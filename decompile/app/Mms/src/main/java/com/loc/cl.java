            ...
            if (cw.a(amapLoc) && context != null) {
                if (by.a) {
                    ...
                    try {
                        ...
                        jSONObject.put(Constant.LOACTION_LATITUDE, amapLoc.i());
                ...
                if (by.a) {
                    ...
                    try {
                        ...
                        if (this.b.containsKey(str)) {
                            jSONObject.put(IccidInfoManager.NUM, jSONObject.getInt(IccidInfoManager.NUM) + i);
                        } else {
                            jSONObject.put(IccidInfoManager.NUM, i);
                        }
                    } catch (Throwable th) {
    ...
    public synchronized ArrayList<ck> b() {
        ...
        while (it.hasNext()) {
            ...
            try {
                ...
                int i = jSONObject.getInt(IccidInfoManager.NUM);
