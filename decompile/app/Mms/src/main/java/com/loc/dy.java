...
public final class dy {
    ...
    private int d = 310;
    private int e = 4;
    private int f = SmartSmsSdkUtil.DUOQU_BUBBLE_DATA_CACHE_SIZE;
    private int g = 1;
    private int h = 0;
    private int i = 0;
    private long j = 0;
    ...
    protected static dy a(Context context) {
        ...
        dyVar.h = 0;
        dyVar.i = 0;
        dyVar.j = ((System.currentTimeMillis() + SmartSmsSdkDoAction.EIGHT_HOUR_MILLISECOND) / 86400000) * 86400000;
    ...
    private void g() {
        long currentTimeMillis = System.currentTimeMillis() + SmartSmsSdkDoAction.EIGHT_HOUR_MILLISECOND;
    ...
    protected final boolean a(String str) {
        ...
        try {
            ...
            if (jSONObject.has(NumberInfo.USER_TAG_UPLOAD_STATUS_KEY) && jSONObject.getInt(NumberInfo.USER_TAG_UPLOAD_STATUS_KEY) != 0) {
                z = true;
                g();
