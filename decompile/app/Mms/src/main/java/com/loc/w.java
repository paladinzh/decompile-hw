...
public class w {
    ...
    public static byte[] a() {
        ...
        try {
            ...
            String[] split2 = new StringBuffer(new String(r.b(new String(bArr)))).reverse().toString().split(",");
