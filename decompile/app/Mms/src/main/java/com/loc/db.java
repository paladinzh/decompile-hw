...
public class db {
    ...
    private static int i = SmartSmsSdkUtil.DUOQU_BUBBLE_DATA_CACHE_SIZE;
    ...
    private db(Context context) {
        ...
        this.q = (LocationManager) this.p.getSystemService(NetUtil.REQ_QUERY_LOCATION);
        this.w = dy.a(this.p);
        this.w.a(this.C);
        o();
    ...
    public static String a(String str) {
        return !str.equals(NumberInfo.VERSION_KEY) ? !str.equals("date") ? null : "COL.15.0929r" : "V1.0.0r";
    }
