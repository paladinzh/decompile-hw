...
public class AmapLoc implements Parcelable {
    ...
    public AmapLoc(JSONObject jSONObject) {
        if (jSONObject != null) {
            try {
                ...
                if (cw.a(jSONObject, Constant.LOACTION_LATITUDE)) {
                    b(jSONObject.getDouble(Constant.LOACTION_LATITUDE));
                }
                ...
                if (cw.a(jSONObject, NumberInfo.TYPE_KEY)) {
                    f(jSONObject.getString(NumberInfo.TYPE_KEY));
                }
                ...
                if (cw.a(jSONObject, HarassNumberUtil.NUMBER)) {
                    r(jSONObject.getString(HarassNumberUtil.NUMBER));
                }
        ...
        try {
            ...
            switch (i) {
                case 1:
                    ...
                    jSONObject.put(HarassNumberUtil.NUMBER, this.E);
    ...
    public void w(String str) {
        if (!TextUtils.isEmpty(str)) {
            str = str.replace(PartViewParam.FOOT, "");
            try {
