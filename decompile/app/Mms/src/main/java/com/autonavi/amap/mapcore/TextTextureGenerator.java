...
public class TextTextureGenerator {
    ...
    public byte[] getCharsWidths(int[] iArr) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            bArr[i] = (byte) ((byte) ((int) (fArr[0] + ContentUtil.FONT_SIZE_NORMAL)));
        }
        return bArr;
    }
    ...
    public static void generaAsccIITexturePng() throws Exception {
        if (Environment.getExternalStorageState().equals("mounted")) {
            ...
            Bitmap createBitmap = Bitmap.createBitmap(ViewPartId.PART_BODY_SIMPLE_CALL_NUMBER, ViewPartId.PART_BODY_SIMPLE_CALL_NUMBER, Config.ARGB_8888);
