            ...
            if (isRequestValid()) {
                ...
                if (mapSvrPath != null && mapSvrPath.length() != 0 && mapAddress != null) {
                    ...
                    if (!TextUtils.isEmpty(gridParma)) {
                        this.inRequest = true;
                        try {
                            Proxy a = bt.a(this.mMapCallback.getContext());
                            ...
                            if (this.httpURLConnection == null) {
                                ...
                                if (this.httpURLConnection.getResponseCode() != SmartSmsSdkUtil.DUOQU_BUBBLE_DATA_CACHE_SIZE) {
                                    OnException(1002);
                                    inputStream = null;
                                } else {
                                    ...
                                    try {
                                        onConnectionOpened();
                                        byte[] bArr = new byte[ViewPartId.PART_BODY_SIMPLE_CALL_NUMBER];
                                        boolean z = true;
                                        while (true) {
