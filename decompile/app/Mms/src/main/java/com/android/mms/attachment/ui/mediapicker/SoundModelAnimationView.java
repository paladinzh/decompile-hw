...
public class SoundModelAnimationView extends BaseSoundModelAnimationView {
    ...
    public SoundModelAnimationView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SoundModelAnimationView(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            this.mBackgroundDrawable = getResources().getDrawable(R.drawable.mic_st_widget_normal);
        ...
        if (!this.mPressed) {
            switch (-getcom-android-mms-attachment-ui-mediapicker-BaseSoundModelAnimationView$StatusSwitchesValues()[this.mCurrentStatus.ordinal()]) {
                ...
                case 4:
                    ...
                    MLog.d("SoundModelAnimationView", "SPEECHINGmSoundLevel " + this.mSoundLevel);
                    ...
                    break;
                default:
                    MLog.d("SoundModelAnimationView", "onDraw enter default");
                    break;
            }
        }
    }
    ...
    public void startRecordingAnimation() {
        MLog.d("SoundModelAnimationView", "startAnimation Recording");
    ...
    public void stopAndClearAnimations() {
        if (this.mCurrentStatus != Status.INIT && this.mCurrentStatus != Status.UNKNOWN) {
            MLog.d("SoundModelAnimationView", "stopAndClearAnimations");
