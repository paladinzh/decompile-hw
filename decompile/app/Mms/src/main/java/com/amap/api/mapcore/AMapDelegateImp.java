...
public class AMapDelegateImp implements Renderer, ab {
    ...
    private class c implements OnDoubleTapListener {
        ...
        public boolean onDoubleTap(MotionEvent motionEvent) {
            ...
            try {
                this.a.b(p.a((float) ContentUtil.FONT_SIZE_NORMAL, new Point((int) motionEvent.getX(), (int) motionEvent.getY())));
            } catch (Throwable e2) {
    ...
    public void onDrawFrame(GL10 gl10) {
        ...
        try {
            if (this.aJ) {
                gl10.glColor4f(ContentUtil.FONT_SIZE_NORMAL, ContentUtil.FONT_SIZE_NORMAL, ContentUtil.FONT_SIZE_NORMAL, 0.5f);
                gl10.glClear(16640);
                this.G.setGL(gl10);
            ...
            gl10.glClearColor(0.9453125f, 0.93359f, 0.9101f, ContentUtil.FONT_SIZE_NORMAL);
        } catch (Throwable th) {
            th.printStackTrace();
        }
    }
    ...
    public void a(p pVar, long j, CancelableCallback cancelableCallback) throws RemoteException {
        ...
        if (pVar.a != a.scrollBy) {
            ...
            if (pVar.a == a.zoomIn) {
                ...
                a = bj.a(ContentUtil.FONT_SIZE_NORMAL + mapZoomer) - mapZoomer;
                if (a == 0.0f) {
                ...
                mapZoomer = this.J.getMapZoomer();
                a = bj.a(mapZoomer - ContentUtil.FONT_SIZE_NORMAL) - mapZoomer;
                if (a == 0.0f) {
                    this.l.obtainMessage(17).sendToTarget();
                    return;
                }
    ...
    public void onSurfaceChanged(GL10 gl10, int i, int i2) {
        ...
        try {
            ...
            if (i5 <= 120) {
                ...
                i5 = HwCustComposeMessageImpl.REQUEST_CODE_MEDIA_COMPRESS_FORWARD;
                i4 = 2;
                i6 = 70;
            } else {
                i5 = SmartSmsSdkUtil.DUOQU_BUBBLE_DATA_CACHE_SIZE;
                i4 = 2;
                i6 = 60;
            }
