...
public class n {
    public static ArrayList<NearbyInfo> a(JSONObject jSONObject, boolean z) throws JSONException {
        ...
        for (int i = 0; i < length; i++) {
            ...
            String a2 = a(jSONObject2, NetUtil.REQ_QUERY_LOCATION);
            double d = 0.0d;
            double d2 = 0.0d;
            if (a2 != null) {
    ...
    public static ArrayList<SuggestionCity> a(JSONObject jSONObject) throws JSONException, NumberFormatException {
        ...
        for (int i = 0; i < optJSONArray.length(); i++) {
            ...
            if (optJSONObject != null) {
                arrayList.add(new SuggestionCity(a(optJSONObject, "name"), a(optJSONObject, "citycode"), a(optJSONObject, "adcode"), j(a(optJSONObject, IccidInfoManager.NUM))));
            }
        }
        return arrayList;
    }
    ...
    public static PoiItem d(JSONObject jSONObject) throws JSONException {
        PoiItem poiItem = new PoiItem(a(jSONObject, "id"), b(jSONObject, NetUtil.REQ_QUERY_LOCATION), a(jSONObject, "name"), a(jSONObject, "address"));
        ...
        poiItem.setTypeDes(a(jSONObject, NumberInfo.TYPE_KEY));
    ...
    private static SubPoiItem w(JSONObject jSONObject) throws JSONException {
        SubPoiItem subPoiItem = new SubPoiItem(a(jSONObject, "id"), b(jSONObject, NetUtil.REQ_QUERY_LOCATION), a(jSONObject, "name"), a(jSONObject, "address"));
    ...
    public static BusStationItem g(JSONObject jSONObject) throws JSONException {
        ...
        busStationItem.setLatLonPoint(b(jSONObject, NetUtil.REQ_QUERY_LOCATION));
    ...
    public static BusLineItem h(JSONObject jSONObject) throws JSONException {
        ...
        busLineItem.setBusLineType(a(jSONObject, NumberInfo.TYPE_KEY));
    ...
    public static BusLineItem j(JSONObject jSONObject) throws JSONException {
        ...
        h.setBusCompany(a(jSONObject, AirManager.COMPANY));
    ...
    public static ArrayList<GeocodeAddress> l(JSONObject jSONObject) throws JSONException {
        ...
        for (int i = 0; i < optJSONArray.length(); i++) {
            ...
            if (optJSONObject != null) {
                ...
                geocodeAddress.setLatLonPoint(b(optJSONObject, NetUtil.REQ_QUERY_LOCATION));
    ...
    public static ArrayList<Tip> m(JSONObject jSONObject) throws JSONException {
        ...
        for (int i = 0; i < optJSONArray.length(); i++) {
            ...
            if (optJSONObject != null) {
                ...
                Object a = a(optJSONObject, NetUtil.REQ_QUERY_LOCATION);
    ...
    public static void a(JSONArray jSONArray, RegeocodeAddress regeocodeAddress) throws JSONException {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            ...
            if (optJSONObject != null) {
                ...
                crossroad.setCenterPoint(b(optJSONObject, NetUtil.REQ_QUERY_LOCATION));
    ...
    public static void b(JSONArray jSONArray, RegeocodeAddress regeocodeAddress) throws JSONException {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            ...
            if (optJSONObject != null) {
                ...
                regeocodeRoad.setLatLngPoint(b(optJSONObject, NetUtil.REQ_QUERY_LOCATION));
    ...
    public static void a(JSONObject jSONObject, RegeocodeAddress regeocodeAddress) throws JSONException {
        ...
        streetNumber.setNumber(a(optJSONObject, HarassNumberUtil.NUMBER));
        streetNumber.setLatLonPoint(b(optJSONObject, NetUtil.REQ_QUERY_LOCATION));
    ...
    public static List<BusinessArea> n(JSONObject jSONObject) throws JSONException {
        ...
        for (int i = 0; i < optJSONArray.length(); i++) {
            ...
            JSONObject optJSONObject = optJSONArray.optJSONObject(i);
            if (optJSONObject != null) {
                businessArea.setCenterPoint(b(optJSONObject, NetUtil.REQ_QUERY_LOCATION));
    ...
    public static List<BusPath> a(JSONArray jSONArray) throws JSONException {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            ...
            if (optJSONObject != null) {
                ...
                busPath.setDuration(m(a(optJSONObject, TrainManager.DURATION)));
    ...
    public static RouteBusWalkItem p(JSONObject jSONObject) throws JSONException {
        ...
        routeBusWalkItem.setDuration(m(a(jSONObject, TrainManager.DURATION)));
    ...
    public static Doorway r(JSONObject jSONObject) throws JSONException {
        ...
        doorway.setLatLonPoint(b(jSONObject, NetUtil.REQ_QUERY_LOCATION));
        return doorway;
    }
    ...
    public static WalkStep s(JSONObject jSONObject) throws JSONException {
        ...
        walkStep.setDuration(k(a(jSONObject, TrainManager.DURATION)));
    ...
    public static RouteBusLineItem t(JSONObject jSONObject) throws JSONException {
        ...
        routeBusLineItem.setBusLineType(a(jSONObject, NumberInfo.TYPE_KEY));
        routeBusLineItem.setDistance(k(a(jSONObject, "distance")));
        routeBusLineItem.setDuration(k(a(jSONObject, TrainManager.DURATION)));
        ...
        try {
            ...
            for (int i = 0; i < optJSONArray.length(); i++) {
                ...
                if (optJSONObject != null) {
                    ...
                    drivePath.setDuration(m(a(optJSONObject, TrainManager.DURATION)));
                            ...
                            if (optJSONArray3 != null) {
                                for (int i3 = 0; i3 < optJSONArray3.length(); i3++) {
                                    ...
                                    if (optJSONObject2 != null) {
                                        ...
                                        driveStep.setDuration(k(a(optJSONObject2, TrainManager.DURATION)));
            ...
            if (optJSONArray != null) {
                for (int i = 0; i < optJSONArray.length(); i++) {
                    ...
                    if (optJSONObject != null) {
                        ...
                        walkPath.setDuration(m(a(optJSONObject, TrainManager.DURATION)));
                            ...
                            if (optJSONArray2 != null) {
                                for (int i2 = 0; i2 < optJSONArray2.length(); i2++) {
                                    ...
                                    if (optJSONObject2 != null) {
                                        ...
                                        walkStep.setDuration(k(a(optJSONObject2, TrainManager.DURATION)));
    ...
    public static LocalWeatherLive d(String str) throws AMapException {
        try {
            ...
            localWeatherLive.setCity(a(jSONObject, "city"));
    ...
    public static LocalWeatherForecast e(String str) throws AMapException {
        try {
            ...
            localWeatherForecast.setCity(a(jSONObject, "city"));
    ...
    public static void c(JSONArray jSONArray, RegeocodeAddress regeocodeAddress) throws JSONException {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            ...
            if (optJSONObject != null) {
                ...
                aoiItem.setLocation(b(optJSONObject, NetUtil.REQ_QUERY_LOCATION));
