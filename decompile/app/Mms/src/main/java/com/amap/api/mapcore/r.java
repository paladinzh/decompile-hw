...
class r extends LinearLayout {
    ...
    public void b() {
        try {
            ...
            matrix.postScale(ContentUtil.FONT_SIZE_NORMAL, (float) Math.cos((((double) cameraHeaderAngle) * 3.141592653589793d) / 180.0d), ((float) this.d.getDrawable().getBounds().width()) / 2.0f, ((float) this.d.getDrawable().getBounds().height()) / 2.0f);
