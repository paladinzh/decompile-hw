...
public abstract class av<Params, Progress, Result> {
    private static final ThreadFactory a = new aw();
    ...
    public final av<Params, Progress, Result> c(Params... paramsArr) {
        return a(g, (Object[]) paramsArr);
    }

    public final av<Params, Progress, Result> a(Executor executor, Params... paramsArr) {
        if (this.j != d.PENDING) {
