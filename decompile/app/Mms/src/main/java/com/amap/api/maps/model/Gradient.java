...
public class Gradient {
    ...
    private HashMap<Integer, a> a() {
        ...
        if (this.c[this.c.length - 1] != ContentUtil.FONT_SIZE_NORMAL) {
            int length = this.c.length - 1;
            hashMap.put(Integer.valueOf((int) (((float) this.a) * this.c[length])), new a(this.b[length], this.b[length], ((float) this.a) * (ContentUtil.FONT_SIZE_NORMAL - this.c[length])));
        }
        return hashMap;
    }
