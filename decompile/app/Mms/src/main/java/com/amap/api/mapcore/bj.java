...
class bj extends View {
    ...
    private Paint e;
    private Rect f;
    private final int[] g = new int[]{10000000, 5000000, 2000000, 1000000, 500000, 200000, 100000, 50000, 30000, 20000, 10000, 5000, AMapException.CODE_AMAP_SERVICE_TABLEID_NOT_EXIST, 1000, VTMCDataCache.MAXSIZE, SmartSmsSdkUtil.DUOQU_BUBBLE_DATA_CACHE_SIZE, 100, 50, 25, 10, 5};
