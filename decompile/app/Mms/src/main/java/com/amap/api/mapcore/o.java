...
public class o {
    ...
    static {
        ...
        while (i < 100) {
            ...
            float f5 = ContentUtil.FONT_SIZE_NORMAL;
            float f6 = f2;
            while (true) {
                f2 = ((f5 - f6) / 2.0f) + f6;
                f3 = (3.0f * f2) * (ContentUtil.FONT_SIZE_NORMAL - f2);
                float f7 = ((((ContentUtil.FONT_SIZE_NORMAL - f2) * 0.175f) + (0.35000002f * f2)) * f3) + ((f2 * f2) * f2);
            ...
            K[i] = (f2 * (f2 * f2)) + (f3 * (((ContentUtil.FONT_SIZE_NORMAL - f2) * 0.5f) + f2));
            f5 = ContentUtil.FONT_SIZE_NORMAL;
            while (true) {
                f2 = ((f5 - f) / 2.0f) + f;
                f3 = (3.0f * f2) * (ContentUtil.FONT_SIZE_NORMAL - f2);
                f7 = ((((ContentUtil.FONT_SIZE_NORMAL - f2) * 0.5f) + f2) * f3) + ((f2 * f2) * f2);
                if (((double) Math.abs(f7 - f4)) < 1.0E-5d) {
                    break;
                } else if (f7 > f4) {
                    f5 = f2;
            ...
            L[i] = (f2 * (f2 * f2)) + ((((ContentUtil.FONT_SIZE_NORMAL - f2) * 0.175f) + (0.35000002f * f2)) * f3);
            i++;
            f2 = f6;
        }
        float[] fArr = K;
        L[100] = ContentUtil.FONT_SIZE_NORMAL;
        fArr[100] = ContentUtil.FONT_SIZE_NORMAL;
        R = ContentUtil.FONT_SIZE_NORMAL;
        R = ContentUtil.FONT_SIZE_NORMAL / a((float) ContentUtil.FONT_SIZE_NORMAL);
    }
        ...
        if (!z) {
            ...
            switch (this.a) {
                case 1:
                    ...
                    int i = (int) (100.0f * f2);
                    float f3 = ContentUtil.FONT_SIZE_NORMAL;
                    f = 0.0f;
                    if (i < 100) {
                        f3 = ((float) i) / 100.0f;
                        f = ((float) (i + 1)) / 100.0f;
    ...
    public void a(int i, int i2, float f, float f2, float f3, int i3, int i4, float f4, float f5, float f6, long j) {
        ...
        this.A = f5;
        this.B = f6;
        this.w = ContentUtil.FONT_SIZE_NORMAL / ((float) this.v);
    }
    ...
    public void a(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        this.b = i;
        this.c = i2;
        g = f2 == 0.0f ? ContentUtil.FONT_SIZE_NORMAL : ((float) i3) / f2;
        f = f2 == 0.0f ? ContentUtil.FONT_SIZE_NORMAL : ((float) i4) / f2;
        double e = e(f2);
    ...
    static float a(float f) {
        float f2 = Q * f;
        if (f2 < ContentUtil.FONT_SIZE_NORMAL) {
            f2 -= ContentUtil.FONT_SIZE_NORMAL - ((float) Math.exp((double) (-f2)));
        } else {
            f2 = ((ContentUtil.FONT_SIZE_NORMAL - ((float) Math.exp((double) (ContentUtil.FONT_SIZE_NORMAL - f2)))) * 0.63212055f) + 0.36787945f;
        }
        return f2 * R;
    }
