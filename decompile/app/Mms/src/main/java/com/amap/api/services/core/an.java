...
public class an {
    ...
    public static void a() {
        try {
            ...
            ay.a(e, "DeviceInfo", "setTraficTag");
        } catch (Throwable e2) {
            ay.a(e2, "DeviceInfo", "setTraficTag");
        } catch (Throwable e22) {
            ay.a(e22, "DeviceInfo", "setTraficTag");
        } catch (Throwable e222) {
            ay.a(e222, "DeviceInfo", "setTraficTag");
        } catch (Throwable e2222) {
            ay.a(e2222, "DeviceInfo", "setTraficTag");
        }
    }
    ...
    public static String f(Context context) {
        ...
        try {
            ...
            ay.a(th2, "DeviceInfo", "getUTDID");
        } catch (Throwable th22) {
            ay.a(th22, "DeviceInfo", "getUTDID");
        } catch (Throwable th222) {
            ay.a(th222, "DeviceInfo", "getUTDID");
        } catch (Throwable th2222) {
            ay.a(th2222, "DeviceInfo", "getUTDID");
        } catch (Throwable th22222) {
            ay.a(th22222, "DeviceInfo", "getUTDID");
        }
        return a;
    }
    ...
    public static int l(Context context) {
        try {
            ...
            ay.a(th, "DeviceInfo", "getNetWorkType");
            return -1;
        }
    }
