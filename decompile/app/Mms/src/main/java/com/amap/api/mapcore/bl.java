...
class bl implements ao {
    ...
    private float o = ContentUtil.FONT_SIZE_NORMAL;
    ...
    private void Q() {
        if (this.t != null && this.t.trim().length() > 0) {
            try {
                ...
                this.r = bj.a(new float[]{0.0f, ContentUtil.FONT_SIZE_NORMAL, ContentUtil.FONT_SIZE_NORMAL, ContentUtil.FONT_SIZE_NORMAL, ContentUtil.FONT_SIZE_NORMAL, 0.0f, 0.0f, 0.0f});
            } catch (Throwable th) {
    ...
    public void b(int i, int i2) throws RemoteException {
        ...
        switch (i) {
            case 1:
                ...
                break;
            case 2:
                this.n = ContentUtil.FONT_SIZE_NORMAL;
                break;
            case 4:
                this.n = 0.5f;
                break;
        ...
        switch (i2) {
            case 8:
                ...
                break;
            case 16:
                this.o = ContentUtil.FONT_SIZE_NORMAL;
                break;
            case 32:
                this.o = 0.5f;
                break;
