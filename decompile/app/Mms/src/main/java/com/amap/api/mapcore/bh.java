...
class bh implements ah {
    ...
    public boolean r() {
        ...
        int i2 = (int) (((float) (iPoint.y + this.c)) + (((float) L) * (ContentUtil.FONT_SIZE_NORMAL - this.o)));
    ...
    public void a(GL10 gl10) {
        if (this.h && this.f != null && M() != null) {
            ...
            if (r()) {
                ...
                gl10.glLoadIdentity();
                gl10.glOrthof(0.0f, (float) this.l.l(), 0.0f, (float) this.l.m(), ContentUtil.FONT_SIZE_NORMAL, -1.0f);
