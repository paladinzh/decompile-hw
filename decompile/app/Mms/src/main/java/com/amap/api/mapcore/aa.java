...
public class aa implements af {
    ...
    private void q() {
        if (this.c != null) {
            ...
            this.f = new LatLngBounds(new LatLng(this.c.latitude - (((double) (ContentUtil.FONT_SIZE_NORMAL - this.l)) * d), this.c.longitude - (((double) this.k) * cos)), new LatLng((d * ((double) this.l)) + this.c.latitude, (cos * ((double) (ContentUtil.FONT_SIZE_NORMAL - this.k))) + this.c.longitude));
            s();
        }
    }
    ...
    private void r() {
        if (this.f != null) {
            ...
            this.c = new LatLng(latLng.latitude + (((double) (ContentUtil.FONT_SIZE_NORMAL - this.l)) * (latLng2.latitude - latLng.latitude)), latLng.longitude + (((double) this.k) * (latLng2.longitude - latLng.longitude)));
    ...
    private void s() {
        if (this.f != null) {
            ...
            if (this.g != 0.0f) {
                ...
                dPoint.y = ((double) fPoint.y) - (((double) (ContentUtil.FONT_SIZE_NORMAL - this.l)) * d2);
    ...
    private void a(DPoint dPoint, double d, double d2, double d3, double d4, FPoint fPoint) {
        ...
        double d6 = (((double) (ContentUtil.FONT_SIZE_NORMAL - this.l)) * d4) - d2;
    ...
    private void a(GL10 gl10, int i, FloatBuffer floatBuffer, FloatBuffer floatBuffer2) {
        if (floatBuffer != null && floatBuffer2 != null) {
            ...
            gl10.glColor4f(ContentUtil.FONT_SIZE_NORMAL, ContentUtil.FONT_SIZE_NORMAL, ContentUtil.FONT_SIZE_NORMAL, ContentUtil.FONT_SIZE_NORMAL - this.j);
            gl10.glEnable(3553);
    ...
    public void d(float f) throws RemoteException {
        boolean z = f >= 0.0f && f <= ContentUtil.FONT_SIZE_NORMAL;
