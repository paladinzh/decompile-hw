...
public interface zzy extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzy {
        ...
        public static zzy zzcU(IBinder iBinder) {
            ...
            return (queryLocalInterface != null && (queryLocalInterface instanceof zzy)) ? (zzy) queryLocalInterface : new zza(iBinder);
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    onStreetViewPanoramaClick(data.readInt() == 0 ? null : StreetViewPanoramaOrientation.CREATOR.zzfH(data));
