...
public interface zzw extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzw {
        ...
        public static zzw zzcS(IBinder iBinder) {
            ...
            return (queryLocalInterface != null && (queryLocalInterface instanceof zzw)) ? (zzw) queryLocalInterface : new zza(iBinder);
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    onStreetViewPanoramaCameraChange(data.readInt() == 0 ? null : StreetViewPanoramaCamera.CREATOR.zzfE(data));
