...
public interface ICameraUpdateFactoryDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements ICameraUpdateFactoryDelegate {
        ...
        public static ICameraUpdateFactoryDelegate zzcs(IBinder iBinder) {
            ...
            return (queryLocalInterface != null && (queryLocalInterface instanceof ICameraUpdateFactoryDelegate)) ? (ICameraUpdateFactoryDelegate) queryLocalInterface : new zza(iBinder);
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 7:
                    data.enforceInterface("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
                    zoomIn = newCameraPosition(data.readInt() == 0 ? null : CameraPosition.CREATOR.zzfv(data));
                    reply.writeNoException();
                    if (zoomIn != null) {
                        iBinder = zoomIn.asBinder();
                    }
                ...
                case 8:
                    data.enforceInterface("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
                    zoomIn = newLatLng(data.readInt() == 0 ? null : LatLng.CREATOR.zzfz(data));
                    reply.writeNoException();
                    if (zoomIn != null) {
                        iBinder = zoomIn.asBinder();
                    }
                ...
                case 9:
                    data.enforceInterface("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
                    zoomIn = newLatLngZoom(data.readInt() == 0 ? null : LatLng.CREATOR.zzfz(data), data.readFloat());
                    reply.writeNoException();
                    if (zoomIn != null) {
                        iBinder = zoomIn.asBinder();
                    }
                ...
                case 10:
                    data.enforceInterface("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
                    zoomIn = newLatLngBounds(data.readInt() == 0 ? null : LatLngBounds.CREATOR.zzfy(data), data.readInt());
                    reply.writeNoException();
                    if (zoomIn != null) {
                        iBinder = zoomIn.asBinder();
                    }
                ...
                case 11:
                    data.enforceInterface("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
                    zoomIn = newLatLngBoundsWithSize(data.readInt() == 0 ? null : LatLngBounds.CREATOR.zzfy(data), data.readInt(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    if (zoomIn != null) {
                        iBinder = zoomIn.asBinder();
                    }
