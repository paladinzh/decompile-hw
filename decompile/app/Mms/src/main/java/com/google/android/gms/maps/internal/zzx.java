...
public interface zzx extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzx {
        ...
        public static zzx zzcT(IBinder iBinder) {
            ...
            return (queryLocalInterface != null && (queryLocalInterface instanceof zzx)) ? (zzx) queryLocalInterface : new zza(iBinder);
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    onStreetViewPanoramaChange(data.readInt() == 0 ? null : StreetViewPanoramaLocation.CREATOR.zzfG(data));
