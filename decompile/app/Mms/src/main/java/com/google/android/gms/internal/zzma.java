        ...
        switch (this.zzaka) {
            ...
            case 2:
                if ((this.zzRD < 0 ? 1 : 0) == 0) {
                    ...
                    if (uptimeMillis < ContentUtil.FONT_SIZE_NORMAL) {
                        i = 0;
                    }
                    if (i != 0) {
                        this.zzaka = 0;
                    }
                    this.zzake = (int) ((Math.min(uptimeMillis, ContentUtil.FONT_SIZE_NORMAL) * ((float) (this.zzakb - this.mFrom))) + ((float) this.mFrom));
                    break;
                }
                break;
        }
