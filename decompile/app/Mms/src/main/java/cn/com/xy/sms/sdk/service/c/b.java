...
final class b implements SdkCallBack {
    ...
    b(String str, HashMap hashMap, String str2, SdkCallBack sdkCallBack, String str3, String str4) {
        this.a = str;
        this.b = hashMap;
        this.c = str2;
        this.d = sdkCallBack;
    ...
    public final void execute(Object... objArr) {
        if (objArr != null && objArr.length > 0) {
            ...
            if (obj.equals("1")) {
                NetUtil.requestNewTokenAndPostRequestAgain(NetUtil.REQ_QUERY_OPERATOR, this.a, Constant.FIVE_MINUTES, a.b(this.b), false, true, this.b, this.c, this);
                return;
