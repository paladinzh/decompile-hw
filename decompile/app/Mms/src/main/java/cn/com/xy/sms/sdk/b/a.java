...
public final class a {
    ...
    public static synchronized HashMap<String, String> a(String str) {
        synchronized (a.class) {
            if (StringUtils.isNull(str)) {
                ...
                return r0;
            } else if (ViewUtil.getChannelType() == 8) {
                r0 = G.a(StringUtils.stringConvertXML("<titles><title_01001001><popus><popu><layoutName>duoqu_popup</layoutName><v_by_bg>#ffffff</v_by_bg><v_hd_del>1_6aba2f9cf8a52365e40c404ecc89e52d.png</v_hd_del><v_hd_close>1_ec3910a4ef4a64e2f8c78c9a80eef68d.png</v_hd_close><v_hd_bg>#FFFFFF</v_hd_bg><v_hd_sp_bg>#307DD5</v_hd_sp_bg><v_bt_bg>#ffffff</v_bt_bg><v_lt_bg>#FFFFFF</v_lt_bg><v_lt_stk>#9db6ca</v_lt_stk></popu></popus></title_01001001></titles>", ""));
                return r0;
    ...
    public static synchronized HashMap<String, String> a(String str, String str2, String str3) {
        synchronized (a.class) {
            if (StringUtils.isNull(str)) {
                return null;
            }
            HashMap<String, String> a = G.a(StringUtils.stringConvertXML(str2, ""), str);
            Map a2 = G.a(StringUtils.stringConvertXML(str3, ""), str);
            if (a2 != null) {
                if (!a2.isEmpty()) {
                    a.putAll(a2);
                }
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static synchronized HashMap<String, String> b(String str) {
        ...
        synchronized (a.class) {
            ...
            if (str.startsWith("02023002")) {
            ...
            } else if (str.startsWith("02010001")) {
            ...
            } else if (str.startsWith("02010002") || str.startsWith("02010003")) {
            ...
            } else if (str.startsWith("02013001")) {
                ...
                if (!str.startsWith("02") || !str.endsWith("01")) {
                    if (!(str.startsWith("02001001") || str.startsWith("02002001") || str.startsWith("02003001") || str.startsWith("02004001") || str.startsWith("02005001") || str.startsWith("02006001") || str.startsWith("02007001") || str.startsWith("02008001"))) {
                        if (!str.startsWith("02") || !str.endsWith("02")) {
                            if (!(str.startsWith("02001002") || str.startsWith("02002002") || str.startsWith("02003002") || str.startsWith("02004002") || str.startsWith("02005002") || str.startsWith("02006002") || str.startsWith("02007002") || str.startsWith("02008002"))) {
                                if (!str.startsWith("02") || !str.endsWith("03")) {
                                    if (!(str.startsWith("02001003") || str.startsWith("02002003") || str.startsWith("02003003") || str.startsWith("02004003") || str.startsWith("02005003") || str.startsWith("02006003") || str.startsWith("02007003") || str.startsWith("02008003"))) {
                                        if (str.startsWith("13001") || str.startsWith("13002") || str.startsWith("13003") || str.startsWith("13005")) {
                                        ...
                                        } else if (str.startsWith("05015") || str.startsWith("05016") || str.startsWith("05017")) {
                                        ...
                                        } else if (str.startsWith("05001") || str.startsWith("05002") || str.startsWith("05003") || str.startsWith("05007") || str.startsWith("05004")) {
                                        ...
                                        } else if (str.startsWith("05008") || str.startsWith("05009") || str.startsWith("05010") || str.startsWith("05013") || str.startsWith("05014")) {
                                        ...
                                        } else if (str.equals("11101001") || str.equals("11102001")) {
                                        ...
                                        } else if (str.equals("11101003") || str.equals("11102003")) {
                                        ...
                                        } else if (str.equals("11101005") || str.equals("11102005")) {
                                        ...
                                        } else if (str.equals("11101008") || str.equals("11102008")) {
                                        ...
                                        } else if (str.equals("11101004") || str.equals("11102004")) {
                                        ...
                                        } else if (str.equals("11101002") || str.equals("11102002")) {
                                        ...
                                        } else if (str.startsWith("0610") && str.endsWith("01")) {
                                        ...
                                        } else if (str.startsWith("0610") && str.endsWith("02")) {
                                        ...
                                        } else if (str.startsWith("13004001") || str.startsWith("13004004") || str.startsWith("13004005")) {
                                        ...
                                        } else if (str.startsWith("08000") || str.startsWith("08101") || str.startsWith("08102") || str.startsWith("08103")) {
                                        ...
                                        } else if (str.startsWith("08104") || str.startsWith("13004")) {
                                        ...
                                        } else if (str.startsWith("04002018")) {
                                            hashMap = G.a(StringUtils.stringConvertXML("<titles><title_03006001><popus><popu><v_hd_close></v_hd_close><v_hd_del></v_hd_del><v_hd_bg></v_hd_bg><v_cpy_logo></v_cpy_logo><v_hd_sp_bg></v_hd_sp_bg></popu></popus></title_03006001></titles>", ""));
                                        }
                                    }
                                }
    ...
    public static HashMap<String, String> c(String str) {
        ...
        try {
            hashMap = (HashMap) g.get(str);
            if (hashMap != null && !hashMap.isEmpty()) {
                return hashMap;
            }
            try {
                SceneRule sceneRule = SceneconfigUtil.getSceneRule(str, 1);
                if (sceneRule != null) {
                    if (sceneRule.mSceneRuleConfig != null && sceneRule.mSceneRuleConfig.length() > 0) {
                        hashMap = (HashMap) JsonUtil.parseJSON2Map(sceneRule.mSceneRuleConfig);
                        if (!(hashMap == null || hashMap.isEmpty())) {
                            g.put(str, hashMap);
                            return hashMap;
                        }
                    ...
                    Constant.getContext();
                    hashMap = a(str, sceneRule.Scene_page_config, sceneRule.Func_config);
                    if (!(hashMap == null || hashMap.isEmpty())) {
                        g.put(str, hashMap);
                    }
                } else if (Constant.Test) {
