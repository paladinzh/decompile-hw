...
public class ParseBoxMsgManager {
    ...
    public static JSONObject parseMsgForBox(Context context, String str, String str2, String str3, Map<String, String> map) {
        if (context == null) {
            ...
            try {
                ...
                if (a2 != null) {
                    if (ParseBubbleManager.getParseStatu(a2) != -1) {
                        a2 = DexUtil.handerBubbleValueMap(a2);
                        if (a2 == null || a2.isEmpty()) {
                            return null;
                        }
                        JSONObject handerBoxValueMap = DexUtil.handerBoxValueMap(a2);
                        if (handerBoxValueMap != null && handerBoxValueMap.length() > 0) {
                            a2.put("boxJsObj", handerBoxValueMap);
                        }
                        a = a(a2, map);
                        return a;
                    }
    ...
    public static JSONArray parseMsgForCardArray(Context context, String str, String str2, String str3, Map<String, String> map) {
        JSONObject parseMsgForBox = parseMsgForBox(context, str, str2, str3, map);
        return parseMsgForBox != null ? DexUtil.parseMsgForCardArray(parseMsgForBox, map) : null;
    }
}
