...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflaterFactory {
    ...
    Animation loadAnimation(Fragment fragment, int transit, boolean enter, int transitionStyle) {
        ...
        switch (styleIndex) {
            case 1:
                return makeOpenCloseAnimation(this.mHost.getContext(), 1.125f, ContentUtil.FONT_SIZE_NORMAL, 0.0f, ContentUtil.FONT_SIZE_NORMAL);
            case 2:
                return makeOpenCloseAnimation(this.mHost.getContext(), ContentUtil.FONT_SIZE_NORMAL, 0.975f, ContentUtil.FONT_SIZE_NORMAL, 0.0f);
            case 3:
                return makeOpenCloseAnimation(this.mHost.getContext(), 0.975f, ContentUtil.FONT_SIZE_NORMAL, 0.0f, ContentUtil.FONT_SIZE_NORMAL);
            case 4:
                return makeOpenCloseAnimation(this.mHost.getContext(), ContentUtil.FONT_SIZE_NORMAL, 1.075f, ContentUtil.FONT_SIZE_NORMAL, 0.0f);
            case 5:
                return makeFadeAnimation(this.mHost.getContext(), 0.0f, ContentUtil.FONT_SIZE_NORMAL);
            case 6:
                return makeFadeAnimation(this.mHost.getContext(), ContentUtil.FONT_SIZE_NORMAL, 0.0f);
            default:
