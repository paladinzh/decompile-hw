...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    void layoutChunk(Recycler recycler, State state, LayoutState layoutState, LayoutChunkResult result) {
        ...
        for (i = 0; i < count; i++) {
            ...
            float otherSize = (((float) this.mOrientationHelper.getDecoratedMeasurementInOther(view)) * 1.0f) / ((float) lp.mSpanSize);
            ...
            if (candidate.isFocusable()) {
                ...
                if (weakCandidate == null) {
                    ...
                    if (overlap > weakCandidateOverlap) {
                        ...
                        if (isLayoutRTL == (candidateStart > weakCandidateSpanIndex)) {
                            assignAsWeek = true;
                        }
                    }
                }
