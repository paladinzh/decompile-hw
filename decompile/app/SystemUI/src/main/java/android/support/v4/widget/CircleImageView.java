...
class CircleImageView extends ImageView {
    ...
    private class OvalShadow extends OvalShape {
        ...
        public OvalShadow(int shadowRadius, int circleDiameter) {
            ...
            this.mRadialGradient = new RadialGradient((float) (this.mCircleDiameter / 2), (float) (this.mCircleDiameter / 2), (float) CircleImageView.this.mShadowRadius, new int[]{1023410176, 0}, null, TileMode.CLAMP);
