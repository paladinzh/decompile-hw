...
public class c extends a {
    public void a(Context context) {
        if ((d.c() - 604800000 <= 0 ? 1 : 0) == 0) {
            a a = a.a(context);
            a.a(ThirdPartyEventRecord.class.getSimpleName(), " time < ? and adType = ?", new String[]{String.valueOf(r4), String.valueOf(2)});
            a.a(AdEventRecord.class.getSimpleName(), " time < ? and adType = ?", new String[]{String.valueOf(r4), String.valueOf(2)});
            a.close();
        }
    }
}
