...
public class ExifTag {
    ...
    public static int getElementSize(short type) {
        if (type < (short) 0 || type >= TYPE_TO_SIZE_MAP.length) {
            return 0;
        }
    ...
    public boolean setValue(int[] value) {
        if (value == null || checkBadComponentCount(value.length)) {
            return false;
        }
    ...
    public boolean setValue(byte[] value, int offset, int length) {
        if (value == null || offset < 0 || length < 0 || length + offset > value.length || checkBadComponentCount(length)) {
            return false;
        }
    ...
    protected void getBytes(byte[] buf, int offset, int length) {
        ...
        HwLog.w("ExifTag", "getBytes mDataType = " + this.mDataType);
    }
    ...
    public String toString() {
        return String.format(Locale.US, "tag id: %04X%n", new Object[]{Short.valueOf(this.mTagId)}) + "ifd id: " + this.mIfd + "\ntype: " + convertTypeToString(this.mDataType) + "\ncount: " + this.mComponentCountActual + "\noffset: " + this.mOffset + "\nvalue: " + forceGetValueAsString() + "\n";
    }
}
