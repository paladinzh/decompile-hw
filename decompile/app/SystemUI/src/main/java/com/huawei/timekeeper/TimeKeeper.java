...
public class TimeKeeper extends AbsTimeKeeper {
    ...
    public void unregisterAll() {
        Log.d("TimeKeeper", "unregisterAll");
        this.mObservable.unregisterAll();
    }

    private boolean isCalledBySystemApp() {
        String appPkg = this.mContext == null ? BuildConfig.FLAVOR : this.mContext.getApplicationInfo().packageName;
    ...
    public synchronized void trigerLockout(long timeToLock) {
        Log.w("TimeKeeper", "trigerLockout " + timeToLock);
