...
public class c implements a<a>, a.a<InputStream> {
    ...
    public void a(d dVar, a.a<? super a> aVar) {
        ...
        com.fyusion.sdk.viewer.internal.b.c.d dVar2 = new com.fyusion.sdk.viewer.internal.b.c.d(com.fyusion.sdk.common.a.b.a.b(this.b));
        if (this.d == null) {
            this.d = new d(dVar2);
        }
        this.d.a(dVar, this);
    ...
    public void a(@Nullable InputStream inputStream) {
        if (inputStream != null) {
            try {
                ...
                h.c("FyuseDataFetcher", "Failed processing Fyuse Data", e);
                a(e);
                return;
            } catch (Throwable th) {
                this.d.a();
    ...
    public void a(Exception exception) {
        if (exception instanceof RuntimeException) {
            h.a("FyuseDataFetcher", "Fetching metadata for " + this.b + " is cancelled.");
        } else {
            h.b("FyuseDataFetcher", "Fetching metadata for " + this.b + " failed.", exception);
        }
        this.e.a(exception);
    }
