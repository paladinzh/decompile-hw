...
import com.fyusion.sdk.core.util.a.c;
...
public class d extends Thread {
    ...
    private File a(int i) {
        return new File(this.c.c(), String.format(Locale.US, k.aH, new Object[]{Integer.valueOf(i)}));
    }
        ...
        if (a(i2).exists() || z) {
            if (this.w.contains(Integer.valueOf(i))) {
                try {
                    ...
                    h.c("LegacyFyuseStabilizer", "Decoding interrupted", e);
                    return;
                }
            }
        ...
        if (!this.y) {
            ...
            try {
                ...
                if (createFromBitmap == null) {
                    h.d("LegacyFyuseStabilizer", "Unable to save thumbnail because img is null");
                } else {
                ...
                h.c("LegacyFyuseStabilizer", "Unable to save thumbnail", e);
            } catch (Throwable th) {
                if (createFromBitmap != null) {
                    createFromBitmap.close();
                }
    ...
    private void a(com.fyusion.sdk.processor.mjpegutils.a aVar, int i) {
        a(this.e.transformParameters.get(i), this.e.globalScale, this.k, this.t.a, this.t.b);
        ...
        if (!this.a.isCancelled()) {
            ...
            while (!this.a.isCancelled()) {
                try {
                    ...
                    h.a("LegacyFyuseStabilizer", e.getMessage());
                    return;
                }
            }
            this.x.a((Object) bVar.b);
        }
    }
    ...
    private void a(TransformationParameters transformationParameters, float f, boolean z, int i, int i2) {
        ...
        this.f.postScale(1.0f / ((float) i), 1.0f / ((float) i2));
    ...
    private boolean a(int i, int i2) {
        ...
        try {
            ...
            h.c("LegacyFyuseStabilizer", "Interrupted in createOutputSurface()", e);
            return lock;
        } finally {
            lock = this.o;
            lock.unlock();
    ...
    private boolean a(MediaCodec mediaCodec, MediaExtractor mediaExtractor, ByteBuffer[] byteBufferArr, int[] iArr) {
        ...
        if (dequeueInputBuffer < 0) {
            h.b("extractInput", "dequeueInputBuffer returns " + dequeueInputBuffer);
            return false;
        }
    ...
    private boolean a(MediaExtractor mediaExtractor, MediaCodec mediaCodec, com.fyusion.sdk.processor.mjpegutils.a aVar, int i) {
        ...
        while (!this.a.isCancelled()) {
            ...
            if (dequeueOutputBuffer == -1) {
                h.b("extractFrames", "dequeueOutputBuffer try again " + i3);
        ...
        h.b("LegacyFyuseStabilizer", "Processing is cancelled. " + this.a.getFile());
        return false;
    }
    ...
    private boolean c() {
        File l = this.c.l();
        h.a("extractFramesAndProcess", "extracting frames for: " + l.getAbsolutePath());
        ...
        try {
            ...
            while (i < mediaExtractor.getTrackCount()) {
                try {
                    ...
                    h.d("LegacyFyuseStabilizer", "unable to get track format");
                    return false;
                }
            }
            i = -1;
            if (i >= 0) {
                this.t = new n(this.e.getMagic().getCameraWidth(), this.e.getMagic().getCameraHeight());
            ...
            h.d("LegacyFyuseStabilizer", "unable to find a video track");
            return false;
        } catch (IOException e4) {
            h.d("LegacyFyuseStabilizer", "could not set data source");
            return false;
        }
    }

    private boolean d() {
        h.a("doVislibProcessing", "beginning vislib processing");
        try {
            boolean z;
            File j;
            ...
            if (cameraOrientation != 90) {
                if (this.d.wasRecordedUsingFrontCamera() || cameraOrientation == 270) {
                    ...
                    h.b("LegacyFyuseStabilizer", "Zoom mode: " + zoomMode.toString());
                    h.b("LegacyFyuseStabilizer", "Enable LC: " + z2);
                    h.b("LegacyFyuseStabilizer", "Force LC check: " + z3);
            ...
            h.c("LegacyFyuseStabilizer", "Error when processing: ", e);
            return false;
        }
    }
    ...
    private synchronized void e() {
        ...
        if (bVar.a != -1) {
            ...
            int i;
            l lVar;
            File file = new File(this.c.c(), String.format(Locale.US, k.aH, new Object[]{Integer.valueOf(bVar.a)}) + ".temp");
            ...
            if (this.l != null) {
                if (this.l.getWidth() == width && this.l.getHeight() == height) {
                    ...
                    if (createFromBitmap != null) {
                        try {
                            pDQBuffer = (PDQBuffer) com.fyusion.sdk.core.util.a.d.a.c(width * height);
                            ...
                            com.fyusion.sdk.core.util.a.d.a.a((Object) pDQBuffer);
                        } catch (Exception e2) {
                            e2.printStackTrace();
                        } catch (Throwable th) {
                            com.fyusion.sdk.core.util.a.d.a.a((Object) pDQBuffer);
                    ...
                    if (this.i instanceof l) {
                        ...
                        i = this.C;
                        this.C = i + 1;
                        lVar.a(processItem, i, this.D, this.l, bVar.c);
                    }
                }
            }
    ...
    private ByteBuffer g() {
        int width = this.e.getMagic().getWidth();
        int height = this.e.getMagic().getHeight();
        ByteBuffer byteBuffer = (ByteBuffer) this.x.b((width * height) * 4);
        byteBuffer.rewind();
    ...
    private void h() {
        ...
        try {
            ...
            h.c("LegacyFyuseStabilizer", "Interrupted", e);
        }
    }
    ...
    private boolean i() {
        ...
        try {
            this.h = new com.fyusion.sdk.processor.mjpegutils.a(this.s.a, this.s.b);
            return true;
        } catch (Throwable e) {
            this.h = null;
            h.c("LegacyFyuseStabilizer", "createCodecSurfaceInGLThread() failed", e);
            return false;
        }
    }
    ...
    public void a(final ProcessorListener processorListener, final ProcessItem processItem) {
        h.a("processing", "processing for " + this.c.c());
        try {
            this.o.lock();
            start();
            this.q.await();
            ...
            Runnable anonymousClass4 = new Runnable(this) {
                ...
                public void run() {
                    ...
                    while (!this.c.g) {
                        if (processItem.isCancelled()) {
                            try {
                                ...
                                if (bVar != null) {
                                    this.c.x.a((Object) bVar.b);
                                }
                                this.c.c.i();
                            } catch (InterruptedException e) {
                                h.d("LegacyFyuseStabilizer", e.getMessage());
                            } catch (IllegalStateException e2) {
                                h.a("LegacyFyuseStabilizer", e2.getMessage());
                            } catch (Throwable th) {
                            }
                    ...
                    if (this.c.j) {
                        try {
                            ...
                            try {
                                ...
                                h.d("LegacyFyuseStabilizer", "Error opening fyuse file: " + e3.getMessage());
                                this.c.c.i();
                            ...
                            h.c("LegacyFyuseStabilizer", "Copy from temp dir failed.", e4);
                    ...
                    if (processItem.isCancelled()) {
                        ...
                        h.a("LegacyFyuseStabilizer", "Corrupt data");
                        processorListener.onError(processItem, ProcessError.CORRUPT_DATA);
                    }
                    d.z.release();
                    return;
            ...
            h.c("LegacyFyuseStabilizer", "startup problems", e);
        } finally {
            this.o.unlock();
        }
    }
        ...
        while (true) {
            if (this.r) {
                try {
                    ...
                    h.c("LegacyFyuseStabilizer", "SurfaceThread was interrupted", e);
                    this.r = true;
                } finally {
                    this.n.unlock();
                }
                ...
                switch (AnonymousClass5.a[this.m.ordinal()]) {
                    ...
                    case 2:
                        ...
                        if (this.s != null) {
                            ...
                            h.d("LegacyFyuseStabilizer", "Illegal surface size supplied, ignoring request");
                        }
                        i = 1;
                        break;
                    case 3:
