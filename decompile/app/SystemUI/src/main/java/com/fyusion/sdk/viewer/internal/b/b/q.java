...
class q implements a<File>, b {
    ...
    public void a(File file) {
        if (file != null) {
            h.a("SourceGenerator", "Fetch " + file.getName() + " from " + this.d.c.c() + " in " + d.a(this.e) + "ms");
            this.c.a(this.d.a, (Object) file, this.d.c, this.d.c.c());
            return;
        }
        h.c("SourceGenerator", "Data should never be null here, this is unexpected.");
    }
    ...
    public void a(Exception exception) {
        if (exception instanceof IOException) {
            ...
            if (obj != null) {
                h.a("SourceGenerator", "Retry loading data for " + this.d.a + ", attempt: " + this.f);
                this.f++;
