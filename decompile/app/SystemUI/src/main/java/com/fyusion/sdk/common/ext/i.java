...
public class i extends j {
    ...
    private boolean p() {
        this.n = new File(this.g.getParent() + File.separator + String.format(Locale.US, k.aI, new Object[]{Integer.valueOf(0)})).exists();
        return this.n;
    }

    private int q() {
        int i = (this.o + this.p) / 2;
        if (new File(this.g.getParent() + File.separator + String.format(Locale.US, k.aI, new Object[]{Integer.valueOf(i)})).exists()) {
            this.o = i;
            return this.o;
        }
        this.p = i;
    ...
    public FileInputStream b(int i) throws IOException, IndexOutOfBoundsException {
        if (!this.a) {
            ...
            if (i >= 0 && i < c()) {
                return new FileInputStream(new File(parent + File.separator + String.format(Locale.US, k.aI, new Object[]{Integer.valueOf(i)})));
            }
            throw new IndexOutOfBoundsException();
        }
    }
