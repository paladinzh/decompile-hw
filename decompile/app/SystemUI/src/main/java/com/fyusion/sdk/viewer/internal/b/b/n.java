...
class n implements com.fyusion.sdk.viewer.internal.b.a.a.a<com.fyusion.sdk.viewer.internal.b.c.a>, b {
    ...
    public void a(com.fyusion.sdk.viewer.internal.b.c.a aVar) {
        if (aVar == null) {
            h.c("MetaDataGenerator", "Data should never be null. This is unexpected.");
            return;
        }
        h.a("MetaDataGenerator", "Load metadata for " + aVar.d() + " from " + this.d.c.c() + " in " + d.a(this.f) + "ms");
    ...
    public void a(Exception exception) {
        if ((exception instanceof IOException) && this.g < 3) {
            h.a("MetaDataGenerator", "Retry loading data for " + this.d.a + ", attempt: " + this.g);
            this.g++;
