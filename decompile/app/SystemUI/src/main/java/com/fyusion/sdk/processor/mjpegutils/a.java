...
public class a implements OnFrameAvailableListener {
                    ...
                    if (j == null) {
                        ...
                        if (j == null) {
                            ...
                            if (this.k == EGL14.EGL_NO_SURFACE) {
                                h.d("EGLContextManager", "EGL NO SURFACE returned");
                            }
    ...
    public boolean d() {
        synchronized (this.l) {
            ...
            h.a("awaitNewImage", "Timeout exceeded! no image found");
            this.f.a("before updateTexImage, thread " + Process.myTid());
            return false;
        }
    }
    ...
    public void onFrameAvailable(SurfaceTexture surfaceTexture) {
        synchronized (this.l) {
            if (this.m) {
                h.a("CodecOutputSurface", "onFrameAvailable mFrameAvailable already set!");
