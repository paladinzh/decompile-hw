...
public class a implements Target<com.fyusion.sdk.viewer.internal.b.c.a> {
    ...
    public void b(com.fyusion.sdk.viewer.internal.b.c.a aVar) {
        if (!this.d) {
            h.a("FyuseViewTarget", "onResourceReady: " + aVar.d());
            a(aVar);
        }
    }
    ...
    public void onDestroy() {
        h.a("FyuseViewTarget", "onDestroy: " + this);
    }

    public void onLoadCleared(@Nullable Drawable drawable) {
        h.a("FyuseViewTarget", "onLoadCleared ");
        if (this.a != null) {
    ...
    public void onLoadFailed(@Nullable Drawable drawable) {
        h.a("FyuseViewTarget", "onLoadFailed: ");
    }

    public void onLoadStarted(@Nullable Drawable drawable) {
        h.a("FyuseViewTarget", "onLoadStarted: ");
    }
    ...
    public void onStart() {
        h.a("FyuseViewTarget", "onStart: " + this);
        this.a.onStart();
    }

    public void onStop() {
        h.a("FyuseViewTarget", "onStop: " + this);
        this.a.onStop();
    }
