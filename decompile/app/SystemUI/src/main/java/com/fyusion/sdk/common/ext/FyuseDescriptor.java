...
public class FyuseDescriptor extends i {
    ...
    public int echoes;
    private String fyusePath = BuildConfig.FLAVOR;
    ...
    public FyuseDescriptor(f fVar, String str) {
        init(str, true);
        this.magic = new Magic();
        this.magic.setSlicesLength(1);
        this.magic.addSlice(fVar.getStartFrame(), 750, 0);
        FyuseSize processedSize = fVar.getProcessedSize();
        ...
        int startFrame = 750 - fVar.getStartFrame();
