...
class g {
    ...
    private com.fyusion.sdk.common.c.a a(float f, float f2, boolean z) {
        ...
        double d = (!isConvex ? -1.0d : 1.0d) * -1.0d;
        if (this.g.isConvex()) {
            f3 = f5;
            f5 = f4;
        } else {
        ...
        com.fyusion.sdk.common.c.a a2 = com.fyusion.sdk.common.c.a(com.fyusion.sdk.common.c.a(com.fyusion.sdk.common.c.a(a, d3 / 10.0d, -1.0d, 0.0d, 0.0d), d4 / 10.0d, 0.0d, 1.0d, 0.0d), 0.0d, 0.0d, d);
        double sin = -1.0d * (((double) (i.a / 3.0f)) / Math.sin(0.017453292519943295d));
        double sin2 = -1.0d * (((double) (i.a / 3.0f)) / Math.sin(d2));
        ...
        return !z ? a3 : com.fyusion.sdk.common.c.a(com.fyusion.sdk.common.c.a(-1.5707963267948966d, 0.0d, 0.0d, 1.0d), com.fyusion.sdk.common.c.a(a3, com.fyusion.sdk.common.c.a(1.5707963267948966d, 0.0d, 0.0d, 1.0d)));
    }

    private void a(com.fyusion.sdk.common.d dVar) {
        dVar.a = ((i.a * 2.0f) / ((float) (Math.exp((double) ((dVar.a * -2.0f) / i.a)) + 1.0d))) - i.a;
        dVar.b = ((i.a * 2.0f) / ((float) (Math.exp((double) ((dVar.b * -2.0f) / i.a)) + 1.0d))) - i.a;
    }
    ...
    private void b(com.fyusion.sdk.common.d dVar) {
        dVar.a = ((-i.a) / 2.0f) * ((float) Math.log((double) (((i.a * 2.0f) / (dVar.a + i.a)) - 1.0f)));
        dVar.b = ((-i.a) / 2.0f) * ((float) Math.log((double) (((i.a * 2.0f) / (dVar.b + i.a)) - 1.0f)));
    }
    ...
    private float s() {
        return (float) (!e() ? 1.0d : 1.059000015258789d);
    }
    ...
    public float a(h hVar, com.fyusion.sdk.viewer.a.b bVar, com.fyusion.sdk.common.d dVar, com.fyusion.sdk.common.d dVar2, b bVar2) {
        ...
        if ((this.t <= 0 ? 1 : null) == null && ((double) (currentTimeMillis - this.t)) * 0.001d > 1.0d) {
            i();
        }
    ...
    com.fyusion.sdk.common.c.b c() {
        if (this.g != null) {
            if (this.G) {
                ...
                return this.g.getEffectiveGravityX() == 1.0f ? com.fyusion.sdk.common.c.a(3.141592653589793d) : com.fyusion.sdk.common.c.b();
            }
        }
        return com.fyusion.sdk.common.c.b();
    }
    ...
    boolean g() {
        ...
        if (this.u) {
            ...
            if (obj == null && ((double) (System.currentTimeMillis() - this.t)) * 0.001d > 1.0d) {
                i();
            }
        }
        return this.e;
