...
public class MeshRenderer {
    ...
    public MeshRenderer(MeshView meshView, f fVar, File file) {
        boolean z = false;
        int cameraOrientation = fVar.getCameraOrientation();
        this.i = fVar.wasRecordedUsingFrontCamera();
        if (this.i && cameraOrientation == 90) {
            z = true;
        }
        this.c = z;
        this.g = h.a().c(file.getPath());
        this.f = meshView;
        this.h = fVar.getGravityX();
    }
