...
public class b implements Runnable {
    ...
    URLConnection a(String str) throws IOException {
        Throwable th;
        Throwable th2 = null;
        HttpURLConnection httpURLConnection = (HttpURLConnection) new URL(this.b + f.a().d() + "&key=" + a.e()).openConnection();
    ...
    public void run() {
                    ...
                    try {
                        ...
                        if (a instanceof HttpURLConnection) {
                            ...
                            try {
                                ...
                                i3 = (responseCode >= 200 && responseCode < 300) ? 1 : 0;
                                if (i3 == 0) {
                                    if (f.a().c()) {
                                        Log.w("Fyulytics", "HTTP error response code was " + responseCode + " from submitting event data: " + str);
                                    }
                                }
                                if (inputStream != null) {
                                    inputStream.close();
                        ...
                        if (i3 != 0) {
                            if (f.a().c()) {
                                Log.d("Fyulytics", "ok ->" + str);
                            }
                            this.a.b(str);
                        } else if (responseCode >= 400 && responseCode < 500) {
                            if (f.a().c()) {
                                Log.d("Fyulytics", "fail " + responseCode + " ->" + str);
                            }
                            this.a.b(str);
        ...
        try {
            if (f.a().c()) {
                Log.w("Fyulytics", "Got exception while trying to submit event data: " + str, th3);
            }
