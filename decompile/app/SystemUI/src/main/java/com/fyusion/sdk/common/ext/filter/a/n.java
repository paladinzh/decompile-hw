...
public class n extends x {
    ...
    protected String g() {
        ...
        String g = (this.a != null && this.a.c()) ? this.a.g() : BuildConfig.FLAVOR;
        ...
        g = (this.a != null && this.a.c()) ? this.a.h() : BuildConfig.FLAVOR;
    ...
    protected String h() {
        ...
        String str = (this.a != null && this.a.c()) ? this.a.i() + this.a.j() : BuildConfig.FLAVOR;
        append = append.append(str).append("void main ()").append("{").append("    highp vec4 color = texture2D (texture, texture_coordinate);");
        str = (this.a != null && this.a.c()) ? this.a.k() : BuildConfig.FLAVOR;
        return append.append(str).append("    gl_FragColor = color;").append("}").toString();
    }

    protected com.fyusion.sdk.common.ext.n i() {
        return this.a == null ? null : new com.fyusion.sdk.common.ext.n(this.a.b(), this.a.a());
    }
}
