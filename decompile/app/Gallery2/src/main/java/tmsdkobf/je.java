...
final class je implements ir {
    ...
    private final String tT = "0c";
    private final String tU = "03";
    private final String tV = "00";
    private a tW;
    ...
    public SmsEntity ca() {
        ...
        byte[] byteArrayExtra = this.mIntent.getByteArrayExtra(MapTilsCacheAndResManager.AUTONAVI_DATA_PATH);
