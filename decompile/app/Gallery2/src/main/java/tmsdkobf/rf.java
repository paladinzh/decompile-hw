...
public class rf {
    public static final List<String> MY = re.aT();
    static DeepCleanEngine Nh = SdcardScannerFactory.getDeepCleanEngine(null);
    ...
    private TreeMap<Integer, List<a>> Nj = null;
    private HashMap<String, b> Nk = new HashMap();
    ...
    static class b {
        ...
        private String Nu = null;
        public List<a> Nw;
        public HashMap<String, List<a>> Nx = new HashMap();
        public TreeMap<String, List<a>> Ny = new TreeMap();
        public TreeMap<String, List<a>> Nz = new TreeMap();
    ...
    private void Q(boolean z) {
        cx cxVar = (cx) nj.b(TMSDKContext.getApplicaionContext(), UpdateConfig.DEEPCLEAN_SDCARD_SCAN_RULE_NAME_V2, UpdateConfig.intToString(40225), new cx(), XmlUtils.INPUT_ENCODING);
            ...
            for (intValue = ((Integer) treeMap2.lastKey()).intValue(); intValue > 0; intValue--) {
                ...
                if (list2 == null) {
                    ...
                    for (a aVar22 : list2) {
                        ...
                        if (aVar != null) {
                            if (aVar.Nl.equals(GpsMeasureMode.MODE_3_DIMENSIONAL)) {
                                if (!aVar22.Nl.equals("4")) {
                                }
                            }
                            if (!aVar22.Nl.equals(GpsMeasureMode.MODE_3_DIMENSIONAL)) {
                                if (a(aVar) >= a(aVar22)) {
                                    aVar22 = aVar;
                                }
                            }
                    ...
                    if (list2 == null) {
                        ...
                        for (a aVar222 : list2) {
                            ...
                            if (aVar != null) {
                                ...
                                if (!aVar222.Nl.equals(GpsMeasureMode.MODE_3_DIMENSIONAL)) {
                                    if (a(aVar) >= a(aVar222)) {
                                        aVar222 = aVar;
                                    }
                                }
                ...
                if (list2 == null) {
                    ...
                    for (a aVar2222 : list2) {
                        ...
                        if (aVar != null) {
                            ...
                            if (!aVar2222.Nl.equals(GpsMeasureMode.MODE_3_DIMENSIONAL)) {
            ...
            if (aE != null) {
                ...
                while (it.hasNext()) {
                    ...
                    if (map.get(Integer.valueOf(3)) != null) {
                        aVar = new a();
                        aVar.Nl = GpsMeasureMode.MODE_3_DIMENSIONAL;
