...
public final class dd implements Serializable {
    ...
    public static final dd hM = new dd(1, 101, "ESP_Symbian_V3");
    public static final dd hN = new dd(2, 102, "ESP_Symbian_V5");
    public static final dd hO = new dd(3, OfflineMapStatus.EXCEPTION_SDCARD, "ESP_Symbian_V2");
