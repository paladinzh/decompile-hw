...
public class qy {
    public static final String TAG = qy.class.getSimpleName();
    ...
    private static void f(OfflineVideo offlineVideo) {
        ...
        if (cY(offlineVideo.mPath) != null) {
            ...
            if (openDatabase == null) {
                ...
                Cursor query2 = openDatabase.query("t_videodownload", null, "save_filename = ?", new String[]{str}, null, null, null);
                if (query2 == null) {
                    i2 = 0;
                    str2 = null;
                } else {
                    try {
                        if (query2.moveToFirst()) {
                            str2 = query2.getString(query2.getColumnIndex("play_id"));
                            try {
                                ...
                                try {
                                    ...
                                    d.g(TAG, "" + str2 + " " + i2 + " " + offlineVideo.mTitle + " " + offlineVideo.mDownProgress);
                                } catch (Exception e) {
