...
public class hh {
    HashMap<String, hf> qx = new HashMap();
    String[] qy;
    final boolean qz;
    ...
    public List<OfflineVideo> bw() {
        ...
        if (bx != null && bx.size() != 0) {
            ...
            while (true) {
                ...
                i4 = ((i5 + i) + i2) + i3;
                d.g("PiDeepClean", "EMID_Secure_DeepClean_OfflineVideo_ScanResult " + (((((j5 + j) + j2) + j3) >> 10) + "," + i4 + "," + (j5 >> 10) + "," + i5 + "," + (j >> 10) + "," + i + "," + (j2 >> 10) + "," + i2 + "," + (j3 >> 10) + "," + i3));
                return f;
            }
        }
        return null;
