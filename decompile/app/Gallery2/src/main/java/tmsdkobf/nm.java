...
public class nm {
    ...
    private IUpdateObserver vg = new IUpdateObserver(this) {
    ...
    private void a(final b bVar) {
        ...
        a(bVar, "add");
        jq.cu().a(807, bVar.CH, new bt(), 0, new lg(this) {
            final /* synthetic */ nm CC;
    ...
    private void a(b bVar, bt btVar) {
        ...
        synchronized (this.Cz) {
            if (this.Cz.containsKey(bVar.CG)) {
                Queue queue = (Queue) this.Cz.remove(bVar.CG);
            }
        }
    }
    ...
    public SmsCheckResult u(String str, String str2) {
        ...
        return (a(smsCheckInput, smsCheckResult) == 0 && smsCheckResult.uiFinalAction == 2 && smsCheckResult.uiContentType == 102) ? smsCheckResult : null;
    }
}
