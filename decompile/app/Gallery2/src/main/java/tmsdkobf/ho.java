...
public class ho extends hf {
    Pattern qC = Pattern.compile("\"title\":\"([^\"]*)\"");
    Pattern qD = Pattern.compile("\"progress\":([0-9]{1,3})");
    Pattern qE = Pattern.compile("\"seconds\":([0-9]{1,3})");
    Pattern qF = Pattern.compile("\"playTime\":([0-9]{1,3})");
