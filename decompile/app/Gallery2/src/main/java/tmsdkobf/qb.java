...
final class qb extends BaseManagerC {
    ...
    private py a(String str, py pyVar, int i) {
        ...
        try {
            packageArchiveInfo = this.mPackageManager.getPackageArchiveInfo(str, co(i));
        ...
        if ((i & 256) != 0) {
            pyVar.put("version", packageArchiveInfo.versionName);
        }
        if ((i & 512) != 0) {
        ...
        if (!((i & 1024) == 0 || packageArchiveInfo.applicationInfo == null)) {
    ...
    private int co(int i) {
        ...
        return (i & 32) == 0 ? i2 : i2 | FragmentTransaction.TRANSIT_ENTER_MASK;
    }
