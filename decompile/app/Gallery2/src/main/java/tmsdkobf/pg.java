...
public class pg {
    ...
    private static final int cj(int i) {
        return i * 60;
    }
    ...
    private void gE() {
        ...
        if (gG >= 0 && this.Hw != null && gG <= this.Hw.size()) {
            ...
            pm.a(this.context, "tmsdk.common.module.sdknetpool.sharknetwork.SharkControler.SHARK_CONTROL_ACTION_EXE_RULE_CLOSE", (long) (piVar.HG * 1000));
            pm.a(this.context, "tmsdk.common.module.sdknetpool.sharknetwork.SharkControler.SHARK_CONTROL_ACTION_EXE_RULE_CYCLE", (long) ((piVar.HG + piVar.HH) * 1000));
