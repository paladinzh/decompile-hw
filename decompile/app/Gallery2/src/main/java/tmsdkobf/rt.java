...
public class rt {
    ...
    private boolean O(Context context) {
        cx cxVar = (cx) nj.b(TMSDKContext.getApplicaionContext(), UpdateConfig.PROCESSMANAGER_WHITE_LIST_NAME, UpdateConfig.intToString(40006), new cx(), XmlUtils.INPUT_ENCODING);
