...
public class fx {
    ...
    private static fx ns = null;
    private lf nq = fw.w().y();
    private hp nr = new hp();
    ...
    public void a(bj bjVar) {
        try {
            this.nr.a(10000, bjVar.toByteArray(XmlUtils.INPUT_ENCODING));
        } catch (Throwable th) {
            d.c("SharkDao", th);
        }
    }
    ...
    public void n(boolean z) {
        this.nr.b(1000, Boolean.toString(z));
    }
}
