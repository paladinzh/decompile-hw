...
public final class qc extends BaseManagerC implements qd {
    ...
    private void a(PackageInfo packageInfo, py pyVar, int i) {
        ...
        if (packageInfo != null && pyVar != null) {
            ...
            if ((i & 8) != 0) {
                pyVar.put("version", packageInfo.versionName);
    ...
    public py a(py pyVar, int i) {
        PackageInfo packageInfo = getPackageInfo((String) pyVar.get("pkgName"), co(i));
        if (packageInfo == null) {
            return null;
        }
    ...
    public ArrayList<py> c(int i, int i2) {
        ...
        try {
            installedPackages = this.mPackageManager.getInstalledPackages(co(i));
        } catch (Exception e) {
            e.printStackTrace();
