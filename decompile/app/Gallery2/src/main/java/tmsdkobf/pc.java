...
public final class pc {
    ...
    private void a(final a aVar) {
        ...
        if (this.Gp.containsKey(Integer.valueOf(aVar.GC))) {
            jq.ct().a(new Runnable(this) {
                ...
                public void run() {
                    this.Gs.a(Process.myPid(), aVar.GC, 0, aVar.GF, null, oi.bX(-50000), 0);
                }
    ...
    public void a(int i, long j, int i2, long j2, int i3, fs fsVar, fs fsVar2, int i4, lg lgVar, long j3, long j4) {
        ...
        a aVar = new a(this, i, this.Gl.fQ(), i2, j2, j, i3, fsVar, fsVar2, i4, lgVar, j3, j4);
    ...
    public li u(final int i, final int i2) {
        li liVar = null;
        synchronized (this.Gq) {
