...
public class pv {
    ...
    private boolean a(b bVar) throws IOException {
        ...
        this.IS = bVar;
        this.IO = a(InetAddress.getByName(bVar.ga()), bVar.getPort());
        if (this.IO == null) {
            return false;
        }
        switch (this.IJ) {
    ...
    private boolean hq() {
        ...
        if (!this.IO.isInputShutdown()) {
            try {
                ...
                mj.bA(ErrorCode.ERR_CORRECTION_PROFILE_UPLOAD_FAIL);
        ...
        try {
            ...
            mj.bA(ErrorCode.ERR_CORRECTION_LOCAL_TEMPLATE_UNMATCH);
            d.e("TcpNetwork", th2);
        }
        if (!this.IO.isOutputShutdown()) {
            try {
                ...
                mj.bA(ErrorCode.ERR_CORRECTION_LOCAL_NO_TEMPLATE);
        ...
        try {
            ...
            mj.bA(ErrorCode.ERR_CORRECTION_PROFILE_ILLEGAL);
