...
public class gr {
    public static String pn = Environment.getExternalStorageDirectory().getAbsolutePath();
    private static List<String> po = gq.aT();
    ...
    private static gu b(Context context, boolean z) {
        gw gwVar = null;
        cx cxVar = (cx) nj.b(TMSDKContext.getApplicaionContext(), UpdateConfig.intToString(40225) + ".dat", UpdateConfig.intToString(40225), new cx(), XmlUtils.INPUT_ENCODING);
        if (cxVar == null || cxVar.gw == null) {
