...
public class if extends BaseManagerC {
    ...
    private final HashMap<String, lc> rI = new HashMap(5);
    private ReentrantReadWriteLock rJ = new ReentrantReadWriteLock();
    private HashMap<String, Integer> rK = null;
    private HashMap<Long, lo> rL = new HashMap();
