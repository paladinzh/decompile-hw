...
public class gk {
    ...
    public static Set<String> a(final gi giVar, final a aVar, final boolean z) {
        final Set<String> hashSet = new HashSet();
        String[] strArr = new String[]{giVar.om};
        DeepCleanEngine deepCleanEngine = SdcardScannerFactory.getDeepCleanEngine(new Callback() {
    ...
    public static List<gm> aP() {
        cx cxVar = (cx) nj.b(TMSDKContext.getApplicaionContext(), UpdateConfig.intToString(40248) + ".dat", UpdateConfig.intToString(40248), new cx(), XmlUtils.INPUT_ENCODING);
        ...
        while (it.hasNext()) {
            cw cwVar = (cw) it.next();
            if (GpsMeasureMode.MODE_3_DIMENSIONAL.equals(cwVar.go)) {
                gm gmVar = new gm();
                gmVar.pa = cwVar.gp;
