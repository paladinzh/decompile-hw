...
public final class ma {
    ...
    void a(lf lfVar, int i, int i2) {
        String by = by(i);
        String string = lfVar.getString(by, null);
        lfVar.m(by, string != null ? string + "|" + String.valueOf(i2) : String.valueOf(i2));
    }
    ...
    void e(int i, String str) {
        if (str != null && str.length() > 0) {
            String by = by(i);
            String string = ew().getString(by, null);
            if (string == null) {
                string = "";
            }
            ...
            if (stringBuilder.length() <= 16384) {
                ew().m(by, stringBuilder.toString());
            }
        }
    }
    ...
    void n(int i, int i2) {
        ...
        String string = eu().getString(by, null);
        ArrayList arrayList = new ArrayList();
        lz lzVar = new lz();
        lzVar.Ap = i;
        ...
        if (w != null) {
            ...
            eu().m(by, stringBuilder.toString());
        }
    }
