...
public final class mu {
    ...
    private static volatile long BI = 0;
    private static volatile long BJ = 0;
    private static Object BK = new Object();
    private static volatile String BL;
    private static ArrayList<Pair<Integer, Long>> BM = new ArrayList();
    ...
    private String Bn;
    private int Bo;
    private String Bq = "GET";
    private HttpURLConnection Br;
    private int Bs = -1;
    private Hashtable<String, String> Bt = new Hashtable(0);
    private boolean Bu = false;
    private boolean Bv = true;
    private byte Bw = (byte) 0;
    private byte Bx = (byte) 0;
    ...
    public int fc() throws NetWorkException {
        ...
        if (fb) {
            throw new NetWorkException(-1000, "sendRequest() is forbidden couldNotConnect");
        }
        int i;
        try {
            byte b2;
