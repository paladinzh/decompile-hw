...
public class ru implements Callback {
    a NQ;
    boolean OL = false;
    HashMap<String, rm> OM = new HashMap();
    HashMap<String, rm> ON = new HashMap();
    HashMap<String, rm> OO = new HashMap();
    List<String> OP = new ArrayList();
    List<rm> OQ = new ArrayList();
    FileScanResult OR = new FileScanResult();
    int OS = 7;
    Context mContext;
    ...
    private boolean jL() {
        ...
        if ((this.OS & 4) != 0) {
            ...
            rmVar22.pf = "0";
            if ((this.OS & 256) != 0) {
                rmVar22.mFileName = "/\\.(zip|rar|pdf|doc|apk|ppt)";
            }
            this.OQ.add(rmVar22);
