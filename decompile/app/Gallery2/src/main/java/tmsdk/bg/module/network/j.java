...
final class j {
    nc nf = new nc("traffic_correction_setting");
    private final String zo = "MATCH_RULE0";
    private final String zp = "#COLUMN0#";
    private final String zq = "#ITEM0#";
    private final String zr = "MATCH_RULE1";
    private final String zs = "#COLUMN1#";
    private final String zt = "#ITEM1#";
    int zu = 0;
