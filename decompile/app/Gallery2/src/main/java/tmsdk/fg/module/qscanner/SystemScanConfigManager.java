...
public class SystemScanConfigManager {
    ...
    private List<ea> Mx = new ArrayList();
    private List<ea> My = new ArrayList();
    private eb Mz;
    ...
    private void jp() {
        this.Mz = (eb) nj.a(this.mContext, UpdateConfig.SYSTEM_SCAN_CONFIG_NAME, UpdateConfig.intToString(30001), new eb(), XmlUtils.INPUT_ENCODING);
