...
final class d extends BaseManagerF {
    ...
    private byte[] Mc = new byte[0];
    private boolean Md;
    private Object Me = new Object();
    private boolean Mf = false;
    private boolean Mg = false;
    private Object Mh = new Object();
    private String[] Mi = new String[]{"image", "icon", "photo", "music", "dcim", "weibo"};
    ...
    private ArrayList<QScanResultEntity> b(int i, final QScanListenerV2 qScanListenerV2, boolean z) {
        String[] strArr;
        ...
        qxVar.KH = strArr;
        QSdcardScanner qSdcardScanner = SdcardScannerFactory.getQSdcardScanner(2, new a(this) {
            ...
            public void onFound(int i, QFile qFile) {
                ...
                this.Ml.a(1, qScanListenerV2);
                if (!this.Ml.b(1, qScanListenerV2)) {
                    py pyVar = new py();
                    pyVar.O(true);
                    ...
                    if (a != null) {
                        arrayList.add(a);
                        if (qScanListenerV2 != null) {
                            qScanListenerV2.onScanProgress(1, -1, a);
                        }
                    }
                }
            }
        }, qxVar);
        qSdcardScanner.registerProgressListener(9999, new ProgressListener(this) {
            final /* synthetic */ d Ml;

            public boolean onScanPathChange(String str) {
                String cG = nb.cG(str);
                if (arrayList2.contains(cG)) {
                    return false;
                }
                arrayList2.add(cG);
                this.Ml.a(1, qScanListenerV2);
    ...
    private boolean b(int i, QScanListenerV2 qScanListenerV2) {
        synchronized (this.Mh) {
            if (!this.Mf) {
                return false;
            } else if (!(qScanListenerV2 == null || this.Mg)) {
    ...
    ArrayList<QScanResultEntity> a(final QScanListenerV2 qScanListenerV2) {
        b anonymousClass3 = new b(this) {
            final /* synthetic */ d Ml;

            public boolean fH() {
                this.Ml.a(3, qScanListenerV2);
                return this.Ml.b(3, qScanListenerV2);
            }
        };
        if (qScanListenerV2 != null) {
    ...
    ArrayList<QScanResultEntity> b(final QScanListenerV2 qScanListenerV2) {
        b anonymousClass4 = new b(this) {
            final /* synthetic */ d Ml;

            public boolean fH() {
                this.Ml.a(4, qScanListenerV2);
                return this.Ml.b(4, qScanListenerV2);
            }
        };
        if (qScanListenerV2 != null) {
    ...
    String getVirusBaseVersion(Context context) {
        ...
        return new SimpleDateFormat("yyyyMMdd").format(date) + (date.getHours() <= 12 ? GpsStatus.IN_PROGRESS : "B");
    }
    ...
    List<QScanAdBehaviorInfo> loadBehaviorConfig() {
        cx cxVar = (cx) nj.a(this.mContext, UpdateConfig.ADB_DES_LIST_NAME, UpdateConfig.intToString(40002), new cx(), XmlUtils.INPUT_ENCODING);
