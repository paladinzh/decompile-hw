...
class ExifOutputStream extends FilterOutputStream {
    ...
    protected ExifOutputStream(OutputStream ou, ExifInterface iRef) {
        super(new BufferedOutputStream(ou, HicloudAccountReceiver.MSG_HICLOUD_ACCOUNT_LOGOUT));
    ...
    private int calculateAllOffset() {
        ...
        GalleryLog.e("ExifOutputStream", "ifd1 is null, return the current offset!");
        return offset;
    }
    ...
    static void writeTagValue(ExifTag tag, OrderedDataOutputStream dataOutputStream) throws IOException {
        ...
        switch (tag.getDataType()) {
            ...
            case (short) 2:
                ...
                if (buf.length != 0 || componentCount != 0) {
                    if (buf.length == componentCount) {
