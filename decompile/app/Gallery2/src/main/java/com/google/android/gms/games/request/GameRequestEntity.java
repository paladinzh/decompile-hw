...
public final class GameRequestEntity implements SafeParcelable, GameRequest {
    ...
    static boolean a(GameRequest gameRequest, Object obj) {
        ...
        if (ep.equal(gameRequest2.getGame(), gameRequest.getGame()) && ep.equal(gameRequest2.fU(), gameRequest.fU()) && ep.equal(gameRequest2.getRequestId(), gameRequest.getRequestId()) && ep.equal(gameRequest2.getSender(), gameRequest.getSender()) && Arrays.equals(b(gameRequest2), b(gameRequest)) && ep.equal(Integer.valueOf(gameRequest2.getType()), Integer.valueOf(gameRequest.getType())) && ep.equal(Long.valueOf(gameRequest2.getCreationTimestamp()), Long.valueOf(gameRequest.getCreationTimestamp()))) {
            if (!ep.equal(Long.valueOf(gameRequest2.getExpirationTimestamp()), Long.valueOf(gameRequest.getExpirationTimestamp()))) {
            }
            return z;
        }
        z = false;
