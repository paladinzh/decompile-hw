...
public final class dg extends de {
    ...
    private static WebResourceResponse d(Context context, String str, String str2) throws IOException {
        ...
        try {
            ...
            WebResourceResponse webResourceResponse = new WebResourceResponse("application/javascript", XmlUtils.INPUT_ENCODING, new ByteArrayInputStream(cv.a(new InputStreamReader(httpURLConnection.getInputStream())).getBytes(XmlUtils.INPUT_ENCODING)));
