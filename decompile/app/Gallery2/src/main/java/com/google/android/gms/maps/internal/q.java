...
public class q {
    ...
    public static c A(Context context) throws GooglePlayServicesNotAvailableException {
        ...
        PC = C(context);
        try {
            PC.a(c.h(getRemoteContext(context).getResources()), 4323000);
            return PC;
    ...
    private static Class<?> hb() {
        try {
            return VERSION.SDK_INT >= 15 ? Class.forName("com.google.android.gms.maps.internal.CreatorImpl") : Class.forName("com.google.android.gms.maps.internal.CreatorImplGmm6");
        } catch (Throwable e) {
