...
public class h implements SafeParcelable {
    ...
    public boolean equals(Object obj) {
        ...
        h hVar = (h) obj;
        if (this.wj == hVar.wj && ep.equal(this.vi, hVar.vi) && Arrays.equals(this.Rm, hVar.Rm) && Arrays.equals(this.Rn, hVar.Rn) && Arrays.equals(this.Ro, hVar.Ro) && ep.equal(this.Rp, hVar.Rp) && ep.equal(this.Rq, hVar.Rq) && ep.equal(this.Rr, hVar.Rr) && ep.equal(this.Rs, hVar.Rs) && ep.equal(this.Rt, hVar.Rt)) {
            z = true;
        }
        return z;
    }
