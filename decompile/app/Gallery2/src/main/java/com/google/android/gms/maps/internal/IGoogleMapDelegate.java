...
public interface IGoogleMapDelegate extends IInterface {
    ...
    public static abstract class a extends Binder implements IGoogleMapDelegate {
        ...
        private static class a implements IGoogleMapDelegate {
            ...
            public CameraPosition getCameraPosition() throws RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    CameraPosition createFromParcel = obtain2.readInt() == 0 ? null : CameraPosition.CREATOR.createFromParcel(obtain2);
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static IGoogleMapDelegate V(IBinder iBinder) {
            ...
            return (queryLocalInterface != null && (queryLocalInterface instanceof IGoogleMapDelegate)) ? (IGoogleMapDelegate) queryLocalInterface : new a(iBinder);
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 9:
                    data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                    IPolylineDelegate addPolyline = addPolyline(data.readInt() == 0 ? null : PolylineOptions.CREATOR.createFromParcel(data));
                    reply.writeNoException();
                    if (addPolyline != null) {
                ...
                case 10:
                    data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                    e addPolygon = addPolygon(data.readInt() == 0 ? null : PolygonOptions.CREATOR.createFromParcel(data));
                    reply.writeNoException();
                    if (addPolygon != null) {
                ...
                case 11:
                    data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                    d addMarker = addMarker(data.readInt() == 0 ? null : MarkerOptions.CREATOR.createFromParcel(data));
                    reply.writeNoException();
                    if (addMarker != null) {
                ...
                case 12:
                    data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                    c addGroundOverlay = addGroundOverlay(data.readInt() == 0 ? null : GroundOverlayOptions.CREATOR.createFromParcel(data));
                    reply.writeNoException();
                ...
                case 13:
                    data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                    f addTileOverlay = addTileOverlay(data.readInt() == 0 ? null : TileOverlayOptions.CREATOR.createFromParcel(data));
                    reply.writeNoException();
                ...
                case AMapException.ERROR_CODE_QUOTA /*35*/:
                    data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                    b addCircle = addCircle(data.readInt() == 0 ? null : CircleOptions.CREATOR.createFromParcel(data));
                    reply.writeNoException();
                    if (addCircle != null) {
