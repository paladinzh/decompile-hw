...
public class hj implements SafeParcelable {
    ...
    private static void a(double d, double d2) {
        ...
        if (d2 <= VirtualEarthProjection.MaxLongitude) {
            obj = null;
        }
        if (obj != null || d2 < VirtualEarthProjection.MinLongitude) {
    ...
    public boolean equals(Object obj) {
        ...
        hj hjVar = (hj) obj;
        return this.KZ == hjVar.KZ && this.KX == hjVar.KX && this.KY == hjVar.KY && this.KW == hjVar.KW;
    }
