...
public final class LatLng implements SafeParcelable {
    ...
    LatLng(int versionCode, double latitude, double longitude) {
        this.wj = versionCode;
        if (VirtualEarthProjection.MinLongitude > longitude || longitude >= VirtualEarthProjection.MaxLongitude) {
            this.longitude = ((((longitude - VirtualEarthProjection.MaxLongitude) % 360.0d) + 360.0d) % 360.0d) - VirtualEarthProjection.MaxLongitude;
        } else {
