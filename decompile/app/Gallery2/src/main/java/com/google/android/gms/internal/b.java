...
import com.huawei.gallery.app.HwCustSlideShowPageImpl;
...
public enum b {
    ...
    INTERVAL(HwCustSlideShowPageImpl.KEY_INTERVAL),
    ...
    PARTITION("partition"),
    PIXEL("pixel"),
    PLATFORM(TMSDKContext.CON_PLATFORM),
    PRICES("prices"),
    PRIORITY("priority"),
    PRODUCT(TMSDKContext.CON_PRODUCT),
