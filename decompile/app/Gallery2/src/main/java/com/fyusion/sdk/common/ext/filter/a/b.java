...
public class b extends a<BlurFilter> implements BlockFilter {
    ...
    private float f = WMElement.CAMERASIZEVALUE1B1;
    private p g = new p();
    private int h = -1;
    private int i = -1;
    private int j = -1;
    ...
    public ArrayList<Double> a(double d) {
        ...
        double[] dArr = new double[]{WeightedLatLng.DEFAULT_INTENSITY, 0.5d, 0.25d, 0.125d, 0.0625d, 0.03125d, 0.015d, 0.008d};
        double[] dArr2 = new double[]{WeightedLatLng.DEFAULT_INTENSITY, 0.45d, 0.225d, 0.1125d, 0.05625d, 0.028125d, 0.0135d, 0.007200000000000001d};
        while (d < dArr2[i]) {
            i++;
        }
    ...
    public void a(o oVar, o oVar2, int i, boolean z, s sVar) {
        ...
        if (i2 >= 0) {
            ...
            float[] fArr3 = new float[]{WMElement.CAMERASIZEVALUE1B1 / ((float) i4), 0.0f};
            ...
            fArr3 = new float[]{0.0f, WMElement.CAMERASIZEVALUE1B1 / ((float) i5)};
            GLES20.glUniform2f(GLES20.glGetUniformLocation(sVar.f, "singleStepOffset"), fArr3[0], fArr3[1]);
            GLES20.glBindFramebuffer(36160, oVar2.a);
            GLES20.glClearColor(0.0f, 0.0f, 0.0f, WMElement.CAMERASIZEVALUE1B1);
            GLES20.glDrawArrays(6, 0, 4);
    ...
    public void a(o[] oVarArr, boolean z, s sVar) {
        ...
        double d = sqrt <= 10.0d ? WeightedLatLng.DEFAULT_INTENSITY : 10.0d / sqrt;
        double d2 = sqrt * d;
