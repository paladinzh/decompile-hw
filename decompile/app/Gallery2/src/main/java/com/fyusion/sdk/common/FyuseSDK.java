...
import com.fyusion.sdk.common.internal.a.a;
...
public class FyuseSDK {
    ...
    private static void a(Context context) throws IllegalStateException {
        ...
        DLog.i("FyuseSDK", "Fyuse SDK version: " + getFullVersion());
    ...
    private static synchronized void a(Context context, String str, String str2, Bundle bundle, boolean z) {
        synchronized (FyuseSDK.class) {
            if (c.booleanValue()) {
                ...
                d = bundle;
                a(context);
                Fyulytics.sharedInstance().init(str);
                a.a(str);
                a.a().a(str, str2, z);
            } else {
    ...
    public static String getBuildDate() {
        return "2017-08-08T21:21:58-07:00";
    }
