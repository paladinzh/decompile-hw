...
public class l implements Callback {
    ...
    public RequestManager a(Fragment fragment) {
        ...
        } else if (e.c() || VERSION.SDK_INT < 17) {
    ...
    public RequestManager a(android.support.v4.app.Fragment fragment) {
        if (fragment.getActivity() == null) {
            throw new IllegalArgumentException("You cannot start a load on a fragment before it is attached");
        } else if (e.c()) {
            return a(fragment.getActivity().getApplicationContext());
    ...
    o a(android.support.v4.app.FragmentManager fragmentManager, android.support.v4.app.Fragment fragment) {
        ...
        android.support.v4.app.Fragment oVar2 = new o();
        oVar2.a(fragment);
        this.b.put(fragmentManager, oVar2);
        fragmentManager.beginTransaction().add(oVar2, "com.fyusion.manager").commitAllowingStateLoss();
