...
public class MeshView extends FrameLayout {
    ...
    private void a(Context context) {
        ...
        this.f.setColorMatrix(new Matrix3f(new float[]{0.0f, 0.0f, WMElement.CAMERASIZEVALUE1B1, 0.0f, WMElement.CAMERASIZEVALUE1B1, 0.0f, WMElement.CAMERASIZEVALUE1B1, 0.0f, 0.0f}));
        this.e = ScriptIntrinsicBlur.create(this.d, Element.U8_4(this.d));
        this.e.setRadius(WMElement.CAMERASIZEVALUE1B1);
    }
    ...
    public void setImage(Bitmap bitmap, IntVec intVec, FloatVec floatVec, boolean z, boolean z2, float f, Matrix matrix) {
        if (bitmap != null && this.a != null && this.k != null && this.b != null) {
            ...
            while (true) {
                ...
                try {
                    ...
                    if (z3) {
                        ...
                        f4 = WMElement.CAMERASIZEVALUE1B1 - f4;
                    }
                    if (z2) {
                        f3 = WMElement.CAMERASIZEVALUE1B1 - f3;
                        f5 = WMElement.CAMERASIZEVALUE1B1 - f5;
                    }
            ...
            if (this.b.getAlpha() != WMElement.CAMERASIZEVALUE1B1) {
                this.b.setAlpha(WMElement.CAMERASIZEVALUE1B1);
            }
            this.b.forceLayout();
            if (!this.c) {
                float width2;
                ...
                if (obj == null) {
                    ...
                    if (f > 0.0f) {
                        matrix2.setRotate(BitmapDescriptorFactory.HUE_CYAN);
                ...
                if (!z) {
                    this.a.setScaleY(WMElement.CAMERASIZEVALUE1B1);
                } else if (f <= 0.0f) {
                    if (obj == null) {
                        this.a.setScaleX(GroundOverlayOptions.NO_DIMENSION);
                    } else {
                        this.a.setScaleY(GroundOverlayOptions.NO_DIMENSION);
                    }
                }
                this.c = true;
            }
