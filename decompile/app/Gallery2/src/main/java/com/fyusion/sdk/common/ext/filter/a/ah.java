...
public class ah extends a<VignetteFilter> implements BlockFilter {
    private float[] c = new float[]{WMElement.CAMERASIZEVALUE1B1, WMElement.CAMERASIZEVALUE1B1};
    private float[] d = new float[]{0.5f, 0.5f};
    private float[] e = new float[]{0.0f, 0.0f, 0.0f};
    private float f = 0.0f;
    private float g = WMElement.CAMERASIZEVALUE1B1;
    private int h = -1;
    private int i = -1;
    private int j = -1;
    private int k = -1;
    ...
    public void a(@NonNull VignetteFilter vignetteFilter) {
        ...
        a(vignetteFilter.getVignetteStart(), WMElement.CAMERASIZEVALUE1B1 - vignetteFilter.getValue());
    }
    ...
    public float getValue() {
        return WMElement.CAMERASIZEVALUE1B1 - i();
    }
