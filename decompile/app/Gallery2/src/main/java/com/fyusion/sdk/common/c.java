...
public class c {
    ...
    public static a a() {
        a aVar = new a();
        aVar.a = WeightedLatLng.DEFAULT_INTENSITY;
        aVar.b = 0.0d;
        aVar.c = 0.0d;
        aVar.d = 0.0d;
        aVar.e = 0.0d;
        aVar.f = WeightedLatLng.DEFAULT_INTENSITY;
        aVar.g = 0.0d;
        aVar.h = 0.0d;
        aVar.i = 0.0d;
        aVar.j = 0.0d;
        aVar.k = WeightedLatLng.DEFAULT_INTENSITY;
        aVar.l = 0.0d;
        aVar.m = 0.0d;
        aVar.n = 0.0d;
        aVar.o = 0.0d;
        aVar.p = WeightedLatLng.DEFAULT_INTENSITY;
        return aVar;
    }
    ...
    public static b b() {
        b bVar = new b();
        bVar.a = WeightedLatLng.DEFAULT_INTENSITY;
        bVar.b = 0.0d;
        bVar.c = 0.0d;
        bVar.d = WeightedLatLng.DEFAULT_INTENSITY;
        bVar.e = 0.0d;
        bVar.f = 0.0d;
        return bVar;
    }
