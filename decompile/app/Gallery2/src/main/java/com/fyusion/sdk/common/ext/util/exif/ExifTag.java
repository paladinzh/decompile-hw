...
public class ExifTag {
    ...
    public byte getValueAsByte(byte b) {
        byte[] valueAsBytes = getValueAsBytes();
        return (valueAsBytes != null && valueAsBytes.length >= 1) ? valueAsBytes[0] : b;
    }

    public byte[] getValueAsBytes() {
        return !(this.h instanceof byte[]) ? null : (byte[]) this.h;
    }
    ...
    public long getValueAsLong(long j) {
        long[] valueAsLongs = getValueAsLongs();
        return (valueAsLongs != null && valueAsLongs.length >= 1) ? valueAsLongs[0] : j;
    }

    public long[] getValueAsLongs() {
        return !(this.h instanceof long[]) ? null : (long[]) this.h;
    }

    public Rational getValueAsRational(long j) {
        return getValueAsRational(new Rational((long) ((int) j), 1));
    }

    public Rational getValueAsRational(Rational rational) {
        Rational[] valueAsRationals = getValueAsRationals();
        return (valueAsRationals != null && valueAsRationals.length >= 1) ? valueAsRationals[0] : rational;
    }

    public Rational[] getValueAsRationals() {
        return !(this.h instanceof Rational[]) ? null : (Rational[]) this.h;
    }
    ...
    public String getValueAsString(String str) {
        ...
        return valueAsString != null ? valueAsString : str;
    }
    ...
    public boolean setTimeValue(long j) {
        boolean value;
        synchronized (j) {
            value = setValue(j.format(new Date(j)));
        }
        return value;
    }
