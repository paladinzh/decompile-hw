...
public class FrameExtractor {
    ...
    public boolean startExtractor() {
        ...
        return startExtractor(g.a().a(this.descriptor.getFyusePath()).getPath());
    }
        ...
        try {
            ...
            while (i2 < this.extractor.getTrackCount()) {
                try {
                    ...
                    DLog.e("FrameExtractor", "unable to get track format");
                    return false;
                }
            }
            i = -1;
            ...
            if (i >= 0) {
                ...
                try {
                    ...
                    if (integer > 0) {
                        ...
                        try {
                            ...
                            for (integer = i2; integer < 100; integer *= 2) {
                            ...
                            DLog.e("startExtractor", "caught general exception from decoder.configure with output surface: " + e2.getMessage());
                ...
                try {
                    ...
                    DLog.e("startExtractor", "unable to create decoder for mime ");
                    return false;
                }
            }
            DLog.e("FrameExtractor", "unable to find a video track");
            return false;
        } catch (IOException e5) {
            DLog.e("FrameExtractor", "could not set data source");
            return false;
        }
    }
