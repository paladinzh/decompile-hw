...
class InputSurface {
    ...
    private void eglSetup() {
        ...
        if (this.mEGLDisplay == EGL14.EGL_NO_DISPLAY) {
            throw new RuntimeException("InputSurface unable to get EGL14 display");
        }
        ...
        if (EGL14.eglInitialize(this.mEGLDisplay, version, 0, version, 1)) {
            ...
            if (EGL14.eglChooseConfig(this.mEGLDisplay, new int[]{12324, 8, 12323, 8, 12322, 8, 12352, 4, 12610, 1, 12344}, 0, configs, 0, configs.length, new int[1], 0)) {
                ...
                if (this.mEGLContext == null) {
                    throw new RuntimeException("InputSurface null context");
                }
                this.mEGLSurface = EGL14.eglCreateWindowSurface(this.mEGLDisplay, configs[0], this.mSurface, new int[]{12344}, 0);
                checkEglError("eglCreateWindowSurface");
                if (this.mEGLSurface == null) {
                    throw new RuntimeException("InputSurface surface was null");
                }
                return;
            }
            throw new RuntimeException("InputSurface unable to find RGB888+recordable ES2 EGL config");
        }
        this.mEGLDisplay = null;
        throw new RuntimeException("InputSurface unable to initialize EGL14");
    }
    ...
    public void release() {
        ...
        GalleryLog.d("InputSurface", "InputSurface mSurface released");
    ...
    public void makeCurrent() {
        if (!EGL14.eglMakeCurrent(this.mEGLDisplay, this.mEGLSurface, this.mEGLSurface, this.mEGLContext)) {
            throw new RuntimeException("InputSurface eglMakeCurrent failed");
        }
    }
