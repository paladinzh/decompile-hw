...
public class AdjustState extends EditorState {
    ...
    public AdjustState(Context context, ViewGroup layout, BaseEditorView editorView) {
        super(context, layout, editorView);
        this.mActionInfo = new ActionInfo(context.getResources().getString(R.string.simple_editor_adjust), Action.BACK, null, false);
    }
    ...
    protected EditorUIController createUIController() {
        ...
        this.mAdjustUIController.setAdapter(new EditorTextViewAdapter(this.mContext, this.mEditorView.getEditorManager().getAdjustViewAdapter()));
