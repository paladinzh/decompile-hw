...
public abstract class MyAbsSpinner extends MyAdapterView<SpinnerAdapter> {
    ...
    class RecycleBin {
        ...
        void clear() {
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (view != null) {
                    MyAbsSpinner.this.removeDetachedView(view, true);
                }
            }
            scrapHeap.clear();
        }
    ...
    static class SavedState extends BaseSavedState {
        ...
        public String toString() {
            return "MyAbsSpinner.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " selectedId=" + this.selectedId + " position=" + this.position + "}";
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(resolveSizeAndState(preferredWidth, widthMeasureSpec, 0), heightSize);
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(MyAbsSpinner.class.getName());
    }

    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(MyAbsSpinner.class.getName());
    }
}
