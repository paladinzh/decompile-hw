...
public class Gradient {
    ...
    private HashMap<Integer, a> a() {
        ...
        if (this.c[this.c.length - 1] != WMElement.CAMERASIZEVALUE1B1) {
            int length = this.c.length - 1;
            hashMap.put(Integer.valueOf((int) (((float) this.a) * this.c[length])), new a(this.b[length], this.b[length], ((float) this.a) * (WMElement.CAMERASIZEVALUE1B1 - this.c[length])));
        }
        return hashMap;
    }
