...
public class k extends TextureView implements SurfaceTextureListener {
    ...
    private class b extends a {
        ...
        public b(k kVar, int i, int i2, int i3, int i4, int i5, int i6) {
            this.i = kVar;
            super(kVar, new int[]{12324, i, 12323, i2, 12322, i3, 12321, i4, 12325, i5, 12326, i6, 12344});
            this.c = i;
            this.d = i2;
            this.e = i3;
            this.f = i4;
        ...
        public void a() {
            ...
            if (this.b != EGL10.EGL_NO_DISPLAY) {
                if (this.a.eglInitialize(this.b, new int[2])) {
                    k kVar = (k) this.f.get();
                    if (kVar != null) {
                        this.d = kVar.f.a(this.a, this.b);
                        this.e = kVar.g.a(this.a, this.b, this.d);
                    } else {
                        this.d = null;
                        this.e = null;
                    }
