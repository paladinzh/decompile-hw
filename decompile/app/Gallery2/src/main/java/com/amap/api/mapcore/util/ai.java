...
public class ai {
    ...
    public static LatLng a(Context context, LatLng latLng) {
        ...
        String a = fg.a(context, "libwgs2gcj.so");
    ...
    private static double a(double d) {
        return Math.sin((3000.0d * d) * (a / VirtualEarthProjection.MaxLongitude)) * 2.0E-5d;
    }

    private static double b(double d) {
        return Math.cos((3000.0d * d) * (a / VirtualEarthProjection.MaxLongitude)) * 3.0E-6d;
    }
