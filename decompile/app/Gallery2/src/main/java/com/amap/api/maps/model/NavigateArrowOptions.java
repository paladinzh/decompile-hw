...
public final class NavigateArrowOptions implements Parcelable {
    ...
    private int d = Color.argb(221, 87, 235, SmsCheckResult.ESCT_204);
    private int e = Color.argb(SmsCheckResult.ESCT_170, 0, SmsCheckResult.ESCT_172, SmsCheckResult.ESCT_146);
