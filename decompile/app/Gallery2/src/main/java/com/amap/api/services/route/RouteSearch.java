...
public class RouteSearch {
    ...
    public static class BusRouteQuery implements Parcelable, Cloneable {
        ...
        public BusRouteQuery clone() {
            try {
                ...
                d.a(e, "RouteSearch", "BusRouteQueryclone");
            }
    ...
    public static class DriveRouteQuery implements Parcelable, Cloneable {
        ...
        public int hashCode() {
            ...
            hashCode = (((hashCode + hashCode2) * 31) + this.b) * 31;
            if (this.c != null) {
                i = this.c.hashCode();
            }
            return hashCode + i;
        ...
        public DriveRouteQuery clone() {
            try {
                ...
                d.a(e, "RouteSearch", "DriveRouteQueryclone");
            }
    ...
    public static class FromAndTo implements Parcelable, Cloneable {
        ...
        public FromAndTo clone() {
            try {
                ...
                d.a(e, "RouteSearch", "FromAndToclone");
            }
    ...
    public static class WalkRouteQuery implements Parcelable, Cloneable {
        ...
        public WalkRouteQuery clone() {
            try {
                ...
                d.a(e, "RouteSearch", "WalkRouteQueryclone");
            }
    ...
    public WalkRouteResult calculateWalkRoute(WalkRouteQuery walkRouteQuery) throws AMapException {
        ...
        WalkRouteResult walkRouteResult = (WalkRouteResult) new u(this.b, clone).g();
        ...
        new Thread(this) {
            ...
            public void run() {
                ...
                try {
                    ...
                    d.a(e, "RouteSearch", "calculateWalkRouteAsyn");
    ...
    public BusRouteResult calculateBusRoute(BusRouteQuery busRouteQuery) throws AMapException {
        ...
        BusRouteResult busRouteResult = (BusRouteResult) new a(this.b, clone).g();
        ...
        new Thread(this) {
            ...
            public void run() {
                ...
                try {
                    ...
                    d.a(e, "RouteSearch", "calculateBusRouteAsyn");
                    bundle.putInt("errorCode", e.getErrorCode());
                    obtainMessage.obj = this.b.a;
                    bundle.putParcelable("result", parcelable);
                    obtainMessage.setData(bundle);
    ...
    public DriveRouteResult calculateDriveRoute(DriveRouteQuery driveRouteQuery) throws AMapException {
        ...
        DriveRouteResult driveRouteResult = (DriveRouteResult) new f(this.b, clone).g();
        ...
        new Thread(this) {
            ...
            public void run() {
                ...
                try {
                    ...
                    d.a(e, "RouteSearch", "calculateDriveRouteAsyn");
                    bundle.putInt("errorCode", e.getErrorCode());
                    obtainMessage.obj = this.b.a;
                    bundle.putParcelable("result", parcelable);
                    obtainMessage.setData(bundle);
