...
public final class VisibleRegion implements Parcelable {
    ...
    public int hashCode() {
        return eh.a(new Object[]{this.nearLeft, this.nearRight, this.farLeft, this.farRight, this.latLngBounds});
    }
    ...
    public String toString() {
        return eh.a(eh.a("nearLeft", this.nearLeft), eh.a("nearRight", this.nearRight), eh.a("farLeft", this.farLeft), eh.a("farRight", this.farRight), eh.a("latLngBounds", this.latLngBounds));
    }
}
