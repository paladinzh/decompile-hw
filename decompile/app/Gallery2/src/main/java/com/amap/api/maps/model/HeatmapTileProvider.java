...
public class HeatmapTileProvider implements TileProvider {
    ...
    private static final float[] b = new float[]{0.2f, WMElement.CAMERASIZEVALUE1B1};
    private a c;
    ...
    public Tile getTile(int i, int i2, int i3) {
        ...
        if (d4 < 0.0d) {
            d8 = -1.0d;
            arrayList = this.c.a(new ds(WeightedLatLng.DEFAULT_INTENSITY + d4, WeightedLatLng.DEFAULT_INTENSITY, d6, d7));
        } else if (d5 > WeightedLatLng.DEFAULT_INTENSITY) {
            a = this.c.a(new ds(0.0d, d5 - WeightedLatLng.DEFAULT_INTENSITY, d6, d7));
            d = WeightedLatLng.DEFAULT_INTENSITY;
            dsVar = new ds(d4, d5, d6, d7);
            if (dsVar.a(new ds(this.e.a - d2, this.e.c + d2, this.e.b - d2, d2 + this.e.d))) {
    ...
    static ds a(Collection<WeightedLatLng> collection) {
            ...
            for (i4 = 0; i4 < length; i4++) {
                ...
                if (d != 0.0d) {
                    ...
                    while (i6 < i5) {
                        ...
                        dArr4[i4] = dArr4[i4] + (dArr2[i6 - (i - floor)] * d);
                        i6++;
                    }
                }
            }
            ...
            for (i = 0; i < length; i++) {
                ...
                if (d != 0.0d) {
                    ...
                    while (i4 < i5) {
                        ...
                        int i7 = i4 - floor;
                        dArr4[i7] = dArr4[i7] + (dArr2[i4 - (i - floor)] * d);
                        i4++;
                    }
                }
            }
    ...
    static double a(Collection<WeightedLatLng> collection, ds dsVar, int i, int i2) {
        double d = dsVar.a;
        double d2 = dsVar.c;
        double d3 = dsVar.b;
        double d4 = dsVar.d;
