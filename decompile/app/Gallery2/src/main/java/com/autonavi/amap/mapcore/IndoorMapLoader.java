...
public class IndoorMapLoader extends BaseMapLoader {
    ...
    private String assScodeToParma(StringBuffer stringBuffer) {
        String d = fi.d(stringBuffer.toString());
        String a = fb.a();
        stringBuffer.append("&ts=" + a + "&");
        stringBuffer.append("scode=" + fb.a(this.mMapCallback.getContext(), a, d));
    ...
    private void processReceivedIndoorData() throws UnsupportedEncodingException {
