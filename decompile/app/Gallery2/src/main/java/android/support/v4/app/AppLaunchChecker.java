...
public class AppLaunchChecker {
    ...
    public static void onActivityCreate(Activity activity) {
        ...
        if (!sp.getBoolean(KEY_STARTED_FROM_LAUNCHER, false)) {
            ...
            if (launchIntent != null && "android.intent.action.MAIN".equals(launchIntent.getAction()) && (launchIntent.hasCategory("android.intent.category.LAUNCHER") || launchIntent.hasCategory("android.intent.category.LEANBACK_LAUNCHER"))) {
