...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflaterFactory {
    ...
    Animation loadAnimation(Fragment fragment, int transit, boolean enter, int transitionStyle) {
        ...
        switch (styleIndex) {
            case 1:
                return makeOpenCloseAnimation(this.mHost.getContext(), 1.125f, WMElement.CAMERASIZEVALUE1B1, 0.0f, WMElement.CAMERASIZEVALUE1B1);
            case 2:
                return makeOpenCloseAnimation(this.mHost.getContext(), WMElement.CAMERASIZEVALUE1B1, 0.975f, WMElement.CAMERASIZEVALUE1B1, 0.0f);
            case 3:
                return makeOpenCloseAnimation(this.mHost.getContext(), 0.975f, WMElement.CAMERASIZEVALUE1B1, 0.0f, WMElement.CAMERASIZEVALUE1B1);
            case 4:
                return makeOpenCloseAnimation(this.mHost.getContext(), WMElement.CAMERASIZEVALUE1B1, 1.075f, WMElement.CAMERASIZEVALUE1B1, 0.0f);
            case 5:
                return makeFadeAnimation(this.mHost.getContext(), 0.0f, WMElement.CAMERASIZEVALUE1B1);
            case 6:
                return makeFadeAnimation(this.mHost.getContext(), WMElement.CAMERASIZEVALUE1B1, 0.0f);
            default:
