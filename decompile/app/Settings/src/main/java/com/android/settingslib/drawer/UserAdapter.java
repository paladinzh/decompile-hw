...
public class UserAdapter implements SpinnerAdapter, ListAdapter {
    ...
    private static List<UserHandle> deleteCloneProfile(UserManager userManager, List<UserHandle> userProfiles) {
        ArrayList<UserHandle> newUserProfiles = new ArrayList();
        for (UserHandle userHandle : userProfiles) {
            UserInfo userInfo = userManager.getUserInfo(userHandle.getIdentifier());
            if (!(userInfo == null || userInfo.isClonedProfile())) {
                newUserProfiles.add(userHandle);
            }
        }
    ...
    public static UserAdapter createUserSpinnerAdapter(UserManager userManager, Context context) {
        List<UserHandle> userProfiles = deleteCloneProfile(userManager, userManager.getUserProfiles());
