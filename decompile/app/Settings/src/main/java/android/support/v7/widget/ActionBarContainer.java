    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mActionBarView != null) {
            ...
            if (!(this.mTabContainer == null || this.mTabContainer.getVisibility() == 8 || mode == 1073741824)) {
                ...
                setMeasuredDimension(getMeasuredWidth(), Math.min(getMeasuredHeightWithMargins(this.mTabContainer) + topMarginForTabs, mode == Integer.MIN_VALUE ? MeasureSpec.getSize(heightMeasureSpec) : HwCustMSimSubscriptionStatusTabFragmentImpl.INVALID));
            }
        }
    }
