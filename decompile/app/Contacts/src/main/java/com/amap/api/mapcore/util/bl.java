...
public class bl {
    ...
    public static String b(Context context) {
        try {
            ...
            cb.a(e, "AppInfo", "getApplicationName");
        } catch (Throwable e2) {
            cb.a(e2, "AppInfo", "getApplicationName");
        }
    }
    ...
    public static String c(Context context) {
        try {
            ...
            cb.a(th, "AppInfo", "getPackageName");
        }
        return b;
    }
    ...
    public static String d(Context context) {
        try {
            ...
            cb.a(e, "AppInfo", "getApplicationVersion");
        } catch (Throwable e2) {
            cb.a(e2, "AppInfo", "getApplicationVersion");
        }
    }
    ...
    public static String e(Context context) {
        try {
            ...
            cb.a(e, "AppInfo", "getSHA1AndPackage");
            return e;
        } catch (Throwable e2) {
            cb.a(e2, "AppInfo", "getSHA1AndPackage");
            return e;
        } catch (Throwable e22) {
            cb.a(e22, "AppInfo", "getSHA1AndPackage");
            return e;
        }
    }
    ...
    public static String f(Context context) {
        try {
            ...
            cb.a(e, "AppInfo", "getKey");
            return d;
        } catch (Throwable e2) {
            cb.a(e2, "AppInfo", "getKey");
            return d;
        }
    }
}
