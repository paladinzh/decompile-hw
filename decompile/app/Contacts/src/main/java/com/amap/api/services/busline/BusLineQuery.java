...
public class BusLineQuery {
    ...
    protected boolean weakEquals(BusLineQuery busLineQuery) {
        if (busLineQuery.getQueryString().equals(this.a) && busLineQuery.getCity().equals(this.b) && busLineQuery.getPageSize() == this.c && busLineQuery.getCategory().compareTo(this.e) == 0) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        hashCode = (((((hashCode + i2) * 31) + this.d) * 31) + this.c) * 31;
        if (this.a != null) {
            i = this.a.hashCode();
        }
        return hashCode + i;
