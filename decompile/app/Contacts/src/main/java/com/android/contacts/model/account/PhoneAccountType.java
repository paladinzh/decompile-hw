...
public class PhoneAccountType extends BaseAccountType {
    private static final List<String> mExtensionPackages = Lists.newArrayList();

    public PhoneAccountType(Context context, String authenticatorPackageName) {
        this.accountType = "com.android.huawei.phone";
        ...
        try {
            ...
            HwLog.e("PhoneAccountType", "Problem building account type", e);
        }
    }
