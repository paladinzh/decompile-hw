...
public class SearchMatch {
    ...
    public static String lettersAndDigitsOnly(String name, boolean keepBlank, boolean keepChinese) {
        return lettersAndDigitsOnly(name, keepBlank, keepChinese, true);
    }
