...
public abstract class zzj<T extends IInterface> implements com.google.android.gms.common.api.Api.zzb, com.google.android.gms.common.internal.zzk.zza {
    ...
    public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        if ((this.zzalu <= 0 ? 1 : null) == null) {
            writer.append(prefix).append("lastConnectedTime=").println(this.zzalu + HwCustPreloadContacts.EMPTY_STRING + simpleDateFormat.format(new Date(this.zzalu)));
        }
        if ((this.zzalt <= 0 ? 1 : null) == null) {
            ...
            writer.append(" lastSuspendedTime=").println(this.zzalt + HwCustPreloadContacts.EMPTY_STRING + simpleDateFormat.format(new Date(this.zzalt)));
        }
        if (this.zzalw > 0) {
            obj = null;
        }
        if (obj == null) {
            ...
            writer.append(" lastFailedTime=").println(this.zzalw + HwCustPreloadContacts.EMPTY_STRING + simpleDateFormat.format(new Date(this.zzalw)));
        }
    }
