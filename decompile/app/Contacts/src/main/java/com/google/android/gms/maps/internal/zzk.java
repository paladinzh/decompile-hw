...
public interface zzk extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzk {
        ...
        public static zzk zzcG(IBinder iBinder) {
            ...
            return (queryLocalInterface != null && (queryLocalInterface instanceof zzk)) ? (zzk) queryLocalInterface : new zza(iBinder);
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 2:
                    data.enforceInterface("com.google.android.gms.maps.internal.IOnLocationChangeListener");
                    zzd(data.readInt() == 0 ? null : (Location) Location.CREATOR.createFromParcel(data));
                    reply.writeNoException();
                    return true;
                case 1598968902:
