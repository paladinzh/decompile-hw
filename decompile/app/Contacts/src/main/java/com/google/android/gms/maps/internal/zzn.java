...
public interface zzn extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzn {
        ...
        public static zzn zzcJ(IBinder iBinder) {
            ...
            return (queryLocalInterface != null && (queryLocalInterface instanceof zzn)) ? (zzn) queryLocalInterface : new zza(iBinder);
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    onMapLongClick(data.readInt() == 0 ? null : LatLng.CREATOR.zzfz(data));
