        ...
        for (int i3 = 0; i3 < arrayList.size(); i3++) {
            ...
            if (i != 4) {
                try {
                    ...
                    e recoder = VMapDataCache.getInstance().getRecoder(str, i);
                ...
                f data = instance.getData(mapSourceGridData.getGridName(), true);
                f data2 = instance.getData(mapSourceGridData.getGridName(), false);
                if (data != null) {
                    mapSourceGridData.obj = data.d;
                }
                if (data2 == null || data2.a == null || data2.a.length <= 0) {
                    arrayList2.add(mapSourceGridData);
                } else {
                    mapCore.putMapData(data2.a, 0, data2.a.length, i, data2.c);
                }
            }
        }
