            ...
            while (i5 < a4.length && e.n) {
                if (i5 < length) {
                    ...
                    if (i5 < length) {
                        ...
                        stringBuilder = a4[i5].startsWith("-") ? stringBuilder + a4[i5].substring(0, 3) + "," : stringBuilder + a4[i5].substring(0, 4) + ",";
                        indexOf = a4[i5].indexOf(",") + 1;
                        stringBuilder = a4[i5].substring(indexOf, indexOf + 1).startsWith("-") ? stringBuilder + a4[i5].substring(indexOf, indexOf + 3) : stringBuilder + a4[i5].substring(indexOf, indexOf + 4);
                        str4 = (stringBuilder + File.separator) + a4[i5];
                        if (str4.equals(c)) {
                            cmVar = e;
                                    ...
                                    try {
                                        ...
                                        if ((c + 7776000000L < cw.a() ? 1 : null) != null) {
                                            ...
                                            if ((g > 8 ? 1 : null) == null || (g - ((long) i7)) % 16 != 0) {
                                                ...
                                                double[] a5;
                                                Entry entry;
                                                if (i5 < length && !hashtable.isEmpty() && i4 < e.o) {
                                                    i2 = 1;
                                                } else {
                                                    obj2 = null;
                                                }
                                                if (i5 >= length && !hashtable2.isEmpty() && i3 < 15) {
                                                    int i8 = 1;
                                                } else {
                                                    obj3 = null;
                                                }
                                                if (obj2 == null) {
                                                    ...
                                                    try {
                                                        ...
                                                        for (Entry entry2 : hashtable.entrySet()) {
                                                            try {
                                                                a5 = a(i7, chVar2, ((String) entry2.getKey()).toString(), 0);
                                                                if (a5 != null) {
                                                                    i2++;
                                                ...
                                                if (obj3 != null) {
                                                    ...
                                                    while (it != null && it.hasNext()) {
                                                        ...
                                                        a5 = a(i7, chVar2, ((String) entry2.getKey()).toString(), 1);
                                                        if (a5 != null) {
                                                            i3++;
                ...
                if (i5 >= length) {
                    ...
                    if (i5 < length) {
                        ...
                        indexOf = a4[i5].indexOf(",") + 1;
                        if (a4[i5].substring(indexOf, indexOf + 1).startsWith("-")) {
                        }
                        str4 = (stringBuilder + File.separator) + a4[i5];
                        if (str4.equals(c)) {
                            cmVar = e;
            ...
            if (httpURLConnection3 != null) {
                ...
                if (responseCode == 200) {
                    ...
                    if (responseCode != 260) {
                        ...
                        try {
                            gZIPInputStream2 = new GZIPInputStream(inputStream3);
                            try {
...
jadx.core.utils.exceptions.CodegenException: Error generate insn: PHI: (r0_2 'z' boolean) = (r0_0 'z' boolean), (r0_1 'z' boolean) binds: {(r0_1 'z' boolean)=B:30:0x0060, (r0_0 'z' boolean)=B:9:0x001c} in method: com.loc.cc.a(java.lang.String, java.lang.String, int, int):boolean
