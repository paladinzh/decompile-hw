...
public class bv {
                ...
                public void run() {
                    if (cc.a[1] <= AMapException.CODE_AMAP_SERVICE_TABLEID_NOT_EXIST) {
                        ...
                        if (cw.a(this.a.v, "fetchoffdatamobile")) {
                            try {
                                boolean equals = CallInterceptDetails.BRANDED_STATE.equals(this.a.v.getString("fetchoffdatamobile"));
                            } catch (Throwable th) {
                ...
                if (a != null) {
                    ...
                    if (a2 != null) {
                        ...
                        if (cw.a(a3)) {
                            ...
                            if (a3.a() == 0 && a3.b() == 0) {
                                if ("-5".equals(a3.m()) || CallInterceptDetails.BRANDED_STATE.equals(a3.m()) || CallInterceptDetails.UNBRANDED_STATE.equals(a3.m()) || "14".equals(a3.m()) || "24".equals(a3.m()) || "-1".equals(a3.m())) {
                                    a3.a(5);
                                } else {
                                    a3.a(6);
                                }
    ...
    private StringBuilder a(Object obj) {
        ...
        String str13 = c != 2 ? str : CallInterceptDetails.BRANDED_STATE;
        if (e != null) {
        ...
        if (cw.a(activeNetworkInfo) == -1) {
            ...
            if (p()) {
                if (a(this.u)) {
                    str11 = CallInterceptDetails.UNBRANDED_STATE;
                    if (!p()) {
                        n();
                    }
                    str8 = str;
            ...
            str11 = CallInterceptDetails.BRANDED_STATE;
            if (p()) {
                n();
            }
            str8 = str;
        ...
        if (str2.equals(CallInterceptDetails.BRANDED_STATE)) {
            stringBuilder.append("\" gmock=\"").append(!this.B ? "0" : CallInterceptDetails.BRANDED_STATE);
        }
        ...
        if (cw.a(this.v, "reversegeo")) {
            ...
            if (cw.a(this.v, "multi")) {
                try {
                    if (this.v.getString("multi").equals(CallInterceptDetails.BRANDED_STATE)) {
                        this.H.b = (short) 1;
                    }
            ...
            this.H.i = str13;
            this.H.j = str2;
            this.H.k = this.B ? "0" : CallInterceptDetails.BRANDED_STATE;
            this.H.l = str3;
            this.H.m = str4;
            this.H.n = str5;
            this.H.o = str6;
    ...
    private void o() {
        ...
        if (p()) {
            ...
            if (cw.c() < 18 && cw.c() > 3 && cw.a(this.v, "wifiactivescan")) {
                try {
                    equals = CallInterceptDetails.BRANDED_STATE.equals(this.v.getString("wifiactivescan"));
                } catch (Throwable th) {
    ...
    private void x() {
        ...
        try {
            ...
            if (TextUtils.isEmpty(obj) || !obj.equals(CallInterceptDetails.BRANDED_STATE)) {
                return;
            }
        } catch (Throwable th) {
        ...
        if (this.q != null) {
            if (!this.q.isEmpty()) {
                ...
                if (cw.a(this.v, "nbssid")) {
                    try {
                        if (this.v.getString("nbssid").equals(CallInterceptDetails.BRANDED_STATE)) {
                            h = true;
