...
public class bm implements Closeable {
    ...
    public bm(InputStream inputStream, int i, Charset charset) {
        if (inputStream == null || charset == null) {
            throw new NullPointerException();
        } else if (i < 0) {
            throw new IllegalArgumentException("capacity <= 0");
        } else if (charset.equals(bn.a)) {
            this.a = inputStream;
            this.b = charset;
            this.c = new byte[i];
        } else {
            ...
            if (this.c != null) {
                ...
                while (i2 != this.e) {
                    if (this.c[i2] != (byte) 10) {
                        ...
                        i = (i2 != this.d && this.c[i2 - 1] == (byte) 13) ? i2 - 1 : i2;
