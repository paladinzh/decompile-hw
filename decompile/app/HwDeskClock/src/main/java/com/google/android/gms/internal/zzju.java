...
public interface zzju extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzju {
        ...
        public static zzju zzaq(IBinder iBinder) {
            ...
            return (queryLocalInterface != null && (queryLocalInterface instanceof zzju)) ? (zzju) queryLocalInterface : new zza(iBinder);
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    zza(data.readInt() == 0 ? null : (Account) Account.CREATOR.createFromParcel(data), data.readInt(), com.google.android.gms.internal.zzjt.zza.zzap(data.readStrongBinder()));
