    ...
    public static final class Builder {
        ...
        private int[] getPixelsFromBitmap(Bitmap bitmap) {
            ...
            if (this.mRegion != null) {
                ...
                bitmap.getPixels(pixels, 0, bitmapWidth, this.mRegion.left, this.mRegion.top, regionWidth, regionHeight);
                Object subsetPixels = new int[(regionWidth * regionHeight)];
            ...
            if (!this.mGeneratedTextColors) {
                ...
                if (lightBodyAlpha == -1 || lightTitleAlpha == -1) {
                    ...
                    if (darkBodyAlpha == -1 || darkBodyAlpha == -1) {
                        this.mBodyTextColor = lightBodyAlpha == -1 ? ColorUtils.setAlphaComponent(-16777216, darkBodyAlpha) : ColorUtils.setAlphaComponent(-1, lightBodyAlpha);
                        this.mTitleTextColor = lightTitleAlpha == -1 ? ColorUtils.setAlphaComponent(-16777216, darkTitleAlpha) : ColorUtils.setAlphaComponent(-1, lightTitleAlpha);
