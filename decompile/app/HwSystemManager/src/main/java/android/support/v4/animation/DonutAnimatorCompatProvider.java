...
class DonutAnimatorCompatProvider implements AnimatorProvider {
    ...
    private static class DonutFloatValueAnimator implements ValueAnimatorCompat {
        ...
        private Runnable mLoopRunnable = new Runnable() {
            public void run() {
                float fraction = (((float) (DonutFloatValueAnimator.this.getTime() - DonutFloatValueAnimator.this.mStartTime)) * Utility.ALPHA_MAX) / ((float) DonutFloatValueAnimator.this.mDuration);
                if (fraction > Utility.ALPHA_MAX || DonutFloatValueAnimator.this.mTarget.getParent() == null) {
                    fraction = Utility.ALPHA_MAX;
                }
                DonutFloatValueAnimator.this.mFraction = fraction;
                DonutFloatValueAnimator.this.notifyUpdateListeners();
                if (DonutFloatValueAnimator.this.mFraction >= Utility.ALPHA_MAX) {
