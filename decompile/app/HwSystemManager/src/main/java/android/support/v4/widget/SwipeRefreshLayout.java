...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mAnimateToCorrectPosition = new Animation() {
            public void applyTransformation(float interpolatedTime, Transformation t) {
                ...
                SwipeRefreshLayout.this.mProgress.setArrowScale(Utility.ALPHA_MAX - interpolatedTime);
            }
        };
    ...
    private void startScaleDownAnimation(AnimationListener listener) {
        this.mScaleDownAnimation = new Animation() {
            public void applyTransformation(float interpolatedTime, Transformation t) {
                SwipeRefreshLayout.this.setAnimationProgress(Utility.ALPHA_MAX - interpolatedTime);
            }
        };
    ...
    private void moveSpinner(float overscrollTop) {
        ...
        float dragPercent = Math.min(Utility.ALPHA_MAX, Math.abs(overscrollTop / this.mTotalDragDistance));
        ...
        if (!this.mScale) {
            ViewCompat.setScaleX(this.mCircleView, Utility.ALPHA_MAX);
            ViewCompat.setScaleY(this.mCircleView, Utility.ALPHA_MAX);
        }
        if (this.mScale) {
            setAnimationProgress(Math.min(Utility.ALPHA_MAX, overscrollTop / this.mTotalDragDistance));
        }
        ...
        this.mProgress.setArrowScale(Math.min(Utility.ALPHA_MAX, adjustedPercent));
