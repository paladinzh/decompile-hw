            ...
            if (event.getAction() == 0) {
                switch (event.getKeyCode()) {
                    ...
                    case 20:
                        ...
                        break;
                    case Events.E_ANTISPAM_VIEW_MSG /*62*/:
            ...
            case 2:
                ...
                if (activePointerIndex != -1) {
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        boolean canOverscroll = overscrollMode != 0 ? overscrollMode == 1 ? range > 0 : false : true;
                        ...
                        if (!dispatchNestedScroll(0, scrolledDeltaY, 0, deltaY - scrolledDeltaY, this.mScrollOffset)) {
                            if (canOverscroll) {
                                ...
                                if (pulledToY < 0) {
                                    ...
                                    this.mEdgeGlowBottom.onPull(((float) deltaY) / ((float) getHeight()), Utility.ALPHA_MAX - (MotionEventCompat.getX(ev, activePointerIndex) / ((float) getWidth())));
