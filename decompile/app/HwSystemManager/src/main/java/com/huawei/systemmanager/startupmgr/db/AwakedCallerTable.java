...
public class AwakedCallerTable implements IBasicColumns, ITableInfo {
    private static String[][] COLUMN_DEFINES = null;
    public static final String COL_CALLER_PKG = "callerpkg";
    public static final String COL_PACKAGE_NAME = "packageName";
    private static String[] INDEX_DEFINES = new String[]{"packageName", COL_CALLER_PKG};
    public static final String TABLE_NAME = "awakedcaller";
    ...
    static {
        ...
        r0[2] = new String[]{COL_CALLER_PKG, ColType.COL_TYPE_TXT, ColLimit.COL_LIMIT_NOT_NULL};
        COLUMN_DEFINES = r0;
    }
