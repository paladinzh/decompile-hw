...
public interface IHoldPreventService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IHoldPreventService {
        private static final String DESCRIPTOR = "com.huawei.systemmanager.preventmode.IHoldPreventService";
        static final int TRANSACTION_isPrevent = 1;
        static final int TRANSACTION_queryAllWhiteListPhoneNo = 2;
