...
public class AwakedRecordTable implements IBasicColumns, ITableInfo {
    private static String[][] COLUMN_DEFINES = null;
    public static final String COL_CALLER_PACKAGE_NAME = "callerPackageName";
    ...
    private static String[] INDEX_DEFINES = new String[]{"packageName", COL_CALLER_PACKAGE_NAME, "startupResult", "timeOfDay"};
    public static final String TABLE_NAME = "awaked_record";
    ...
    static {
        ...
        r0[2] = new String[]{COL_CALLER_PACKAGE_NAME, ColType.COL_TYPE_TXT, ColLimit.COL_LIMIT_NOT_NULL};
        r0[3] = new String[]{"startupResult", ColType.COL_TYPE_INT, ColLimit.COL_LIMIT_NOT_NULL};
        r0[4] = new String[]{"timeOfDay", ColType.COL_TYPE_INT, ColLimit.COL_LIMIT_NOT_NULL};
        r0[5] = new String[]{"timeOfLastExact", ColType.COL_TYPE_INT, ColLimit.COL_LIMIT_NOT_NULL};
        r0[6] = new String[]{"totalCount", ColType.COL_TYPE_INT, ColLimit.COL_LIMIT_NOT_NULL};
        COLUMN_DEFINES = r0;
    }
