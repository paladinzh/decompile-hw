...
public interface IRequestCallBack extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IRequestCallBack {
        private static final String DESCRIPTOR = "com.huawei.android.thememanager.aidl.IRequestCallBack";
        ...
        private static class Proxy implements IRequestCallBack {
            ...
            public void onRequestResult(int requestCode, int resultCode, Intent data) throws RemoteException {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    Intent _arg2 = new Intent();
                    onRequestResult(_arg0, _arg1, _arg2);
    ...
    void onRequestResult(int i, int i2, Intent intent) throws RemoteException;
}
