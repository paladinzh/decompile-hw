...
import com.common.imageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.common.imageloader.core.assist.FlushedInputStream;
...
public final class ImageLoaderConfiguration {
    ...
    public static class Builder {
        ...
        private ImageDecoder apkdecoder;
        ...
        public Builder taskExecutor(Executor executor) {
            if (this.threadPoolSize == 3 && this.threadPriority == 3) {
                if (this.tasksProcessingType != DEFAULT_TASK_PROCESSING_TYPE) {
                }
        ...
        private void initEmptyFieldsWithDefaultValues() {
            ...
            if (this.apkdecoder == null) {
                this.apkdecoder = DefaultConfigurationFactory.createApkDecoderImageDecoder(this.writeLogs);
            }
    ...
    private static class NetworkDeniedImageDownloader implements ImageDownloader {
        ...
        private static /* synthetic */ int[] -getcom-common-imageloader-core-download-ImageDownloader$SchemeSwitchesValues() {
            ...
            try {
                iArr[Scheme.DRAWABLE.ordinal()] = 5;
            } catch (NoSuchFieldError e3) {
            }
            try {
                iArr[Scheme.FILE.ordinal()] = 6;
    ...
    private ImageLoaderConfiguration(Builder builder) {
        ...
        this.apkDecoder = builder.apkdecoder;
