...
public class HwViewPagerImpl implements HwViewPager {
    ...
    public Scroller createScroller(Context context) {
        return new Scroller(context, new PathInterpolator(0.325f, 0.63f, 0.05f, Utility.ALPHA_MAX));
    }
    ...
    public Interpolator createCubicBezierInterpolator(Context context) {
        try {
            ...
            return (Interpolator) animUtilclazz.getConstructor(new Class[]{Float.TYPE, Float.TYPE, Float.TYPE, Float.TYPE}).newInstance(new Object[]{Float.valueOf(0.325f), Float.valueOf(0.63f), Float.valueOf(0.05f), Float.valueOf(Utility.ALPHA_MAX)});
