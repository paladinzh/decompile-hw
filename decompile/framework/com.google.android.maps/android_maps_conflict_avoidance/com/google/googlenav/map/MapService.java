...
*/
    ...
    private void doCompact(boolean r15) {
        /* JADX: method processing error */
/*
...
*/
    ...
    L_0x0004:
        ...
        monitor-enter(r11);
        r10 = 1;
        r14.setMapCacheLocked(r10);	 Catch:{ all -> 0x0070 }
        r10 = android_maps_conflict_avoidance.com.google.common.Config.getInstance();	 Catch:{ all -> 0x006a }
        r10 = r10.getClock();	 Catch:{ all -> 0x006a }
        r0 = r10.currentTimeMillis();	 Catch:{ all -> 0x006a }
        r10 = r14.mapCache;	 Catch:{ all -> 0x006a }
        r5 = r10.keys();	 Catch:{ all -> 0x006a }
    L_0x001d:
        r10 = r5.hasMoreElements();	 Catch:{ all -> 0x006a }
    ...
    L_0x0029:
        ...
        goto L_0x0004;
    L_0x002c:
        r7 = r5.nextElement();	 Catch:{ all -> 0x006a }
        r7 = (android_maps_conflict_avoidance.com.google.googlenav.map.Tile) r7;	 Catch:{ all -> 0x006a }
        r10 = r14.mapCache;	 Catch:{ all -> 0x006a }
        r6 = r10.get(r7);	 Catch:{ all -> 0x006a }
        r6 = (android_maps_conflict_avoidance.com.google.googlenav.map.MapTile) r6;	 Catch:{ all -> 0x006a }
        r2 = r6.getLastAccessTime();	 Catch:{ all -> 0x006a }
        r12 = r2 + r8;	 Catch:{ all -> 0x006a }
        r10 = (r12 > r0 ? 1 : (r12 == r0 ? 0 : -1));	 Catch:{ all -> 0x006a }
        if (r10 < 0) goto L_0x0068;	 Catch:{ all -> 0x006a }
    L_0x0044:
        r10 = 1;	 Catch:{ all -> 0x006a }
    L_0x0045:
        if (r10 != 0) goto L_0x001d;	 Catch:{ all -> 0x006a }
    L_0x0047:
        r6.compact();	 Catch:{ all -> 0x006a }
        r10 = r14.layerServices;	 Catch:{ all -> 0x006a }
        r10 = r10.size();	 Catch:{ all -> 0x006a }
        r4 = r10 + -1;	 Catch:{ all -> 0x006a }
    L_0x0052:
        if (r4 < 0) goto L_0x001d;	 Catch:{ all -> 0x006a }
    L_0x0054:
        r10 = r14.layerServices;	 Catch:{ all -> 0x006a }
        r10 = r10.elementAt(r4);	 Catch:{ all -> 0x006a }
        r10 = (android_maps_conflict_avoidance.com.google.googlenav.map.LayerService) r10;	 Catch:{ all -> 0x006a }
        r12 = 8;	 Catch:{ all -> 0x006a }
        r12 = android_maps_conflict_avoidance.com.google.googlenav.map.Tile.getTile(r12, r7);	 Catch:{ all -> 0x006a }
        r10.doCompact(r12);	 Catch:{ all -> 0x006a }
        r4 = r4 + -1;
        goto L_0x0052;
    L_0x0068:
        r10 = 0;
    ...
    L_0x006a:
        r10 = move-exception;
        r12 = 0;
        r14.setMapCacheLocked(r12);	 Catch:{ all -> 0x0070 }
        throw r10;	 Catch:{ all -> 0x0070 }
    L_0x0070:
        r10 = move-exception;	 Catch:{ all -> 0x0070 }
        monitor-exit(r11);	 Catch:{ all -> 0x0070 }
        throw r10;
        */
        throw new UnsupportedOperationException("Method not decompiled: android_maps_conflict_avoidance.com.google.googlenav.map.MapService.doCompact(boolean):void");
    }
