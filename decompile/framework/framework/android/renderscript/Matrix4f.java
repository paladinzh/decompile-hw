...
public class Matrix4f {
    ...
    public void loadOrthoWindow(int w, int h) {
        loadOrtho(0.0f, (float) w, (float) h, 0.0f, ScaledLayoutParams.SCALE_UNSPECIFIED, 1.0f);
    }
    ...
    public void loadProjectionNormalized(int w, int h) {
        ...
        if (w > h) {
            ...
            m1.loadFrustum(-aspect, aspect, ScaledLayoutParams.SCALE_UNSPECIFIED, 1.0f, 1.0f, SensorManager.LIGHT_CLOUDY);
        } else {
            aspect = ((float) h) / ((float) w);
            m1.loadFrustum(ScaledLayoutParams.SCALE_UNSPECIFIED, 1.0f, -aspect, aspect, 1.0f, SensorManager.LIGHT_CLOUDY);
        }
