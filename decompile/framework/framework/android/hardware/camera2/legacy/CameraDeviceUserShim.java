...
public class CameraDeviceUserShim implements ICameraDeviceUser {
    ...
    private static class CameraCallbackThread implements ICameraDeviceCallbacks {
        ...
        public void onCaptureStarted(CaptureResultExtras resultExtras, long timestamp) {
            getHandler().sendMessage(getHandler().obtainMessage(2, (int) (timestamp & KeymasterArguments.UINT32_MAX_VALUE), (int) ((timestamp >> 32) & KeymasterArguments.UINT32_MAX_VALUE), resultExtras));
        }
        ...
        public void onRepeatingRequestError(long lastFrameNumber) {
            getHandler().sendMessage(getHandler().obtainMessage(5, (int) (lastFrameNumber & KeymasterArguments.UINT32_MAX_VALUE), (int) ((lastFrameNumber >> 32) & KeymasterArguments.UINT32_MAX_VALUE)));
        }
