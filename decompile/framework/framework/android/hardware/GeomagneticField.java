...
public class GeomagneticField {
    ...
    private static class LegendreTable {
        static final /* synthetic */ boolean -assertionsDisabled = (!LegendreTable.class.desiredAssertionStatus());
    ...
    static {
        ...
        r0[10] = new float[]{-2.0f, -6.3f, 0.9f, -1.1f, -0.2f, 2.5f, -0.3f, 2.2f, 3.1f, ScaledLayoutParams.SCALE_UNSPECIFIED, -2.8f};
        r0[11] = new float[]{3.0f, -1.5f, -2.1f, 1.7f, -0.5f, NetworkHistoryUtils.RECOVERY_PERCENTAGE, -0.8f, Face.CONFIDENCE_THRESHOLD, 1.8f, 0.1f, 0.7f, 3.8f};
        r0[12] = new float[]{-2.2f, -0.2f, 0.3f, 1.0f, -0.6f, 0.9f, -0.1f, NetworkHistoryUtils.RECOVERY_PERCENTAGE, -0.4f, -0.4f, System.PRESS_LIMIT_DEFAULT, -0.8f, 0.0f};
        G_COEFF = r0;
        r0 = new float[13][];
        r0[0] = new float[]{0.0f};
        ...
        r0[10] = new float[]{0.0f, 2.8f, -0.1f, 4.7f, 4.4f, -7.2f, ScaledLayoutParams.SCALE_UNSPECIFIED, -3.9f, -2.0f, -2.0f, -8.3f};
        r0[11] = new float[]{0.0f, System.PRESS_LIMIT_DEFAULT, 1.7f, -0.6f, -1.8f, 0.9f, -0.4f, -2.5f, -1.3f, -2.1f, -1.9f, -1.8f};
        r0[12] = new float[]{0.0f, -0.9f, 0.3f, 2.1f, -2.5f, NetworkHistoryUtils.RECOVERY_PERCENTAGE, SensorManager.GRAVITY_PLUTO, 0.0f, 0.1f, 0.3f, -0.9f, -0.2f, 0.9f};
        H_COEFF = r0;
        r0 = new float[13][];
        r0[0] = new float[]{0.0f};
        ...
        r0[5] = new float[]{ScaledLayoutParams.SCALE_UNSPECIFIED, SensorManager.GRAVITY_PLUTO, -1.8f, ScaledLayoutParams.SCALE_UNSPECIFIED, 0.9f, 1.0f};
        ...
        r0[8] = new float[]{-0.1f, 0.1f, -0.6f, System.PRESS_LIMIT_DEFAULT, -0.2f, 0.3f, 0.3f, -0.6f, System.PRESS_LIMIT_DEFAULT};
        r0[9] = new float[]{0.0f, -0.1f, 0.0f, 0.3f, -0.4f, -0.3f, 0.1f, -0.1f, -0.4f, -0.2f};
        r0[10] = new float[]{0.0f, 0.0f, -0.1f, System.PRESS_LIMIT_DEFAULT, 0.0f, -0.1f, -0.2f, 0.0f, -0.1f, -0.2f, -0.2f};
        ...
        r0[6] = new float[]{0.0f, -0.2f, -2.1f, -0.4f, -0.6f, NetworkHistoryUtils.RECOVERY_PERCENTAGE, 0.9f};
        r0[7] = new float[]{0.0f, 0.7f, 0.3f, -0.1f, -0.1f, -0.8f, -0.3f, 0.3f};
        r0[8] = new float[]{0.0f, -0.1f, System.PRESS_LIMIT_DEFAULT, Face.CONFIDENCE_THRESHOLD, Face.CONFIDENCE_THRESHOLD, 0.1f, -0.1f, Face.CONFIDENCE_THRESHOLD, 0.3f};
        r0[9] = new float[]{0.0f, 0.0f, -0.2f, 0.0f, -0.1f, 0.1f, 0.0f, -0.2f, 0.3f, System.PRESS_LIMIT_DEFAULT};
