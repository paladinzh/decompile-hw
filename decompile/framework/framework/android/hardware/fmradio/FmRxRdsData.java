...
public class FmRxRdsData {
    ...
    public int rdsOptions(int rdsMask) {
        ...
        int re = FmReceiverJNI.setControlNative(this.mFd, V4L2_CID_PRIVATE_TAVARUA_RDSGROUP_PROC, (byte) (((rdsMask & 7) << 3) | ((byte) (rds_group_mask & 199))));
        return FmReceiverJNI.setControlNative(this.mFd, V4L2_CID_PRIVATE_TAVARUA_PSALL, psAllVal >> 4);
    }
    ...
    public int enableAFjump(boolean AFenable) {
        ...
        if (AFenable) {
            FmReceiverJNI.setControlNative(this.mFd, V4L2_CID_PRIVATE_TAVARUA_RDSGROUP_PROC, rds_group_mask | 64);
        } else {
