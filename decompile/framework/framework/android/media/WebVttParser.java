...
class WebVttParser {
    ...
    private final Phase mParseCueId = new Phase() {
        static final /* synthetic */ boolean -assertionsDisabled = (!AnonymousClass4.class.desiredAssertionStatus());
    ...
    private final Phase mParseCueTime = new Phase() {
        static final /* synthetic */ boolean -assertionsDisabled = (!AnonymousClass5.class.desiredAssertionStatus());
    ...
    private final Phase mParseHeader = new Phase() {
        static final /* synthetic */ boolean -assertionsDisabled = (!AnonymousClass3.class.desiredAssertionStatus());
