...
class Cea608CCParser {
    ...
    private static class CCData {
        ...
        private static final String[] mSpanishCharMap = new String[]{"Á", "É", "Ó", "Ú", "Ü", "ü", "‘", "¡", NetworkCapabilities.MATCH_ALL_REQUESTS_NETWORK_SPECIFIER, "'", "—", "©", "℠", "•", "“", "”", "À", "Â", "Ç", "È", "Ê", "Ë", "ë", "Î", "Ï", "ï", "Ô", "Ù", "ù", "Û", "«", "»"};
