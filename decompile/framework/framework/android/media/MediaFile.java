...
public class MediaFile {
    ...
    static {
        ...
        addFileType("JPG", 34, "image/jpeg", MtpConstants.FORMAT_EXIF_JPEG);
        addFileType("JPE", 34, "image/jpeg", MtpConstants.FORMAT_EXIF_JPEG);
        addFileType("JPEG", 34, "image/jpeg", MtpConstants.FORMAT_EXIF_JPEG);
        addFileType("GIF", 35, "image/gif", MtpConstants.FORMAT_GIF);
        addFileType("PNG", 36, "image/png", MtpConstants.FORMAT_PNG);
        addFileType("BMP", 37, "image/x-ms-bmp", MtpConstants.FORMAT_BMP);
        addFileType("WBMP", 38, "image/vnd.wap.wbmp", MtpConstants.FORMAT_DEFINED);
        addFileType("WEBP", 39, "image/webp", MtpConstants.FORMAT_DEFINED);
        addFileType("DNG", 300, "image/x-adobe-dng", MtpConstants.FORMAT_DNG);
        addFileType("CR2", 301, "image/x-canon-cr2", MtpConstants.FORMAT_TIFF);
        addFileType("NEF", 302, "image/x-nikon-nef", MtpConstants.FORMAT_TIFF_EP);
        ...
        addFileType("SRW", 309, "image/x-samsung-srw", MtpConstants.FORMAT_TIFF);
        addFileType("M3U", 44, "audio/x-mpegurl", MtpConstants.FORMAT_M3U_PLAYLIST);
        addFileType("M3U", 44, "application/x-mpegurl", MtpConstants.FORMAT_M3U_PLAYLIST);
        addFileType("PLS", 45, "audio/x-scpls", MtpConstants.FORMAT_PLS_PLAYLIST);
        addFileType("WPL", 46, "application/vnd.ms-wpl", MtpConstants.FORMAT_WPL_PLAYLIST);
        ...
        addFileType("DOCX", 104, "application/vnd.openxmlformats-officedocument.wordprocessingml.document", MtpConstants.FORMAT_MS_WORD_DOCUMENT);
        addFileType("XLS", 105, "application/vnd.ms-excel", MtpConstants.FORMAT_MS_EXCEL_SPREADSHEET);
        addFileType("XLSX", 105, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", MtpConstants.FORMAT_MS_EXCEL_SPREADSHEET);
        addFileType("PPT", 106, "application/mspowerpoint", MtpConstants.FORMAT_MS_POWERPOINT_PRESENTATION);
        addFileType("PPTX", 106, "application/vnd.openxmlformats-officedocument.presentationml.presentation", MtpConstants.FORMAT_MS_POWERPOINT_PRESENTATION);
