...
*/
    ...
    private int modulateColorAlpha(int baseColor, float alphaMod) {
        ...
        return (IBinder.LAST_CALL_TRANSACTION & baseColor) | (MathUtils.constrain((int) ((((float) Color.alpha(baseColor)) * alphaMod) + NetworkHistoryUtils.RECOVERY_PERCENTAGE), 0, 255) << 24);
    }
