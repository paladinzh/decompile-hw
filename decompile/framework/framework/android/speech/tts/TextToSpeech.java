    ...
    public Locale getLanguage() {
        return (Locale) runAction(new Action<Locale>() {
            public Locale run(ITextToSpeechService service) {
                return new Locale(TextToSpeech.this.mParams.getString("language", ProxyInfo.LOCAL_EXCL_LIST), TextToSpeech.this.mParams.getString(Engine.KEY_PARAM_COUNTRY, ProxyInfo.LOCAL_EXCL_LIST), TextToSpeech.this.mParams.getString(Engine.KEY_PARAM_VARIANT, ProxyInfo.LOCAL_EXCL_LIST));
            }
        }, null, "getLanguage");
    }
