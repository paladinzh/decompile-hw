...
public class VolumeInfo implements Parcelable {
    ...
    static {
        ...
        sStateToDescrip.put(0, 17040434);
        sStateToDescrip.put(1, 17040435);
        sStateToDescrip.put(2, 17040436);
        sStateToDescrip.put(3, 17040437);
        sStateToDescrip.put(4, 17040442);
        sStateToDescrip.put(5, 17040441);
        sStateToDescrip.put(6, 17040439);
        sStateToDescrip.put(7, 17040433);
        sStateToDescrip.put(8, 17040438);
    }
