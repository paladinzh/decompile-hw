            ...
            switch (this.mRenderMode) {
                ...
                case 1:
                    if (relativeAspectRatio > 1.0f) {
                        this.mProgram.setTargetRect(NetworkHistoryUtils.RECOVERY_PERCENTAGE - (NetworkHistoryUtils.RECOVERY_PERCENTAGE / relativeAspectRatio), 0.0f, 1.0f / relativeAspectRatio, 1.0f);
                        return;
                    } else {
                        this.mProgram.setTargetRect(0.0f, NetworkHistoryUtils.RECOVERY_PERCENTAGE - (NetworkHistoryUtils.RECOVERY_PERCENTAGE * relativeAspectRatio), 1.0f, relativeAspectRatio);
                        return;
                    }
                case 2:
                    if (relativeAspectRatio > 1.0f) {
