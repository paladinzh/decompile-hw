...
public class SurfaceTextureTarget extends Filter {
    ...
    public void prepare(FilterContext context) {
        ...
        this.mProgram.setSourceRect(0.0f, 1.0f, 1.0f, ScaledLayoutParams.SCALE_UNSPECIFIED);
                ...
                switch (this.mRenderMode) {
                    ...
                    case 1:
                        if (relativeAspectRatio > 1.0f) {
                            ...
                            this.mTargetQuad.p2.set(NetworkHistoryUtils.RECOVERY_PERCENTAGE - (NetworkHistoryUtils.RECOVERY_PERCENTAGE / relativeAspectRatio), 1.0f);
                            this.mTargetQuad.p3.set((NetworkHistoryUtils.RECOVERY_PERCENTAGE / relativeAspectRatio) + NetworkHistoryUtils.RECOVERY_PERCENTAGE, 1.0f);
                        } else {
                            ...
                            this.mTargetQuad.p1.set(1.0f, NetworkHistoryUtils.RECOVERY_PERCENTAGE - (NetworkHistoryUtils.RECOVERY_PERCENTAGE * relativeAspectRatio));
                            ...
                            this.mTargetQuad.p3.set(1.0f, (NetworkHistoryUtils.RECOVERY_PERCENTAGE * relativeAspectRatio) + NetworkHistoryUtils.RECOVERY_PERCENTAGE);
                        }
