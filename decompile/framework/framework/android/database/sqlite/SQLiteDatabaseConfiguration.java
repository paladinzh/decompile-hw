...
public final class SQLiteDatabaseConfiguration {
    ...
    public void initConfigEnhancementFlag() {
        ...
        } else if (optimizeDBConfigFlag.equalsIgnoreCase("true") && (this.path.equalsIgnoreCase("/data/data/com.android.providers.contacts/databases/contacts2.db") || this.path.equalsIgnoreCase("/data/data/com.android.providers.telephony/databases/mmssms.db"))) {
