...
*/
    ...
    private Cursor queryForIndexSearch(String table, String whereClause, String[] whereArgs) {
        ...
        if ("files".equals(table)) {
            ...
            sql.append("SELECT _id FROM words WHERE ").append(whereClause.replace("_id", "source_id")).append(" AND ").append("table_to_use IS 8");
        }
    ...
    public boolean isDatabaseIntegrityOk() {
        ...
        while (i < attachedDbs.size()) {
            ...
            r5 = null;
            r5 = compileStatement("PRAGMA " + ((String) p.first) + ".integrity_check(1);");
            String rslt = r5.simpleQueryForString();
