...
public class MtpDatabase implements AutoCloseable {
    ...
    private static final String[] OBJECT_ALL_COLUMNS_PROJECTION = new String[]{"_id", FileColumns.STORAGE_ID, FileColumns.FORMAT, "parent", "_data", "_size", "date_added", "date_modified", "mime_type", "title", "_display_name", "media_type", MediaColumns.IS_DRM, "width", "height", "description", "artist", "album", AudioColumns.ALBUM_ARTIST, "duration", AudioColumns.TRACK, AudioColumns.COMPOSER, AudioColumns.YEAR, "name"};
    private static final String[] OBJECT_INFO_PROJECTION = new String[]{"_id", FileColumns.STORAGE_ID, FileColumns.FORMAT, "parent", "_data", "_size", "date_added", "date_modified"};
    private static final String PARENT_WHERE = "parent=?";
    private static final String[] PATH_FORMAT_PROJECTION = new String[]{"_id", "_data", "_size", FileColumns.FORMAT};
        ...
        switch (property) {
            ...
            case MtpConstants.DEVICE_PROPERTY_DEVICE_FRIENDLY_NAME /*54274*/:
                ...
                if (property == MtpConstants.DEVICE_PROPERTY_DEVICE_FRIENDLY_NAME) {
                    if (Global.getInt(this.mContext.getContentResolver(), SettingsEx.Global.DB_KEY_UNIFIED_DEVICE_NAME_UPDATED, 0) == 1) {
