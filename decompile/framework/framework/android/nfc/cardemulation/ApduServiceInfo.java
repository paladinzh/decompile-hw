...
public final class ApduServiceInfo implements Parcelable {
    public static final Creator<ApduServiceInfo> CREATOR = new Creator<ApduServiceInfo>() {
        public ApduServiceInfo createFromParcel(Parcel source) {
            ...
            ApduServiceInfo tmpInfo = new ApduServiceInfo(info, onHost, description, staticAidGroups, dynamicAidGroups, requiresUnlock, bannerResource, uid, settingsActivityName, seExtension, nfcid2Groups, drawable, modifiable);
            tmpInfo.setServiceState(CardEmulation.CATEGORY_OTHER, servicestate);
            return tmpInfo;
        }
                    ...
                    while (true) {
                        ...
                        if ((eventType != 3 || xmlResourceParser.getDepth() > depth) && eventType != 1) {
                            ...
                            if (eventType == 2 && "se-id".equals(tagName)) {
                                ...
                                if (str == null || !(str.equalsIgnoreCase(SECURE_ELEMENT_ESE) || str.equalsIgnoreCase(SECURE_ELEMENT_UICC))) {
                                }
                            } else if (eventType == 2 && "se-power-state".equals(tagName)) {
                                String powerName = xmlResourceParser.getAttributeValue(null, "name");
                            ...
                            } else if (eventType == 2 && "felica-id".equals(tagName)) {
