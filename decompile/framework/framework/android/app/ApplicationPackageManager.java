...
public class ApplicationPackageManager extends PackageManager {
    ...
    public PackageInfo getPackageInfo(String packageName, int flags) throws NameNotFoundException {
        return getPackageInfoAsUser(packageName, flags, UserHandle.getCallingUserId());
    }
    ...
    public Drawable getUserBadgedIcon(Drawable icon, UserHandle user) {
        if (UserHandle.EMUI_UID == user.getIdentifier() || isClonedProfile(user.getIdentifier())) {
        ...
        return getBadgedDrawable(icon, getDrawable(HwThemeManager.HWT_USER_SYSTEM, badgeResId, null), null, false);
    }
