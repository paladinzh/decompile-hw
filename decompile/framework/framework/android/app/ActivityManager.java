...
public class ActivityManager {
    ...
    public static void dumpPackageStateStatic(FileDescriptor fd, String packageName) {
        ...
        dumpService(pw, fd, HwFrameworkMonitor.KEY_PACKAGE, new String[]{packageName});
        pw.println();
        dumpService(pw, fd, "activity", new String[]{"-a", HwFrameworkMonitor.KEY_PACKAGE, packageName});
        pw.println();
