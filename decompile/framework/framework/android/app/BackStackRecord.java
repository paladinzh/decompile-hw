...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, Runnable {
    ...
    private ArrayList<View> addTransitionTargets(TransitionState state, Transition enterTransition, TransitionSet sharedElementTransition, Transition exitTransition, Transition overallTransition, View container, Fragment inFragment, Fragment outFragment, ArrayList<View> hiddenFragmentViews, boolean isBack, ArrayList<View> sharedElementTargets) {
        ...
        final Transition transition3 = enterTransition;
        ...
        container.getViewTreeObserver().addOnPreDrawListener(new OnPreDrawListener() {
            public boolean onPreDraw() {
                ...
                if (transitionSet != null) {
                    ...
                    arrayList2.remove(transitionState.nonExistentView);
                    BackStackRecord.excludeViews(transition2, transitionSet, arrayList2, false);
                    BackStackRecord.excludeViews(transition3, transitionSet, arrayList2, false);
                    BackStackRecord.setSharedElementTargets(transitionSet, transitionState.nonExistentView, arrayMap, arrayList2);
                ...
                if (transition3 != null) {
                    transition3.removeTarget(transitionState.nonExistentView);
                    View view = fragment.getView();
                    if (view != null) {
                        view.captureTransitioningViews(enteringViews);
                        if (arrayMap != null) {
                            enteringViews.removeAll(arrayMap.values());
                        }
                        enteringViews.add(transitionState.nonExistentView);
                        BackStackRecord.addTargets(transition3, enteringViews);
                    }
                    BackStackRecord.this.setSharedElementEpicenter(transition3, transitionState);
                }
                BackStackRecord.excludeViews(transition2, transition3, enteringViews, true);
                BackStackRecord.excludeViews(transition2, transitionSet, arrayList2, true);
                BackStackRecord.excludeViews(transition3, transitionSet, arrayList2, true);
                return true;
            }
        });
            ...
            sceneRoot.getViewTreeObserver().addOnPreDrawListener(new OnPreDrawListener() {
                public boolean onPreDraw() {
                    ...
                    if (transition != null) {
                        ...
                        BackStackRecord.excludeViews(transition, transition2, arrayList2, false);
                        BackStackRecord.excludeViews(transition, transition3, arrayList3, false);
                    }
                    if (transition2 != null) {
                        BackStackRecord.removeTargets(transition2, arrayList2);
                        BackStackRecord.excludeViews(transition2, transition, arrayList, false);
                        BackStackRecord.excludeViews(transition2, transition3, arrayList3, false);
                    }
                    if (transition3 != null) {
