...
public final class ScanSettings implements Parcelable {
    ...
    public static final class Builder {
        ...
        public Builder setRssiHighValue(int rssi_high_thres) {
            ...
            HwLog.bdati("ScanSettings", "setRssiHighValue:: " + rssi_high_thres);
        ...
        public Builder setRssiLowValue(int rssi_low_thres) {
            ...
            HwLog.bdati("ScanSettings", "setRssiLowValue:: " + rssi_low_thres);
        ...
        public Builder setListLogicType(int list_logic_type) {
            ...
            HwLog.bdati("ScanSettings", "setListLogicType:: " + list_logic_type);
        ...
        public Builder setFilterLogicType(int filter_logic_type) {
            ...
            HwLog.bdati("ScanSettings", "setFilterLogicType:: " + filter_logic_type);
        ...
        public Builder setScanIntervalMillis(int scanIntervalMillis) {
            ...
            HwLog.bdati("ScanSettings", "setScanIntervalMillis:: " + scanIntervalMillis);
        ...
        public Builder setScanWindowMillis(int scanWindowMillis) {
            ...
            HwLog.bdati("ScanSettings", "setScanWindowMillis:: " + scanWindowMillis);
        ...
        public ScanSettings build() {
            return new ScanSettings(this.mScanMode, this.mCallbackType, this.mScanResultType, this.mReportDelayMillis, this.mMatchMode, this.mNumOfMatchesPerFilter, this.mExtendedSelection, this.mRssiHighValue, this.mRssiLowValue, this.mListLogicType, this.mFilterLogicType, this.mScanIntervalMillis, this.mScanWindowMillis);
        }
    }
