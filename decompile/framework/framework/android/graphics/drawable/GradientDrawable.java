...
public class GradientDrawable extends Drawable {
    ...
    static final class GradientState extends ConstantState {
        ...
        int[] mAttrSolid;
        int[] mAttrStroke;
        float mCenterX = NetworkHistoryUtils.RECOVERY_PERCENTAGE;
        float mCenterY = NetworkHistoryUtils.RECOVERY_PERCENTAGE;
        public int mChangingConfigurations;
        int mDensity = 160;
        public boolean mDither = false;
        public int mGradient = 0;
        public int[] mGradientColors;
        float mGradientRadius = NetworkHistoryUtils.RECOVERY_PERCENTAGE;
    ...
    private void updateGradientDrawableGradient(Resources r, TypedArray a) throws XmlPullParserException {
        ...
        if (hasCenterColor) {
            ...
            st.mPositions[1] = st.mCenterX != NetworkHistoryUtils.RECOVERY_PERCENTAGE ? st.mCenterX : st.mCenterY;
