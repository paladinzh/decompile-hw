...
public class WifiConfiguration implements Parcelable {
    ...
    public static final Creator<WifiConfiguration> CREATOR = new Creator<WifiConfiguration>() {
        public WifiConfiguration createFromParcel(Parcel in) {
            ...
            config.wifiProNoHandoverNetwork = z;
            if (in.readInt() != 0) {
                z = true;
            } else {
                z = false;
    ...
    public static class KeyMgmt {
        ...
        public static final String[] strings = new String[]{KeyProperties.DIGEST_NONE, "WPA_PSK", "WPA_EAP", "IEEE8021X", "WPA2_PSK", "OSEN", "WAPI_PSK", "WAPI_CERT", "QUALCOMM_WAPI_PSK", "QUALCOMM_WAPI_CERT"};
