...
public final class Decoder {
    ...
    private static final String[] PUNCT_TABLE = new String[]{MSimTelephonyConstants.MY_RADIO_PLATFORM, "\r", "\r\n", ". ", ", ", ": ", "!", "\"", AlphaIndexerListView.DIGIT_LABEL, "$", "%", "&", "'", "(", ")", "*", "+", SmartTrimProcessEvent.ST_EVENT_STRING_TOKEN, "-", ".", "/", ":", SmartTrimProcessEvent.ST_EVENT_INTER_STRING_TOKEN, "<", "=", ">", "?", "[", "]", "{", "}", "CTRL_UL"};
