...
public class NumberPicker extends android.widget.NumberPicker {
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mEdgeOffset = context.getResources().getDimensionPixelSize(34472061);
    ...
    private void initialNumberPicker(Context context, AttributeSet attrs) {
        ...
        this.mSelectorOffset = res.getDimensionPixelSize(34472058);
        this.mSelectorTextSize = (float) res.getDimensionPixelSize(34472059);
        this.mNormalTextSize = (float) res.getDimensionPixelSize(34472060);
