...
public class SeekBar extends android.widget.SeekBar {
    ...
    public void setTip(boolean setLabelling, int stepNum, boolean isBubbleTip) {
        if (stepNum != 0) {
            ...
            this.mCircleDr = this.mRes.getDrawable(33751537);
            if (tipBgDra != null) {
        ...
        if (this.mCircleDr != null) {
            ...
            if (this.mSetLabelling) {
                for (i = 0; i < this.mStepNum + 1; i++) {
                    int stepText;
                    int strHeight = getTextHeight((this.mStepValue * i) + MSimTelephonyConstants.MY_RADIO_PLATFORM, 9);
                    int strWidth = getTextWidth((this.mStepValue * i) + MSimTelephonyConstants.MY_RADIO_PLATFORM, 9);
                    ...
                    canvas.drawText(stepText + MSimTelephonyConstants.MY_RADIO_PLATFORM, ((float) ((((availableLen / this.mStepNum) * i) + circleLeft) - (strWidth / 2))) + 0.0f, (float) ((((circleHeight * 2) + circleTop) + dip2px(4)) + strHeight), paintText);
                }
