...
public class DragListView extends ListView {
    ...
    public DragListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mRightTouchTolerance = Float.valueOf(getResources().getDimension(34472095)).intValue();
        this.mLeftTouchTolerance = Float.valueOf(getResources().getDimension(34472096)).intValue();
        this.mItemHeightNormal = Float.valueOf(getResources().getDimension(34472094)).intValue();
