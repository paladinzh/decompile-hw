...
public class SubTabWidget extends LinearLayout {
    ...
    public SubTabWidget(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mTextHeightOffset = context.getResources().getDimensionPixelSize(34472117);
        ...
        this.mSubTabAnim.mSecondLayerInsetLeft = context.getResources().getDimensionPixelSize(34472177);
        this.mSubTabAnim.mSecondLayerInsetTop = context.getResources().getDimensionPixelSize(34472178);
        this.mSubTabAnim.mSecondLayerInsetRight = context.getResources().getDimensionPixelSize(34472179);
        this.mSubTabAnim.mSecondLayerInsetBottom = context.getResources().getDimensionPixelSize(34472180);
    }
    ...
    private void updateTabViewContainerWidth(Context context) {
        ...
        if (realSize.x < realSize.y) {
            ...
            this.mWidthPixels = (Math.max(useSize.x, useSize.y) * 8) / 12;
        }
    ...
    private void initDividerDrawable() {
        int dividerRes = this.mIsLightStyle ? 33751607 : this.mIsEmphasizeStyle ? 33751609 : 33751608;
        ...
        if (this.mSubTabAnim.isAnimEnd()) {
            ...
            if (childCount == 1) {
                ...
                if (this.mIsLightStyle || this.mIsEmphasizeStyle) {
                    leftRightRes = 33751617;
                } else {
                    leftRightRes = 33751618;
                }
    ...
    private static void updateSubTabColorRes(Context context, Drawable[] array, int index, int first, int last) {
        if (index == first) {
            if (SystemProperties.getRTLFlag()) {
                array[0] = context.getResources().getDrawable(33751621);
                array[1] = context.getResources().getDrawable(33751606);
            } else {
                array[0] = context.getResources().getDrawable(33751619);
                array[1] = context.getResources().getDrawable(33751604);
            }
        } else if (index != last) {
            array[0] = context.getResources().getDrawable(33751620);
            array[1] = context.getResources().getDrawable(33751605);
        ...
        array[0].setTint(context.getResources().getColor(33882254));
        array[1].setTint(context.getResources().getColor(33882254));
    }
}
