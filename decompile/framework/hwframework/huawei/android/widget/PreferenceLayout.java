...
public class PreferenceLayout extends LinearLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.title_frame.getVisibility() == 0 && this.detail_frame.getVisibility() == 0) {
            ...
            if (titleWidth_origin + detailWidth_origin > availableSpace) {
                if (titleWidth_origin > availableSpace - maxTitleWidthWithDetail && titleWidth_origin <= maxTitleWidthWithDetail) {
            ...
            } else if (detailWidth_origin > availableSpace - maxTitleWidthWithDetail) {
                this.title_frame.measure(MeasureSpec.makeMeasureSpec(availableSpace - detailWidth_origin, 1073741824), titleHeightMeasureSpec);
                this.detail_frame.measure(MeasureSpec.makeMeasureSpec(detailWidth_origin, 1073741824), detailHeightMeasureSpec);
            }
        }
    }
}
