...
public class DynamicAddItemListView extends ListView {
    ...
    public DynamicAddItemListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mPaddingHorizontal = context.getResources().getDimensionPixelOffset(34472154);
        this.mPaddingVertical = context.getResources().getDimensionPixelOffset(34472155);
        this.mTipPadding = context.getResources().getDimensionPixelOffset(34472156);
