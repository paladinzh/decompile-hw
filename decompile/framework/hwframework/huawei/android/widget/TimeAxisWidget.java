...
public class TimeAxisWidget extends LinearLayout {
    ...
    private void initTimeAxis() {
        if (!isInEditMode()) {
            ...
            LayoutParams datetimeview = new LayoutParams(this.context.getResources().getDimensionPixelOffset(34472109), -1);
            ...
            this.mTimeAxisImage.setBackgroundResource(33751419);
    ...
    private void setAxisStyle() {
        if (this.axisStyle != this.mCurrentAxisStyle && this.mDateTimeView != null && this.mTimeAxisImage != null) {
            if (1 == this.axisStyle) {
                ...
                this.mTimeAxisImage.setBackgroundResource(33751420);
