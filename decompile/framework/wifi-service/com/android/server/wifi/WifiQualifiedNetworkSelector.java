                                ...
                                if (status.isNetworkEnabled()) {
                                    if (network2.BSSID != null && !network2.BSSID.equals(WifiLastResortWatchdog.BSSID_ANY) && !network2.BSSID.equals(scanResult.BSSID)) {
                                        ...
                                        if (network2.useExternalScores) {
                                            ...
                                            boolean z2 = lastUserSelectedNetwork != null && lastUserSelectedNetwork.networkId == network2.networkId;
            ...
            if (!(isWifiProEnabled() || scanResultCandidate == null)) {
                ...
                while (tempConfig.getNetworkSelectionStatus().getConnectChoice() != null) {
                    ...
                    if (tempStatus.getCandidate() != null && tempStatus.isNetworkEnabled()) {
                        if (this.mCurrentConnectedNetwork == null || !this.mCurrentConnectedNetwork.isLinked(networkCandidate) || (tempStatus.getCandidate().level >= -75 && tempStatus.getCandidateScore() + 40 >= this.mCurrentConnectedNetwork.getNetworkSelectionStatus().getCandidateScore())) {
