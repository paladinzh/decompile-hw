...
public class WifiP2pServiceImpl extends AbsWifiP2pService {
    ...
    protected class P2pStateMachine extends StateMachine {
        ...
        protected WifiNative mWifiNative = WifiNative.getP2pNativeInterface();
        ...
        class FrequencyConflictState extends State {
            ...
            private void notifyFrequencyConflict() {
                ...
                AlertDialog dialog = new Builder(WifiP2pServiceImpl.this.mContext).setMessage(r.getString(17040349, new Object[]{P2pStateMachine.this.getDeviceName(P2pStateMachine.this.mSavedPeerConfig.deviceAddress)})).setPositiveButton(r.getString(17040383), new OnClickListener() {
                    ...
                    case WifiMonitor.P2P_GROUP_STARTED_EVENT /*147485*/:
                        ...
                        if (P2pStateMachine.this.mGroup.isGroupOwner()) {
                            ...
                            if (!WifiP2pServiceImpl.this.getMagicLinkDeviceFlag()) {
                                ...
                                P2pStateMachine.this.mWifiNative.setBluetoothCoexistenceMode(1);
        ...
        private void notifyP2pProvDiscShowPinRequest(final String pin, final String peerAddress) {
            ...
            addRowToDialog(group, 17040346, getDeviceName(peerAddress));
            addRowToDialog(group, 17040348, pin);
            AlertDialog dialog = new Builder(WifiP2pServiceImpl.this.mContext).setTitle(r.getString(17040343)).setView(textEntryView).setPositiveButton(r.getString(17040341), new OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    P2pStateMachine.this.mSavedPeerConfig = new WifiP2pConfig();
        ...
        private void notifyInvitationReceived() {
            if (!WifiP2pServiceImpl.this.autoAcceptConnection()) {
                ...
                View textEntryView = LayoutInflater.from(WifiP2pServiceImpl.this.mContext).inflate(17367306, null);
                ViewGroup group = (ViewGroup) textEntryView.findViewById(16909381);
                View row = LayoutInflater.from(WifiP2pServiceImpl.this.mContext).inflate(17367322, group, false);
                ((TextView) row.findViewById(16909384)).setText(String.format(r.getString(33685691), new Object[]{getDeviceName(this.mSavedPeerConfig.deviceAddress)}));
                ((TextView) row.findViewById(16909384)).setTextColor(-16777216);
                group.addView(row);
                final EditText pin = (EditText) textEntryView.findViewById(16909383);
                AlertDialog dialog = new Builder(WifiP2pServiceImpl.this.mContext, 33947691).setTitle(r.getString(33685693)).setView(textEntryView).setPositiveButton(r.getString(33685692), new OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        if (wps.setup == 2) {
                ...
                switch (wps.setup) {
                    ...
                    case 2:
                        ...
                        textEntryView.findViewById(16909382).setVisibility(0);
                        break;
                }
