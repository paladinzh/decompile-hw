...
public class SoftApManager extends AbsSoftApManager {
    ...
    private final String mInterfaceName = this.mWifiNative.getInterfaceName();
    ...
    private class SoftApStateMachine extends StateMachine {
            ...
            public boolean processMessage(Message message) {
                ...
                switch (message.what) {
                    ...
                    case 2:
                        ...
                        Log.d(SoftApManager.TAG, String.format("handle message: CMD_TETHER_STATE_CHANGE: avail=[%s] active=[%s]", new Object[]{TextUtils.join(",", stateChange.available), TextUtils.join(",", stateChange.active)}));
        ...
        private class TetheringState extends State {
            ...
            public void enter() {
                ...
                softApStateMachine.sendMessageDelayed(softApStateMachine2.obtainMessage(3, softApStateMachine3.mTetherToken = softApStateMachine3.mTetherToken + 1), 5000);
            }
