...
public class HwGlobalActionsView extends RelativeLayout implements IBlurWallpaperCallback {
    ...
    private static final int ID_IC_AIRPLANEMODE_OFF = 33751318;
    private static final int ID_IC_AIRPLANEMODE_ON = 33751060;
    private static final int ID_IC_NEW_REBOOT = 33751332;
    private static final int ID_IC_NEW_REBOOT_CONFIRM = 33751332;
    private static final int ID_IC_NEW_SHUTDOWN = 33751331;
    private static final int ID_IC_NEW_SHUTDOWN_CONFIRM = 33751331;
    ...
    private void initConfirmAction(boolean isReboot) {
        ...
        if (isReboot) {
            ...
            imageView.setImageResource(hwNewGlobalAction ? 33751332 : ID_IC_REBOOT_CONFIRM);
            ...
            imageView.setImageResource(hwNewGlobalAction ? 33751331 : ID_IC_SHUTDOWN_CONFIRM);
    ...
    private String formateTime(long alarmTime, int type) {
        ...
        int days = hours / 24;
        hours %= 24;
        String daySeq = getContext().getResources().getQuantityString(34734083, days, new Object[]{Integer.valueOf(days)});
        String hourSeq = getContext().getResources().getQuantityString(34734084, hours, new Object[]{Integer.valueOf(hours)});
        String minutesSeq = getContext().getResources().getQuantityString(34734085, minutes, new Object[]{Integer.valueOf(minutes)});
        ...
        if (type == TYPEDESKCLOCK) {
            ...
            if (index == 7) {
                return getContext().getResources().getString(33685762, new Object[]{daySeq, hourSeq, minutesSeq});
            } else if (index == 6) {
                return getContext().getResources().getString(33685763, new Object[]{daySeq, hourSeq});
            } else if (index == 5) {
                return getContext().getResources().getString(33685764, new Object[]{daySeq, minutesSeq});
            } else if (index == 4) {
                return getContext().getResources().getString(33685765, new Object[]{daySeq});
            } else if (index == 3) {
                return getContext().getResources().getString(33685766, new Object[]{hourSeq, minutesSeq});
            } else if (index == 2) {
                return getContext().getResources().getString(33685767, new Object[]{hourSeq});
            } else {
                return getContext().getResources().getString(33685768, new Object[]{minutesSeq});
            }
        } else if (index == 0) {
            return getContext().getResources().getString(33685787);
        } else {
            if (index == 7) {
                return getContext().getResources().getString(33685780, new Object[]{daySeq, hourSeq, minutesSeq});
            } else if (index == 6) {
                return getContext().getResources().getString(33685781, new Object[]{daySeq, hourSeq});
            } else if (index == 5) {
                return getContext().getResources().getString(33685782, new Object[]{daySeq, minutesSeq});
            } else if (index == 4) {
                return getContext().getResources().getString(33685783, new Object[]{daySeq});
            } else if (index == 3) {
                return getContext().getResources().getString(33685784, new Object[]{hourSeq, minutesSeq});
            } else if (index == 2) {
                return getContext().getResources().getString(33685785, new Object[]{hourSeq});
            } else {
                return getContext().getResources().getString(33685786, new Object[]{minutesSeq});
            }
        }
    }
    ...
    private void updateActionUI(View v, int actionID, int idText, final int idImage) {
        if (v != null) {
            ...
            final ImageView rebootImageView = (ImageView) rebootAction.findViewById(34603123);
            if (this.mHandler != null) {
    ...
    private void showNewRebootAndShutdownUI(View v) {
        updateActionUI(v, 34603211, ID_STR_REBOOT, 33751332);
        setActionClickListener(v, 34603211, REBOOT_TAG);
        updateActionUI(v, 34603212, ID_STR_SHUTDOWN, 33751331);
    ...
    private void replacePoweroffHint(TextView poweroffHintView) {
        if (poweroffHintView != null) {
            ...
            poweroffHintView.setText(String.format(tmpResources.getString(33685838), new Object[]{Integer.valueOf(poweroffHintTime)}));
        }
    }
