...
public class ShutdownMenuAnimations {
    ...
    private final Interpolator typeA = new CubicBezierInterpolator(0.51f, 0.35f, 0.15f, HwCircleAnimation.SMALL_ALPHA);
            ...
            if (view != null) {
                ...
                switch (view.getId()) {
                    ...
                    case ID_SHUTDOWN_RESOURCE /*34603212*/:
                        ...
                        fromX = (int) mContext.getResources().getDimension(34472089);
                        fromY = (int) mContext.getResources().getDimension(34472090);
