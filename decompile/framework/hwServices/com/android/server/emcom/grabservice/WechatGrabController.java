...
public class WechatGrabController extends BaseGrabController {
    ...
    private void onNewPacketReceive(WechatMessage localWechatMessage) {
        ...
        this.mHandler.sendMessageDelayed(Message.obtain(this.mHandler, 3, 1, this.mNotifyId), 30000);
    }

    private void sendMessage(byte eventType) {
        this.mHandler.obtainMessage(2, new BluetoothMessage((byte) 1, eventType, (byte) 1, AutoGrabTools.intToByteArray(this.mNotifyId))).sendToTarget();
    }
    ...
    private void sendPendingIntent() {
        ...
        try {
            ...
            this.mHandler.sendMessageDelayed(Message.obtain(this.mHandler, 3, 2, this.mGrabingId), 25000);
