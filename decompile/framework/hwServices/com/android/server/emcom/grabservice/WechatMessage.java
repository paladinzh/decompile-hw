...
public class WechatMessage implements IMessage, Serializable {
    ...
    private String conversation = AppHibernateCst.INVALID_PKG;
    private String from = AppHibernateCst.INVALID_PKG;
    private String message = AppHibernateCst.INVALID_PKG;
    PendingIntent pendingIntent;
    private int type = -1;
    String wechatId = AppHibernateCst.INVALID_PKG;
