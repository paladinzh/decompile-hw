...
public class HwAutomaticBrightnessNewPolicyController extends AutomaticBrightnessController {
    ...
    private static float BrightenDebounceTimeParaBig = HwCirclePrompt.BG_ALPHA;
    ...
    private static float DarkenDebounceTimePara = HwCircleAnimation.SMALL_ALPHA;
    ...
    private static float DarkenDeltaLuxPara = HwCircleAnimation.SMALL_ALPHA;
    ...
    private static String TAG = "HwAutomaticBrightnessNewPolicyController";
    ...
    public HwAutomaticBrightnessNewPolicyController(Callbacks callbacks, Looper looper, SensorManager sensorManager, Spline autoBrightnessSpline, int lightSensorWarmUpTime, int brightnessMin, int brightnessMax, float dozeScaleFactor, int lightSensorRate, long brighteningLightDebounceConfig, long darkeningLightDebounceConfig, boolean resetAmbientLuxAfterWarmUpConfig, Context context) {
        super(callbacks, looper, sensorManager, createAutoBrightnessHwNewPolicySpline(context), lightSensorWarmUpTime, brightnessMin, brightnessMax, dozeScaleFactor, lightSensorRate, brighteningLightDebounceConfig, darkeningLightDebounceConfig, resetAmbientLuxAfterWarmUpConfig, 10000, 3.0f);
        ...
        this.mAmbientLightRingBufferFilter = new AmbientLightRingBuffer(50, 10000);
    }
    ...
    public HwAutomaticBrightnessNewPolicyController(Callbacks callbacks, Looper looper, SensorManager sensorManager, Spline autoBrightnessSpline, int lightSensorWarmUpTime, int brightnessMin, int brightnessMax, float dozeScaleFactor, Context context) {
        this(callbacks, looper, sensorManager, createAutoBrightnessHwNewPolicySpline(context), lightSensorWarmUpTime, brightnessMin, brightnessMax, dozeScaleFactor, 0, 0, 0, false, context);
    }
