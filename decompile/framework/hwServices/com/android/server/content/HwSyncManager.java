...
public final class HwSyncManager extends SyncManager {
    ...
    public boolean isAllow2Sync(int uid) {
        ...
        if (isOK || !"CN".equalsIgnoreCase(SystemProperties.get("ro.product.locale.region", AppHibernateCst.INVALID_PKG)) || this.mPowerManager.isScreenOn() || !doesUidHavePackage(uid, "com.google.android.gms")) {
            return true;
        }
