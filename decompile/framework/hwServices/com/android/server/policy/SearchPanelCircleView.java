...
public class SearchPanelCircleView extends FrameLayout {
    ...
    public SearchPanelCircleView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mCircleMinSize = context.getResources().getDimensionPixelSize(34472148);
        this.mBaseMargin = context.getResources().getDimensionPixelSize(34472149);
        this.mStaticOffset = context.getResources().getDimensionPixelSize(34472150);
        this.mMaxElevation = context.getResources().getDimensionPixelSize(34472151);
    ...
    private void updateLogo() {
        ...
        if (exitAnimationRunning) {
            ...
            this.mLogo.setAlpha(Math.max(((HwCircleAnimation.SMALL_ALPHA - t) - 0.5f) * 2.0f, 0.0f));
        }
    ...
    private void performExitFadeOutAnimation(int startDelay, int duration, final Runnable endRunnable) {
        ...
        this.mFadeOutAnimator.addUpdateListener(new AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                float logoValue = SearchPanelCircleView.ALPHA_OUT.getInterpolation(HwCircleAnimation.SMALL_ALPHA - (animatedFraction > 0.5f ? HwCircleAnimation.SMALL_ALPHA : animatedFraction / 0.5f));
