...
public class HwUsbDeviceManager extends UsbDeviceManager {
    ...
    private void createWarningDialog() {
        this.mWarningDialog = new AlertDialog.Builder(this.mContext, 33947691).setTitle(33685890).setMessage(33685891).setIcon(17301543).setPositiveButton(33685892, new OnClickListener() {
