    ...
    class UsbDebuggingHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 2:
                    if (HwUsbHDBManagerImpl.this.mHdbEnabled) {
                        HwUsbHDBManagerImpl.this.mHdbEnabled = false;
        ...
        private void listenToSocket() throws IOException {
            ...
            while (true) {
                ...
                try {
                    ...
                    String key = new String(Arrays.copyOfRange(buffer, 2, count), Charset.defaultCharset());
    ...
    private void writeKey(String key) {
        ...
        try {
            ...
            if (keyFile != null) {
                ...
                try {
                    fo.write(key.getBytes(Charset.defaultCharset()));
                    fo.write(10);
                    if (fo != null) {
                        try {
                            fo.close();
