...
public class HwActivityStack extends ActivityStack implements IHwActivityStack {
    ...
    protected int overrideRealConfigChanged(ActivityRecord r) {
        int realConfigChange = r.info.getRealConfigChanged();
        ...
        Slog.v(TAG, "r.info.packageName = " + r.info.packageName + " r.task.mFullscreen = " + r.task.mFullscreen);
        if (r.task.mFullscreen && forceRotationManager.isAppInForceRotationWhiteList(r.info.packageName)) {
