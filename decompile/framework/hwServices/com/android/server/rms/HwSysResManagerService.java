...
public final class HwSysResManagerService extends SystemService {
        ...
        public boolean handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 4:
                    ...
                    return true;
                case 5:
                    if ((Utils.RMSVERSION & 1) == 0 && (Utils.RMSVERSION & 2) == 0) {
                    ...
                    if (!statisticDisable) {
                        ...
                        if (HwSysResManagerService.this.mStatisticCtl != null && baseSamplePeriod > 0) {
                            ...
                            HwSysResManagerService.this.mHandler.sendEmptyMessageDelayed(5, (long) baseSamplePeriod);
                        }
                    }
                    return true;
                case 6:
                    if (HwSysResManagerService.enableRms && (Utils.RMSVERSION & 8) != 0) {
                ...
                case 10:
                    ...
                    if (args.getBoolean("appsSatus")) {
                        AppTypeRecoManager.getInstance().addAppType(pkgName, apptype);
                    } else {
    ...
    private ResourceRecordStore mResourceRecordStore = new ResourceRecordStore();
    private final IBinder mService = new IHwSysResManager.Stub() {
        ...
        public void reportAppType(String pkgName, int appType, boolean status) {
            if (HwSysResManagerService.this.checkServiceReadyAndPermission()) {
                Message msg = HwSysResManagerService.this.mHandler.obtainMessage();
                msg.what = 10;
        ...
        protected void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
            ...
            } else if (Binder.getCallingUid() > 1000 || !TestCase.test(HwSysResManagerService.this.mContext, pw, args)) {
    ...
    public HwSysResManagerService(Context context) {
        ...
        if (enableRms && (Utils.RMSVERSION & 8) != 0) {
            if (Utils.HWFLOW) {
    ...
    public void handleInitService() {
        ...
        if (!statisticDisable) {
            ...
            if (baseSamplePeriod > 0) {
                ...
                this.mHandler.sendEmptyMessageDelayed(5, (long) baseSamplePeriod);
            }
        }
        try {
        ...
        try {
            ...
            this.mPtr = nativeInit(this, this.mHandler.getLooper().getQueue(), 1);
        ...
        setSRMSFeature();
        monitorUsageInfo();
        this.mThirdAppUploadInterval = this.mConfig.getResourceThreshold(19, 3);
    }
    ...
    private void monitorUsageInfo() {
        ...
        this.mAppUsageFile = new AppUsageFileRecord(this.mContext, this.mConfig.getResourceMaxPeroid(19, 3), appUsageFileEnabled);
        if (appUsageFileEnabled) {
