...
public class MultiTaskPolicyList {
    ...
    private static String MULTITASK_POLICY_FILEPATH_CUST = "/data/cust/xml/multi_task_config.xml";
    private static String MULTITASK_POLICY_FILEPATH_DEFAULT = "/system/etc/multi_task_config.xml";
    ...
    private static MultiTaskPolicyList instance = null;
    static final Object mLock = new Object[0];
    HashMap<String, MultiTaskResourceConfig> multiTaskPolicy = new HashMap();
    ...
    public static class PolicyConfig {
        ArrayList<PolicyConditionConfig> conditions = null;
