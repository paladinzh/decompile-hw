...
public class RPolicyManager implements RPolicyCreator {
    ...
    private static /* synthetic */ int[] -getandroid-rms-iaware-AwareConstant$FeatureTypeSwitchesValues() {
        ...
        try {
            iArr[FeatureType.FEATURE_CPU.ordinal()] = 5;
        } catch (NoSuchFieldError e5) {
        }
        try {
            iArr[FeatureType.FEATURE_DEFRAG.ordinal()] = 6;
        } catch (NoSuchFieldError e6) {
        }
        try {
            iArr[FeatureType.FEATURE_INVALIDE_TYPE.ordinal()] = 7;
        } catch (NoSuchFieldError e7) {
        }
        try {
            iArr[FeatureType.FEATURE_IO.ordinal()] = 8;
        } catch (NoSuchFieldError e8) {
        }
        try {
            iArr[FeatureType.FEATURE_MEMORY.ordinal()] = 9;
        } catch (NoSuchFieldError e9) {
        }
        try {
            iArr[FeatureType.FEATURE_RESOURCE.ordinal()] = 10;
