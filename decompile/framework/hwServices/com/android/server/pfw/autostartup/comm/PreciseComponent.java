...
public class PreciseComponent {
    ...
    private String mKey;
    private Set<String> mRelatedPkgs = new HashSet();
    private int mScope;
    ...
    private boolean validType() {
        return this.mType == 0 || 1 == this.mType || 2 == this.mType;
    }
    ...
    private boolean validScreenStatus() {
        return this.mScreenStatus == 0 || 1 == this.mScreenStatus;
    }
