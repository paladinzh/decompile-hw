...
public class HwPFWAppWakeLockPolicy extends HwPFWPolicy {
    ...
    private long mInitAppWakeLockTime = 0;
    private boolean mIsScrOff = false;
    private Map<Integer, Long> mLastAcquireWakelock = new HashMap();
    private int mQQUid = -1;
    private Runnable mScrOffWakeLock = new Runnable() {
        public void run() {
    ...
    private Map<Integer, Long> mUidWakeLockMap = new HashMap();
    private Handler mWakelockHandler = null;
    private int mWechatUid = -1;
        ...
        if (this.mEnabled) {
            ...
            if (action != null) {
                if (action.equals("android.intent.action.BOOT_COMPLETED")) {
                    ...
                    this.mWechatUid = getAppUid("com.tencent.mm");
                    this.mQQUid = getAppUid(QQ_PKG_NAME);
                    this.mGmsUid = getAppUid("com.google.android.gms");
                        ...
                        if (wakelocks != null) {
                            if (wakelocks.size() > 0) {
                                for (Entry<String, ? extends Wakelock> ent : wakelocks.entrySet()) {
                                    ...
                                    if (!skipTags.contains((String) ent.getKey())) {
    ...
    private void forceStopAbnormalWakelockApp(int uid) {
        ...
        if (packages != null) {
            ...
            for (String pac : packages) {
                if (!("abbanza.bixpe.orange.dispositivos.android".equals(pac) || "com.android.mediacenter".equals(pac))) {
