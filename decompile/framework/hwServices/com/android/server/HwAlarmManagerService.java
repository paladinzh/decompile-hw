...
public class HwAlarmManagerService extends AlarmManagerService {
    ...
    private static final boolean IS_DEVICE_ENCRYPTED = "encrypted".equals(SystemProperties.get("ro.crypto.state", AppHibernateCst.INVALID_PKG));
    ...
    private void saveDeskClock(Alarm a) {
        if (a != null && a.operation.getTargetPackage().equals(DESKCLOCK_PACKAGENAME) && resetStrExtraCallingIdentity(a.operation, IS_OWNER_ALARM, false)) {
    ...
    public void removePackageAlarm(final String pkg) {
        if (this.mHandler != null) {
            this.mHandler.post(new Runnable() {
                public void run() {
                    synchronized (HwAlarmManagerService.this.mLock) {
                        HwAlarmManagerService.this.removeLocked(pkg, null);
                    }
                }
            });
        }
