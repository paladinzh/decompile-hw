...
final class SingleHandWindow {
    ...
    void updateLocale() {
        ...
        if (isFingerPrintHand()) {
            this.singlehandmode_slide_hint.setText(this.mContext.getResources().getString(33685896));
        } else {
    ...
    private void createWindow() {
        ...
        this.mWindowParams.alpha = HwCircleAnimation.SMALL_ALPHA;
        this.mWindowParams.gravity = 51;
        this.mWindowParams.format = -3;
        if (this.mName.contains("blurpaper")) {
            showHint(!hintShown);
            this.mWidthScale = HwCircleAnimation.SMALL_ALPHA;
            this.mHeightScale = HwCircleAnimation.SMALL_ALPHA;
        }
    }
    ...
    private void showHint(boolean visible) {
        ...
        if (isFingerPrintHand()) {
            ...
            if (imageView != null) {
                ...
                params.height = (int) (((float) this.mContext.getResources().getDimensionPixelSize(17104920)) * 0.75f);
