...
public class HWDrmDialogsService {
    ...
    private String mRightsIssuer = AppHibernateCst.INVALID_PKG;
    ...
    private void showDlg(int dialog) {
        switch (dialog) {
            case 0:
                if (this.mToast == null) {
                    this.mToast = Toast.makeText(this.mContext, 33685709, 1);
                } else {
            ...
            case 1:
                if (AppHibernateCst.INVALID_PKG.equals(this.mRightsIssuer)) {
                    if (this.mToast == null) {
                        this.mToast = Toast.makeText(this.mContext, 33685708, 1);
                    } else {
                    ...
                    this.mAlertDlg = new Builder(this.mContext, 33947691).setCancelable(false).setTitle(17039380).setMessage(33685642).setPositiveButton(17039370, new OnClickListener() {
                        public void onClick(DialogInterface dialog, int whichButton) {
                            ...
                            if (HWDrmDialogsService.this.mToast == null) {
                                HWDrmDialogsService.this.mToast = Toast.makeText(HWDrmDialogsService.this.mContext, 33685710, 1);
                            } else {
            ...
            case 2:
                if (this.mToast == null) {
                    this.mToast = Toast.makeText(this.mContext, 33685711, 1);
                } else {
