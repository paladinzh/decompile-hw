...
public class HwGpsActionReporter implements IHwGpsActionReporter {
    ...
    private String mMccMnc = AppHibernateCst.INVALID_PKG;
    ...
    private void reportGpsSwitch(int gpsSwitchStatus) {
        String reportString = new StringBuilder(AppHibernateCst.INVALID_PKG).append("{ACT:").append(gpsSwitchStatus).append(",RT:").append((isGpsProviderSettingOn(this.mCurrentUserId) ? 1 : 0) == gpsSwitchStatus).append("}").toString();
        if (HWFLOW) {
    ...
    private void reportGpsStarted(int positionMode) {
        String reportString = new StringBuilder(AppHibernateCst.INVALID_PKG).append("{GA:").append(1).append(",PAR1:").append(positionMode).append(",PAR2:").append(60000).append("}").toString();
        if (HWFLOW) {
    ...
    private void reportGpsStopped(int ttff, int svCount, double deltaDistance) {
        String reportString = new StringBuilder(AppHibernateCst.INVALID_PKG).append("{GA:").append(0).append(",PAR1:").append(ttff).append(",PAR2:").append(svCount).append(",PAR3:").append(this.mProvider).append(",PAR4:").append(this.mTableID).append(",PAR5:").append(deltaDistance).append("}").toString();
        if (HWFLOW) {
