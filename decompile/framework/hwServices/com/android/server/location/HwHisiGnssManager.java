...
public class HwHisiGnssManager {
    ...
    protected static final HashMap<Integer, HashMap<Integer, String>> mapGpsEventReason = new HashMap();
    protected static final HashMap<String, TriggerLimit> mapHalDriverEventTriggerFreq = new HashMap();
    protected static final HashMap<Integer, ChrLogBaseEventModel> mapSaveLogModel = new HashMap();
        ...
        if (mapHalDriverEventTriggerFreq.containsKey(suberror)) {
            ...
            if (triggerLimit != null) {
                if (nowTime - triggerLimit.lastUploadTime > 86400000) {
                    ...
                    if (triggerLimit.triggerNum > (commercialUser ? 50 : 100)) {
                        isMatch = false;
                    }
                }
                if (isMatch) {
    ...
    private void writeCHRInfo(int type, boolean ChipLogEnable) {
        ...
        GnssConnectivityLogManager.getInstance().reportAbnormalEventEx(cChrLogBaseModel, 14, 1, type, date, 1);
    }
}
