...
public class HwGeocoderProxy extends GeocoderProxy {
    ...
    public String getConnectedPackageName() {
        if (this.start_g && this.start_ab) {
            ...
            if (this.mNlpUsed == 1) {
                return this.mServiceWatcherGoogle.getBestPackageName() + ";" + this.mServiceWatcherAb.getBestPackageName();
            }
            return this.mServiceWatcherAb.getBestPackageName() + ";" + this.mServiceWatcherGoogle.getBestPackageName();
        } else if (this.start_g) {
            return this.mServiceWatcherGoogle.getBestPackageName();
        } else {
            return this.mServiceWatcherAb.getBestPackageName();
