...
public class HwCircleAnimation {
    ...
    private static final float[] BG_COLOR_POS = new float[]{0.0f, 0.3f, SMALL_ALPHA};
    ...
    private static int SMALL_Y_LUNCH = (SMALL_Y + CPUFeature.MSG_THERMAL_LIMITED);
    ...
    public void startRingOutAnim(int cx, int cy, int type) {
        ...
        if (!this.mIsCircleAnimating) {
            ...
            this.mPvhRing2.setFloatValues(new float[]{0.0f, RING_ALPHA});
            this.mPvhRing3.setFloatValues(new float[]{0.0f, SMALL_ALPHA});
            this.mPvhRing4.setIntValues(new int[]{SMALL_Y_0, SMALL_Y});
            this.mPvhRing5.setFloatValues(new float[]{0.0f, BG_ALPHA});
    ...
    private void startLunchAnimation() {
        ...
        if (this.mAnimRing != null) {
            ...
            this.mPvhRing5.setFloatValues(new float[]{BG_ALPHA, 0.0f});
    ...
    private void drawRing(Canvas canvas) {
        if (this.mType == 4) {
            ...
            this.mPaint.setAlpha((int) ((this.mBgAlpha < BG_ALPHA ? this.mBgAlpha : this.mBgAlpha + (this.mFillProcess * 0.2f)) * 255.0f));
