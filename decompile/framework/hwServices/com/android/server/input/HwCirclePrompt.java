...
public class HwCirclePrompt {
    ...
    private static final float[] BG_COLOR_POS = new float[]{0.0f, 0.3f, HwCircleAnimation.SMALL_ALPHA};
    ...
    float mDpi = HwCircleAnimation.SMALL_ALPHA;
    ...
    private void drawText(Canvas canvas, TextPaint paint) {
        ...
        canvas.save();
        paint.setTextSize((float) this.mResources.getDimensionPixelSize(34472118));
        ...
        if (str != null) {
            StaticLayout staticlayout = new StaticLayout(str, paint, this.mWidth - this.fontRightPadding, Alignment.ALIGN_NORMAL, HwCircleAnimation.SMALL_ALPHA, 0.0f, false);
    ...
    private void drawTextH(Canvas canvas, TextPaint paint) {
        ...
        paint.setTextAlign(Align.CENTER);
        String str = this.mContext.getString(33685831);
        StaticLayout staticlayout = new StaticLayout(str, paint, this.mHeight - this.fontRightPadding, Alignment.ALIGN_NORMAL, HwCircleAnimation.SMALL_ALPHA, 0.0f, false);
    ...
    private void loadBitmap() {
        ...
        if (this.mIsPortrait) {
            this.mBitmap = BitmapFactory.decodeResource(this.mContext.getResources(), 33751444, options);
        } else {
            this.mBitmapH = BitmapFactory.decodeResource(this.mContext.getResources(), 33751445, options);
        }
        if (DEBUG) {
