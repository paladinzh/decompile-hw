...
public class TaskStack implements DimLayerUser, AnimateBoundsUser {
    ...
    void positionTask(Task task, int position, boolean showForAllUsers) {
        ...
        if (windows.size() >= 4) {
            String pkg1 = ((WindowState) windows.get(0)).getOwningPackage();
            String pkg2 = ((WindowState) windows.get(1)).getOwningPackage();
            String pkg3 = ((WindowState) windows.get(2)).getOwningPackage();
            if ("com.huawei.hwstartupguide".equals(((WindowState) windows.get(3)).getOwningPackage()) && pkg3 == null && "com.android.incallui".equals(pkg2) && "com.android.systemui".equals(pkg1)) {
