...
class ScreenRotationAnimation {
        ...
        if (HISI_ROT_ANI_OPT) {
            ...
            while (i >= 0) {
                ...
                if (win.mAttrs.type == 3) {
                    ...
                    this.mIsLandScape = this.mPerfHub.perfEvent(4103, "pkg_name=" + win.mAttrs.packageName, new int[0]);
    ...
    private boolean stepAnimation(long now) {
        ...
        boolean more = ((this.TWO_PHASE_ANIMATION && (this.mMoreStartEnter || this.mMoreStartExit || this.mMoreFinishEnter || this.mMoreFinishExit)) || this.mMoreRotateEnter || this.mMoreRotateExit) ? true : !this.mFinishAnimReady;
