...
public class DockedStackDividerController implements DimLayerUser {
    ...
    private float getClipRevealMeetFraction(TaskStack stack) {
        ...
        return ((CLIP_REVEAL_MEET_LAST - Math.max(0.0f, Math.min(CLIP_REVEAL_MEET_LAST, ((((float) Math.abs(this.mService.mAppTransition.getLastClipRevealMaxTranslation())) / ((float) stack.getMinimizeDistance())) - CLIP_REVEAL_MEET_FRACTION_MIN) / CLIP_REVEAL_MEET_FRACTION_MIN))) * 0.39999998f) + 0.6f;
    }
