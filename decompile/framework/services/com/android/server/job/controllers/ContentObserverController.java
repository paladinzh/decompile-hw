...
public class ContentObserverController extends StateController {
    ...
    ArrayMap<TriggerContentUri, ObserverInstance> mObservers = new ArrayMap();
            ...
            if (uris != null) {
                for (TriggerContentUri uri : uris) {
                    ...
                    if (obs == null) {
                        ...
                        this$0.mContext.getContentResolver().registerContentObserver(uri.getUri(), (uri.getFlags() & 1) != 0, obs);
                    }
                    obs.mJobs.add(this);
