    ...
    private void handleEarlyInteractiveChange() {
        synchronized (this.mLock) {
            if (this.mInteractive) {
                this.mHandler.post(new Runnable() {
                    public void run() {
                        EventLog.writeEvent(EventLogTags.POWER_SCREEN_STATE, new Object[]{Integer.valueOf(1), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0)});
    ...
    private void handleLateInteractiveChange() {
        synchronized (this.mLock) {
            if (this.mInteractive) {
                ...
                this.mHandler.post(new Runnable() {
                    public void run() {
                        EventLog.writeEvent(EventLogTags.POWER_SCREEN_STATE, new Object[]{Integer.valueOf(0), Integer.valueOf(why), Integer.valueOf(0), Integer.valueOf(0)});
