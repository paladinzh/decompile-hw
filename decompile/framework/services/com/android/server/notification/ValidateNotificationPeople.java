...
public class ValidateNotificationPeople implements NotificationSignalExtractor {
    ...
    private static class LookupResult {
        ...
        private boolean isExpired() {
            return this.mExpireMillis < System.currentTimeMillis() ? ValidateNotificationPeople.ENABLE_PEOPLE_VALIDATOR : false;
        }
    ...
    private class PeopleRankingReconsideration extends RankingReconsideration {
        ...
        public void work() {
            ...
            if (this.mRecord != null) {
                ValidateNotificationPeople.this.mUsageStats.registerPeopleAffinity(this.mRecord, this.mContactAffinity > ValidateNotificationPeople.NONE ? ValidateNotificationPeople.ENABLE_PEOPLE_VALIDATOR : false, this.mContactAffinity == ValidateNotificationPeople.STARRED_CONTACT ? ValidateNotificationPeople.ENABLE_PEOPLE_VALIDATOR : false, false);
            }
...
*/
    ...
    public void initialize(Context context, NotificationUsageStats usageStats) {
        ...
        this.mEnabled = 1 == Global.getInt(this.mBaseContext.getContentResolver(), SETTING_ENABLE_PEOPLE_VALIDATOR, 1) ? ENABLE_PEOPLE_VALIDATOR : false;
        if (this.mEnabled) {
    ...
    private RankingReconsideration validatePeople(Context context, NotificationRecord record) {
        ...
        if (rr == null) {
            ...
            boolean z2 = affinity > NONE ? ENABLE_PEOPLE_VALIDATOR : false;
