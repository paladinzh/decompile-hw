...
public class ZenModeHelper {
    ...
    private final Migration mConfigMigration = new Migration() {
    ...
    private void applyRestrictions() {
        ...
        boolean muteCalls = (!zen || this.mConfig.allowCalls || this.mConfig.allowRepeatCallers || Secure.getInt(this.mContext.getContentResolver(), "zen_call_white_list_enabled", 0) == 1) ? (this.mSuppressedEffects & 2) != 0 : true;
