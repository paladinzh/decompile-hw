...
public class ActivityStack extends AbsActivityStack {
    ...
    int mDisplayId;
    boolean mFullscreen = SHOW_APP_STARTING_PREVIEW;
    ...
    Boolean mRuningBackground = Boolean.valueOf(false);
...
*/
    ...
    final boolean isDockedStack() {
        return this.mStackId == 3 ? SHOW_APP_STARTING_PREVIEW : false;
    }
    ...
    void findTaskLocked(ActivityRecord target, FindTaskResult result) {
        ...
        for (int taskNdx = this.mTaskHistory.size() - 1; taskNdx >= 0; taskNdx--) {
            ...
            if (task.voiceSession != null) {
                ...
                if (r == null || r.finishing || (!(r.userId == userId || (this.mStackSupervisor.isCurrentProfileLocked(r.userId) && this.mStackSupervisor.isCurrentProfileLocked(userId))) || r.launchMode == 3)) {
                    if (ActivityManagerDebugConfig.DEBUG_TASKS) {
    ...
    ActivityRecord findActivityLocked(Intent intent, ActivityInfo info, boolean compareIntentFilters) {
        ...
        for (int taskNdx = this.mTaskHistory.size() - 1; taskNdx >= 0; taskNdx--) {
            ...
            for (int activityNdx = activities.size() - 1; activityNdx >= 0; activityNdx--) {
                ActivityRecord r = (ActivityRecord) activities.get(activityNdx);
                if (!(notCurrentUserTask && (r.info.flags & 1024) == 0) && !r.finishing && r.userId == userId && (r.intent.getHwFlags() & 1) == (intent.getHwFlags() & 1)) {
    ...
    void minimalResumeActivityLocked(ActivityRecord r) {
        ...
        if (!this.mService.mActivityStarter.mCurActivityPkName.equals(r.packageName)) {
            ...
            if (this.mRuningBackground.booleanValue()) {
                LogPower.push(114, this.mService.mActivityStarter.mCurActivityPkName);
    ...
    final void activityPausedLocked(IBinder token, boolean timeout) {
        ...
        if (r != null) {
            ...
            if (this.mPausingActivity == r) {
                Flog.i(101, "Moving to PAUSED: " + r + (timeout ? " (due to timeout)" : " (pause complete)"));
    ...
    private void addToStopping(ActivityRecord r, boolean immediate) {
        ...
        boolean forceIdle = this.mStackSupervisor.mStoppingActivities.size() <= 3 ? (!r.frontOfTask || this.mTaskHistory.size() > 1) ? false : SHOW_APP_STARTING_PREVIEW : SHOW_APP_STARTING_PREVIEW;
    ...
    private void completeResumeLocked(ActivityRecord next) {
        ...
        Flog.i(101, "completedResumed: " + next + ", launchTrack: " + this.mStackSupervisor.mActivityLaunchTrack);
...
jadx.core.utils.exceptions.CodegenException: Error generate insn: PHI: (r11_1 'taskNdx' int) = (r11_0 'taskNdx' int), (r11_4 'taskNdx' int) binds: {(r11_0 'taskNdx' int)=B:8:0x000c, (r11_4 'taskNdx' int)=B:26:0x0065} in method: com.android.server.am.ActivityStack.findNextTranslucentActivity(com.android.server.am.ActivityRecord):com.android.server.am.ActivityRecord
...
*/
            ...
            int getStackVisibilityLocked(ActivityRecord starting) {
                ...
                if ((this.mService.mLockScreenShown == 2 ? SHOW_APP_STARTING_PREVIEW : false) && !StackId.isAllowedOverLockscreen(this.mStackId)) {
                    return 0;
                }
            ...
            final void ensureActivitiesVisibleLocked(ActivityRecord starting, int configChanges, boolean preserveWindows) {
                ...
                boolean stackInvisible = stackVisibility != 1 ? SHOW_APP_STARTING_PREVIEW : false;
                boolean stackVisibleBehind = stackVisibility == 2 ? SHOW_APP_STARTING_PREVIEW : false;
            ...
            private boolean shouldBeVisible(ActivityRecord r, boolean behindTranslucentActivity, boolean stackVisibleBehind, ActivityRecord visibleBehind, boolean behindFullscreenActivity) {
                ...
                if (this.mService.mSupportsLeanbackOnly && z && r.isRecentsActivity()) {
                    z = this.mStackSupervisor.getStack(3) == null ? this.mStackSupervisor.isFocusedStack(this) : SHOW_APP_STARTING_PREVIEW;
                }
                return z;
            }
            ...
            private boolean resumeTopActivityInnerLocked(ActivityRecord prev, ActivityOptions options) {
                ...
                if (next == null) {
                    ...
                    returnTaskType = (taskRecord == null || !taskRecord.isOverHomeStack()) ? 1 : taskRecord.getTaskToReturnTo();
                    if (!this.mFullscreen) {
                ...
                if (taskRecord != null && taskRecord.stack == this && taskRecord.isOverHomeStack() && prev.finishing && prev.frontOfTask) {
                    ...
                    if (taskRecord == nextTask) {
                        ...
                        ((TaskRecord) this.mTaskHistory.get(this.mTaskHistory.indexOf(taskRecord) + 1)).setTaskToReturnTo(1);
                ...
                if (this.mService.isSleepingOrShuttingDownLocked() && this.mLastPausedActivity == next && this.mStackSupervisor.allPausedActivitiesComplete()) {
                    ...
                    if (this.mStackSupervisor.allPausedActivitiesComplete()) {
                        ...
                        if (this.mResumedActivity != null) {
                            ...
                            Flog.i(101, "resumeTopActivityLocked: Pausing " + this.mResumedActivity);
                            ...
                            if (next.app == null || next.app.thread == null) {
                                ...
                                if (notUpdated) {
                                    ...
                                    if (this.mStackSupervisor.reportResumedActivityLocked(next)) {
                                        Flog.i(101, "resumeTopActivityLocked, report resumed activity: " + next);
                                        this.mNoAnimActivities.clear();
                                        if (ActivityManagerDebugConfig.DEBUG_STACK) {
                                            this.mStackSupervisor.validateTopActivitiesLocked();
                                        }
            ...
            protected void insertTaskAtTop(TaskRecord task, ActivityRecord newActivity) {
                ...
                if (isOnHomeDisplay()) {
                    ...
                    Flog.i(101, "insertTaskAtTop, setTaskToReturnTo: fromHome=" + fromHome + ",lastStackTop=" + lastStack.topTask() + ", isHomeStack=" + isHomeStack() + ", topTask=" + topTask() + ", task=" + task);
                ...
                boolean notShownWhenLocked = (newActivity == null || (newActivity.info.flags & 1024) != 0) ? (newActivity == null && task.topRunningActivityLocked() == null) ? SHOW_APP_STARTING_PREVIEW : false : SHOW_APP_STARTING_PREVIEW;
                ...
                for (int i = numActivities - 1; i > rootActivityNdx; i--) {
                    ...
                    if (!finishOnTaskLaunch && !clearWhenTaskReset && target.resultTo != null) {
                        ...
                        if (bottom == null || target.taskAffinity == null || !target.taskAffinity.equals(bottom.task.affinity)) {
                            ...
                            Flog.i(105, "ResetTask:Start pushing activity " + target + " out to new task " + target.task);
                        } else {
                            targetTask = bottom.task;
                            Flog.i(105, "ResetTask:Start pushing activity " + target + " out to bottom task " + bottom.task);
                        }
                        ...
                        for (srcPos = start; srcPos >= i; srcPos--) {
                            ...
                            if (!p.finishing) {
                                ...
                                Flog.i(105, "ResetTask:Pushing next activity " + srcPos + ": " + p + " out to target's task " + targetTask);
                ...
                if (this.mStackSupervisor.isFocusedStack(this) && this.mService.mFocusedActivity == r) {
                    ...
                    if (next != r) {
                        ...
                        if (r.frontOfTask && task == topTask() && task.isOverHomeStack()) {
                            ...
                            if (!this.mFullscreen && adjustFocusToNextFocusableStackLocked(taskToReturnTo, myReason)) {
                                Flog.i(101, "adjustFocus in multiwindow reason=" + reason);
                                return;
                            } else if (this.mStackSupervisor.moveHomeStackTaskToTop(taskToReturnTo, myReason)) {
                                return;
                            }
                        }
                    }
            ...
            final ActivityRecord finishCurrentActivityLocked(ActivityRecord r, int mode, boolean oomAdj) {
                ...
                if (mode != 2 || (!(r.visible || r.nowVisible) || next == null || next.nowVisible)) {
                    ...
                    if (mode == 0 || ((prevState == ActivityState.PAUSED && (mode == 1 || ((mode == 2 && !this.mFullscreen) || this.mStackId == 4))) || prevState == ActivityState.STOPPED || prevState == ActivityState.INITIALIZING)) {
                        r.makeFinishingLocked();
                        boolean activityRemoved = destroyActivityLocked(r, SHOW_APP_STARTING_PREVIEW, "finish-imm");
                        if (prevState == ActivityState.PAUSED && mode == 2 && !this.mFullscreen) {
                            this.mStackSupervisor.ensureActivitiesVisibleLocked(null, 0, false);
            ...
            public void unhandledBackLocked() {
                ...
                if (top >= 0) {
                    ...
                    if (activityTop > 0) {
                        finishActivityLocked((ActivityRecord) activities.get(activityTop), 0, null, "unhandled-back", SHOW_APP_STARTING_PREVIEW);
                    }
                }
            }
            ...
            TaskRecord createTaskRecord(int taskId, ActivityInfo info, Intent intent, IVoiceInteractionSession voiceSession, IVoiceInteractor voiceInteractor, boolean toTop) {
                ...
                boolean isLockscreenShown = this.mService.mLockScreenShown == 2 ? SHOW_APP_STARTING_PREVIEW : false;
