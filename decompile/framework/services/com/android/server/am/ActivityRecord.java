...
public class ActivityRecord extends AbsActivityRecord {
    ...
    public ActivityRecord(ActivityManagerService _service, ProcessRecord _caller, int _launchedFromUid, String _launchedFromPackage, Intent _intent, String _resolvedType, ActivityInfo aInfo, Configuration _configuration, ActivityRecord _resultTo, String _resultWho, int _reqCode, boolean _componentSpecified, boolean _rootVoiceInteraction, ActivityStackSupervisor supervisor, ActivityContainer container, ActivityOptions options, ActivityRecord sourceRecord) {
        ...
        int i = ((_intent.getHwFlags() & 1) == 0 && this.info.applicationInfo.euid == 0) ? 0 : 1;
        ...
        if (aInfo != null) {
            ...
            boolean isTranslucent = (ent == null || !ent.array.getBoolean(5, false)) ? false : isForceRotationMode(this.packageName) ? false : SHOW_ACTIVITY_START_TIME;
            boolean z = ent != null ? !isTranslucent ? !ent.array.hasValue(5) ? ent.array.getBoolean(25, false) : false : SHOW_ACTIVITY_START_TIME : false;
            this.translucent = z;
            ...
            this.immersive = (aInfo.flags & 2048) != 0 ? SHOW_ACTIVITY_START_TIME : false;
    ...
    boolean isHomeActivity() {
        return this.mActivityType == 1 ? SHOW_ACTIVITY_START_TIME : false;
    }

    boolean isRecentsActivity() {
        return this.mActivityType == 2 ? SHOW_ACTIVITY_START_TIME : false;
    }
    ...
    boolean canGoInDockedStack() {
        ...
        return (isResizeableOrForced() || this.info.resizeMode == 1) ? SHOW_ACTIVITY_START_TIME : false;
    }
    ...
    void windowsVisibleLocked() {
        ...
        Flog.i(101, "windowsVisibleLocked(): " + this + " idle: " + this.idle);
        if (!this.nowVisible) {
    ...
    static ActivityRecord restoreFromXml(XmlPullParser in, ActivityStackSupervisor stackSupervisor) throws IOException, XmlPullParserException {
        ...
        while (true) {
            ...
            if (event == 1 || (event == 3 && in.getDepth() < outerDepth)) {
                ...
                ActivityRecord r = HwServiceFactory.createActivityRecord(service, null, launchedFromUid, launchedFromPackage, intent, resolvedType, aInfo, service.getConfiguration(), null, null, 0, componentSpecified, false, stackSupervisor, null, null, null);
        ...
        if (intent != null) {
            ...
            aInfo = stackSupervisor.resolveActivity(intent, resolvedType, 0, null, userId);
            if (aInfo != null) {
                ActivityRecord r2 = HwServiceFactory.createActivityRecord(service, null, launchedFromUid, launchedFromPackage, intent, resolvedType, aInfo, service.getConfiguration(), null, null, 0, componentSpecified, false, stackSupervisor, null, null, null);
