            ...
            if (!isPackageUploaded(sceneDef, pkg, extras.getString(KEY_ACTION, null))) {
                ...
                switch (sceneDef) {
                    case SCENE_DEF_BROADCAST_OVERLENGTH /*2801*/:
                        ...
                        break;
                    case 2803:
                        Flog.i(104, "Trigger receiver timeout radar upload. Receiver[" + extras.getString(KEY_RECEIVER, "unknown") + "] from " + pkg + " receiving " + extras.getParcelable(KEY_BROADCAST_INTENT) + " tooks " + extras.getFloat(KEY_RECEIVE_TIME, -1.0f) + "s.");
                        break;
                    default:
