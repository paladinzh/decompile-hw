...
public final class ProcessList {
    ...
    static final int SCHED_GROUP_KEY_BACKGROUND = 4;
    ...
    private static final long[] sFirstAwakePssTimes = new long[]{JobStatus.DEFAULT_TRIGGER_MAX_DELAY, JobStatus.DEFAULT_TRIGGER_MAX_DELAY, JobStatus.DEFAULT_TRIGGER_UPDATE_DELAY, 20000, 20000, 20000, 20000, 20000, 20000, 20000, 20000, 30000, 30000, 30000, 30000, 30000, 30000};
    private static OutputStream sLmkdOutputStream;
    private static LocalSocket sLmkdSocket;
    private static final int[] sProcStateToProcMem = new int[]{0, 0, 1, 2, 2, 1, 2, 2, 2, 2, 3, 4, 4, 4, 4, 4, 4};
    private static final long[] sSameAwakePssTimes = new long[]{900000, 900000, JobStatus.DEFAULT_TRIGGER_MAX_DELAY, 900000, 900000, 900000, 900000, 900000, 900000, 900000, 1200000, 1200000, 1800000, 1800000, 1800000, 1800000, 1800000};
    private static final long[] sTestFirstAwakePssTimes = new long[]{3000, 3000, 3000, 20000, 20000, 20000, 5000, 5000, 5000, 5000, 5000, 5000, 5000, 5000, 5000, 5000, 5000};
    ...
    private final int[] mOomAdj = new int[]{0, 100, PERCEPTIBLE_APP_ADJ, BACKUP_APP_ADJ, CACHED_APP_MIN_ADJ, CACHED_APP_MAX_ADJ};
