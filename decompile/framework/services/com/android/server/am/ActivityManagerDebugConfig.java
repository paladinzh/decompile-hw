...
class ActivityManagerDebugConfig {
    ...
    static {
        boolean z = true;
        boolean isLoggable = !Log.HWINFO ? Log.HWModuleLog ? Log.isLoggable(TAG_AM, 4) : false : true;
        HWFLOW = isLoggable;
        isLoggable = !Log.HWLog ? Log.HWModuleLog ? Log.isLoggable(TAG_AM, 3) : false : true;
