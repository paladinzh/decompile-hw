...
public class VoiceInteractionManagerService extends SystemService {
    ...
    final ActivityManagerInternal mAmInternal = ((ActivityManagerInternal) LocalServices.getService(ActivityManagerInternal.class));
    final Context mContext;
    final DatabaseHelper mDbHelper;
    final TreeSet<Integer> mLoadedKeyphraseIds = new TreeSet();
