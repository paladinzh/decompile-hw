...
*/
    ...
    protected void processBlock() {
        ...
        c = rotateLeft(((F(d, a, b) + c) + this.X[S23]) - 1502002290, 17) + d;
        b = rotateLeft(((F(c, d, a) + b) + this.X[S43]) + 1236535329, 22) + c;
        a = rotateLeft(((G(b, c, d) + a) + this.X[1]) - 165796510, 5) + b;
        d = rotateLeft(((G(a, b, c) + d) + this.X[6]) - 1069501632, 9) + a;
        c = rotateLeft(((G(d, a, b) + c) + this.X[11]) + 643717713, S23) + d;
        ...
        d = rotateLeft(((G(a, b, c) + d) + this.X[S23]) - 1019803690, 9) + a;
        ...
        c = rotateLeft(((G(d, a, b) + c) + this.X[7]) + 1735328473, S23) + d;
        ...
        b = rotateLeft(((H(c, d, a) + b) + this.X[S23]) - 35309556, 23) + c;
        ...
        c = rotateLeft(((H(d, a, b) + c) + this.X[S43]) + 530742520, 16) + d;
        ...
        c = rotateLeft(((K(d, a, b) + c) + this.X[10]) - 1051523, S43) + d;
        b = rotateLeft(((K(c, d, a) + b) + this.X[1]) - 2054922799, 21) + c;
        a = rotateLeft(((K(b, c, d) + a) + this.X[8]) + 1873313359, 6) + b;
        d = rotateLeft(((K(a, b, c) + d) + this.X[S43]) - 30611744, 10) + a;
        c = rotateLeft(((K(d, a, b) + c) + this.X[6]) - 1560198380, S43) + d;
