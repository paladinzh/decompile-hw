...
public class HwDsdsController extends Handler {
    ...
    private void setRadioPowerByCardState(boolean isCard1Present, boolean isCard2Present, boolean isCard1Inserted, boolean isCard2Inserted) {
    ...
    private void setRadioPowerForHotPlug() {
        ...
        if (mdsdsDesiredPowerState) {
            ...
            if (this.mUiccCards[0] != null) {
                if (this.mUiccCards[0].getCardState() == CardState.CARDSTATE_PRESENT) {
                    z = true;
                } else {
                    z = false;
                }
                ...
                if (this.mSubinfoAutoUpdateDone) {
                    ...
                    z = z && 1 == SubscriptionController.getInstance().getSubState(0);
                }
            } else {
                logd("setRadioPowerForHotPlug mUiccCards[0] == null");
            }
            if (this.mUiccCards[1] != null) {
                if (this.mUiccCards[1].getCardState() == CardState.CARDSTATE_PRESENT) {
                    isCard2Present = true;
                } else {
            ...
            logd("setRadioPowerForHotPlug isCard1Present=" + z + " ;isCard2Present=" + isCard2Present);
            setRadioPowerByCardState(z, isCard2Present, isCard1Inserted, isCard2Inserted);
            return;
        }
