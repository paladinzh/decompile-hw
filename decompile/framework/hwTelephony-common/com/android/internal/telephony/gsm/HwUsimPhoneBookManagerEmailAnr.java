...
public class HwUsimPhoneBookManagerEmailAnr extends UsimPhoneBookManager {
    ...
    private void readEmailFileAndWait(int recNum) {
        ...
        if (fileIds != null && fileIds.containsKey(Integer.valueOf(USIM_EFEMAIL_TAG))) {
            ...
            if (emailFileArray != null) {
                for (int m = 0; m < emailFileArray.size(); m++) {
    ...
    private void readAnrFileAndWait(int recNum) {
        ...
        if (!(fileIds != null ? fileIds.isEmpty() : true) && fileIds.containsKey(Integer.valueOf(USIM_EFANR_TAG))) {
            ...
            if (anrFileArray != null) {
                for (int m = 0; m < anrFileArray.size(); m++) {
    ...
    private int getEmailRecNumber(int adnRecIndex, int numRecs, String oldEmail) {
        ...
        if (!hasRecordIn(this.mEmailFileRecord, pbrIndex)) {
            ...
            if (record == null || this.mEmailTagNumberInIap >= record.length || record[this.mEmailTagNumberInIap] == (byte) -1 || (record[this.mEmailTagNumberInIap] & 255) <= 0 || (record[this.mEmailTagNumberInIap] & 255) > ((ArrayList) this.mEmailFileRecord.get(Integer.valueOf(pbrIndex))).size()) {
    ...
    private int getAnrRecNumber(int adnRecIndex, int numRecs, String oldAnr) {
        ...
        if (record == null || this.mAnrTagNumberInIap >= record.length || record[this.mAnrTagNumberInIap] == (byte) -1 || (record[this.mAnrTagNumberInIap] & 255) <= 0 || (record[this.mAnrTagNumberInIap] & 255) > ((ArrayList) this.mAnrFileRecord.get(Integer.valueOf(pbrIndex))).size()) {
    ...
    private void putValidRecNums(int pbrIndex) {
        ...
        for (int i = 0; i < ((Integer) this.mAdnLengthList.get(pbrIndex)).intValue(); i++) {
            ...
            case 12:
                ...
                if (ar.exception == null) {
                    ...
                    if (ext1FileArray != null) {
                        ...
                        for (int m = 0; m < ext1FileArray.size(); m++) {
    ...
    public int getSpareAnrCount() {
        ...
        for (int j = 0; j < pbrIndex; j++) {
            for (int i = 0; i < ((ArrayList) this.mAnrFlags.get(Integer.valueOf(j))).size(); i++) {
    ...
    public int getSpareEmailCount() {
        ...
        for (int j = 0; j < pbrIndex; j++) {
            for (int i = 0; i < ((ArrayList) this.mEmailFlags.get(Integer.valueOf(j))).size(); i++) {
    ...
    private void updateExt1RecordFlags(int pbrIndex) {
        if (hasRecordIn(this.mExt1FileRecord, pbrIndex)) {
            ...
            for (i = 0; i < numAdnRecs; i++) {
                ...
                if (rec != null && rec.getExtRecord() != 255 && rec.getExtRecord() > 0 && rec.getExtRecord() <= ((ArrayList) this.mExt1Flags.get(Integer.valueOf(pbrIndex))).size()) {
    ...
    private void updateExt1RecordFlagsForSim(int recNum) {
        ...
        for (i = 0; i < numAdnRecs; i++) {
            ...
            if (rec != null && rec.getExtRecord() != 255 && rec.getExtRecord() > 0 && rec.getExtRecord() <= ((ArrayList) this.mExt1Flags.get(Integer.valueOf(recNum))).size()) {
    ...
    public boolean updateExt1File(int adnRecNum, AdnRecord oldAdnRecord, AdnRecord newAdnRecord, int tagOrEfid) {
        ...
        if (IccRecords.getAdnLongNumberSupport()) {
            ...
            if (oldNumber.length() > 20 || newNumber.length() > 20) {
                int efid;
    ...
    private int getExt1RecNumber(int adnRecIndex) {
        ...
        if (extRecordNumber != 255 && extRecordNumber > 0 && extRecordNumber <= ((ArrayList) this.mExt1FileRecord.get(Integer.valueOf(pbrIndex))).size()) {
    ...
    public int getSpareExt1Count() {
        ...
        for (int j = 0; j < pbrIndex; j++) {
            for (int i = 0; i < ((ArrayList) this.mExt1Flags.get(Integer.valueOf(j))).size(); i++) {
