...
public class HwVpApStatusHandler extends Handler {
    ...
    public class EventReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("android.net.conn.CONNECTIVITY_CHANGE".equals(action)) {
                ...
                hwVpApStatusHandler = HwVpApStatusHandler.this;
                hwVpApStatusHandler.VP_Flag = hwVpApStatusHandler.VP_Flag | 128;
    ...
    protected HwVpApStatusHandler(GsmCdmaPhone phone) {
        ...
        if (phone != null) {
            ...
            this.VP_Flag = ((PowerManager) this.mPhone.getContext().getSystemService("power")).isScreenOn() ? this.VP_Flag | 128 : this.VP_Flag & -129;
