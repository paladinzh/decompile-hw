...
public class HwGSMPhoneReference extends HwPhoneReferenceBase implements GSMPhoneReference {
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            if (-1 != SystemProperties.getInt("persist.radio.stack_id_0", -1) && "android.intent.action.ACTION_SUBSCRIPTION_SET_UICC_RESULT".equals(intent.getAction())) {
    ...
    public HwGSMPhoneReference(GsmCdmaPhone phone) {
        ...
        this.mPhoneStateListener = new PhoneStateListener(this.mSlotId) {
    ...
    private String getSelectedApn() {
        ...
        if (isMultiEnable) {
            ...
            cursor = mContext.getContentResolver().query(ContentUris.withAppendedId(PREFERAPN_NO_UPDATE_URI, (long) slotId), new String[]{"_id", NumMatchs.NAME, "apn"}, null, null, NumMatchs.DEFAULT_SORT_ORDER);
        } else {
    ...
    private ArrayList<OperatorInfo> custAvaliableNetworks(ArrayList<OperatorInfo> searchResult) {
        ...
        for (OperatorInfo operatorInfo : searchResult) {
            ...
            if (iccRecords != null) {
                ...
                if ("50503".equals(plmn) && "50503".equals(hplmn) && (iccRecords.getDisplayRule(plmn) & 1) == 1) {
        ...
        switch (msg.what) {
            ...
            case HwVSimEventHandler.EVENT_HOTPLUG_SWITCHMODE /*1000*/:
                if (msg.arg2 == 1) {
                    ...
                    this.mPhone.mCi.getIMEI(this.mPhone.obtainMessage(9, msg.arg1, 0, null));
                } else if (msg.arg2 == 2) {
