...
class SubscriptionHelper extends Handler {
    ...
    public void updateSubActivation(int[] simStatus, boolean isStackReadyEvent) {
        ...
        if (isAllSubsAvailable() && !setUiccSent) {
            ...
            if (!((HwVSimUtils.isVSimDsdsVersionOne() && HwVSimUtils.isVSimEnabled()) || HwVSimUtils.isVSimInProcess())) {
                isVSimSkipUpdateUserPref = HwVSimUtils.isVSimCauseCardReload();
            }
    ...
    private void processSetUiccSubscriptionDone(Message msg) {
        ...
        if (ar.exception != null) {
            ...
            if ((ar.exception instanceof CommandException) && ((CommandException) ar.exception).getCommandError() == Error.RADIO_NOT_AVAILABLE && HwVSimUtils.isVSimEnabled() && HwVSimUtils.isVSimInProcess()) {
