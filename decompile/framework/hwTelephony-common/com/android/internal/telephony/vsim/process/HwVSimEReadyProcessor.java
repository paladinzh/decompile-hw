...
public class HwVSimEReadyProcessor extends HwVSimReadyProcessor {
    ...
    private void doRadioPowerOnForSwap(HwVSimRequest request) {
        ...
        if ((!HwVSimUtilsInner.isPlatformRealTripple() || HwVSimUtilsInner.isVSimDsdsVersionOne()) && (insertedSimCount == 0 || ((insertedSimCount == 1 && !hasIccCardOnM2) || !(insertedSimCount != 2 || ulOnlyMode || subId == userReservedSubId)))) {
