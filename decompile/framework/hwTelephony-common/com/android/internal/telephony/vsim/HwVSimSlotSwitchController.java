...
public class HwVSimSlotSwitchController extends StateMachine {
    ...
    private class InitialState extends State {
        ...
        public void enter() {
            ...
            for (int i = 0; i < HwVSimSlotSwitchController.SUB_COUNT; i++) {
                HwVSimSlotSwitchController.this.mCis[i].registerForAvailable(HwVSimSlotSwitchController.this.getHandler(), 17, Integer.valueOf(i));
            }
        ...
        private boolean isGotAllRatCombineMode() {
            ...
            if (HwVSimUtils.isPlatformTwoModems()) {
                ...
                while (i < HwVSimSlotSwitchController.SUB_COUNT) {
                    if (HwVSimSlotSwitchController.this.mCis[i].isRadioAvailable() && !HwVSimSlotSwitchController.this.mGotRatCombineMode[i]) {
                        result = false;
                    }
                    i++;
                }
        ...
        private void checkAndSwitchSlot() {
            ...
            if (!HwVSimSlotSwitchController.this.mGotSimSlot || !isGotAllRatCombineMode()) {
    ...
    private class SwitchCommrilModeState extends State {
        ...
        public boolean processMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 25:
                    ...
                    hwVSimSlotSwitchController.mPollingCount = hwVSimSlotSwitchController.mPollingCount - 1;
                    HwVSimSlotSwitchController.this.logi("mPollingCount = " + HwVSimSlotSwitchController.this.mPollingCount);
                    HwVSimSlotSwitchController.this.setUserSwitchDualCardSlots(HwVSimSlotSwitchController.this.mExpectSlot);
                    HwVSimSlotSwitchController.this.processSwitchCommrilMode();
                    break;
                default:
        ...
        private void restartRild() {
            ...
            for (int subId = 0; subId < HwVSimSlotSwitchController.PHONE_COUNT; subId++) {
                HwVSimSlotSwitchController.this.logd("restartRild : setDesiredPowerState is true for subId:" + subId);
                ((GsmCdmaPhone) mVSimController.getPhoneBySub(subId)).getServiceStateTracker().setDesiredPowerState(true);
            }
            resetStatus();
            HwVSimSlotSwitchController.this.logi("restart rild");
            if (HwVSimSlotSwitchController.this.mIsVSimOn) {
                HwVSimSlotSwitchController.this.mCis[HwVSimSlotSwitchController.SUB_VSIM].restartRild(null);
            } else {
                HwVSimSlotSwitchController.this.mCis[HwVSimSlotSwitchController.this.mMainSlot].restartRild(null);
            }
    ...
    private void initWhatToStringMap() {
        ...
        this.mWhatToStringMap.put(Integer.valueOf(17), "EVENT_RADIO_AVAILABLE");
    ...
    private void setAllRaidoPowerOff() {
        ...
        for (subId = 0; subId < this.mCis.length; subId++) {
            if (this.mRadioPowerStatus[subId]) {
                ...
                Message onCompleted = obtainMessage(36, Integer.valueOf(subId));
