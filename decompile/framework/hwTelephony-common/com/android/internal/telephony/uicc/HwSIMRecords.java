...
public class HwSIMRecords extends SIMRecords {
    ...
    private static final boolean FEATURE_POP_SIM_UNSUPPORT_LTE = SystemProperties.getBoolean("ro.config.hw_pop_unsupport_lte", false);
    ...
    private void popUnsupportLte(UiccCard uiccCard, int slotId, String iccid) {
        ...
        boolean is3gCard = (apptype == AppType.APPTYPE_CSIM || apptype == AppType.APPTYPE_ISIM) ? true : apptype == AppType.APPTYPE_USIM;
        ...
        if (is3gCard && ((networkType == 9 || networkType == 0) && (simOperator == 1 || simOperator == 2))) {
