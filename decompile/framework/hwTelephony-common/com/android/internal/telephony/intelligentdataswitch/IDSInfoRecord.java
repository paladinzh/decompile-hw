...
public class IDSInfoRecord {
    ...
    private boolean mIdsState = false;
    private boolean[] mInVoicecall = new boolean[]{false, false};
    private boolean[] mIsSlotRoaming = new boolean[]{false, false};
    private boolean mIsUserDataEnabled = false;
    private boolean mIsWifiConnected = false;
    private ServiceState[] mServiceState = new ServiceState[]{null, null};
    private SignalStrength[] mSignalStrength = new SignalStrength[]{null, null};
    private int mUserDefaultDataSlot = SubscriptionController.getInstance().getDefaultDataSubId();
