...
public class IDSManager extends StateMachine {
    ...
    private int mAbnormalReason = -1;
    private int mAbnormalSlotId = -1;
    private Context mContext = null;
    private boolean mDataSwitchBroadcastSend = false;
    private int mDataSwitchForbiddenInterval = 120000;
    private int mDefaultDataSlotWeakCount = 0;
    private DsmDefaultState mDefaultState = new DsmDefaultState();
    private int mGoodEcioForCdma = -12;
    private int mGoodRscpForWandTD = -85;
    private int mGoodRsrpForLte = -90;
    private int mGoodRsrqForLte = -10;
    private int mGoodRssiForCdma = -85;
    private int mGoodRssiForEvdo = -85;
    private int mGoodSignalStrengthForGsm = -85;
    private int mGoodSnrForEvdo = 7;
    private DsmHaltingState mHaltingState = new DsmHaltingState();
    private IntelligentDataSwitch mIDS = null;
    private DsmIdleState mIdleState = new DsmIdleState();
    private IDSInfoRecord mIdsInfoRecord = null;
    private int mPdpDisconnectExcpRecoverTimer = IDSConstants.ONE_MINUTE_TO_WAIT;
    private int mPdpSetupFailureRecoverTimer = IDSConstants.ONE_MINUTE_TO_WAIT;
    private Timer mSignalWeakTimer = null;
    private boolean mStayInForbiddenStateBeforeTimeUp = false;
    private DsmSwitchForbiddenState mSwitchForbiddenState = new DsmSwitchForbiddenState();
    private DsmSwitchOngoingState mSwitchOngoingState = new DsmSwitchOngoingState();
    private DsmSwitchTriggeredState mSwitchTriggeredState = new DsmSwitchTriggeredState();
    private Timer mVoiceCallBackGroundTimer = null;
    private boolean mVoiceCallUiGoBackGround = false;
    private int mWeakEcioForCdma = -15;
    private int mWeakPsrpForLte = IDSConstants.WEAK_LTE_SIGNAL_STRENGTH_VALUE;
    private int mWeakRscpForWandTD = -100;
    private int mWeakRsrqForLte = -15;
    private int mWeakRssiForCdma = -100;
    private int mWeakRssiForEvdo = -100;
    private int mWeakSignalStrengthForGsm = -100;
    private int mWeakSnrForEvdo = 1;
        ...
        public boolean processMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 17:
                    ...
                    IDSManager.this.startVoiceCallIntoBackGroundTimer(20000);
                    break;
                    break;
                default:
