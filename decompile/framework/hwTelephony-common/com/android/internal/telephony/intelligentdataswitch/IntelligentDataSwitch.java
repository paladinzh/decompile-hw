...
public class IntelligentDataSwitch {
    ...
    private DataState[] mApnState = new DataState[2];
    private Context mContext = null;
    private IDSManager mDataSwitchManager = null;
    private boolean[] mFristTimeReceApnState = new boolean[]{false, false};
    private Handler mIdsHandler = null;
