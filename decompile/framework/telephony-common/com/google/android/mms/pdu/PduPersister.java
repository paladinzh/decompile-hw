...
public class PduPersister {
    ...
    private void loadAddress(long msgId, PduHeaders headers, int loadType) {
        Cursor c;
        if (loadType == 1) {
            c = SqliteWrapper.query(this.mContext, this.mContentResolver, Uri.parse("content://fav-mms/" + msgId + "/addr"), new String[]{"address", Addr.CHARSET, "type"}, null, null, null);
        } else {
    ...
    public Uri persistPart(PduPart part, long msgId, HashMap<Uri, InputStream> preOpenedFiles) throws MmsException {
        ...
        if (charset != 0) {
            ...
            values.put(Part.CHARSET, Integer.valueOf(106));
        }
        ...
        if (existingUri || MESSAGE_BOX_MAP.get(uri) != null) {
            ...
            for (int addrType : ADDRESS_FIELDS) {
                if (addrType == 137) {
                    ...
                    array = (str == null || str.length() == 0) ? new EncodedStringValue[]{new EncodedStringValue(this.mContext.getString(33685717))} : new EncodedStringValue[]{v};
                } else {
            ...
            switch (msgType) {
                ...
                case 132:
                    ...
                    if (groupMmsEnabled && !(this.mHwCustPduPersister != null && this.mHwCustPduPersister.isShortCodeFeatureEnabled() && this.mHwCustPduPersister.hasShortCode((EncodedStringValue[]) addressMap.get(Integer.valueOf(151)), (EncodedStringValue[]) addressMap.get(Integer.valueOf(130))))) {
