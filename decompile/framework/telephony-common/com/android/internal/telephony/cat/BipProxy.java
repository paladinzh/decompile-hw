...
public class BipProxy extends Handler {
    ...
    private ServerChannel[] mServerChannels = new ServerChannel[3];
    ...
    class TcpClientChannel implements BipChannel {
        ...
        byte[] mRxBuf = new byte[BipProxy.TCP_CHANNEL_BUFFER_SIZE];
        int mRxLen = 0;
        int mRxPos = 0;
        TcpClientSendThread mSendThread = null;
        Socket mSocket;
        TcpClientThread mThread = null;
        byte[] mTxBuf = new byte[BipProxy.TCP_CHANNEL_BUFFER_SIZE];
        int mTxLen = 0;
        int mTxPos = 0;
    ...
    class TcpServerChannel implements BipChannel {
        ...
        int mRxLen = 0;
        int mRxPos = 0;
        TcpServerSendThread mSendThread = null;
        Socket mSocket;
        TcpServerThread mThread = null;
        byte[] mTxBuf = new byte[BipProxy.TCP_CHANNEL_BUFFER_SIZE];
        int mTxLen = 0;
        int mTxPos = 0;
        ResultCode result = ResultCode.OK;
        ...
        class TcpServerSendThread extends Thread {
            ...
            public void run() {
                ...
                for (int i = 0; i < dataSettings.data.length && TcpServerChannel.this.mTxPos < TcpServerChannel.this.mTxBuf.length; i++) {
                ...
                if (this.cmdMsg.getCommandQualifier() == 1) {
                    ...
                    try {
                        TcpServerChannel.this.mSocket.getOutputStream().write(TcpServerChannel.this.mTxBuf, 0, len);
                        CatLog.d((Object) this, "Data on channel no: " + dataSettings.channel + " sent to socket.");
                    } catch (IOException e) {
                        CatLog.d((Object) this, "IOException " + e.getMessage());
                        BipProxy.this.mStkService.sendTerminalResponse(this.cmdMsg.mCmdDet, ResultCode.BIP_ERROR, true, 0, new SendDataResponseData(0));
            ...
            public void run() {
                ...
                while (i < 3) {
                    try {
                        ...
                        if (BipProxy.this.mImmediateLinkEstablish) {
                            BipProxy.this.mStkService.sendTerminalResponse(TcpServerChannel.this.catCmdMsg.mCmdDet, ResultCode.BIP_ERROR, true, 0, new OpenChannelResponseData(TcpServerChannel.this.mChannelSettings.bufSize, Integer.valueOf(TcpServerChannel.this.mChannelStatus), TcpServerChannel.this.mChannelSettings.bearerDescription));
                        } else {
                            BipProxy.this.mImmediateLinkEstablish = true;
                        }
                        CatLog.d((Object) this, "IOException " + e.getMessage());
                ...
                TcpServerChannel.this.mChannelStatus = (TcpServerChannel.this.mChannelSettings.channel << 8) + BipProxy.TCP_CHANNEL_BUFFER_SIZE;
                if (BipProxy.this.mImmediateLinkEstablish) {
                    BipProxy.this.mStkService.sendTerminalResponse(TcpServerChannel.this.catCmdMsg.mCmdDet, TcpServerChannel.this.result, false, 0, new OpenChannelResponseData(TcpServerChannel.this.mChannelSettings.bufSize, Integer.valueOf(TcpServerChannel.this.mChannelStatus), TcpServerChannel.this.mChannelSettings.bearerDescription));
                } else {
                    BipProxy.this.mImmediateLinkEstablish = true;
                }
                if (TcpServerChannel.this.mSocket == null || TcpServerChannel.this.mSocket.isClosed()) {
                    ...
                    try {
                        ...
                        if (TcpServerChannel.this.mSocket.isConnected()) {
                            TcpServerChannel.this.mChannelStatus = (TcpServerChannel.this.mChannelSettings.channel << 8) + 32768;
                            BipProxy.this.sendChannelStatusEvent(TcpServerChannel.this.mChannelStatus);
                        }
