...
public class SmsMessage extends SmsMessageBase {
    ...
    private void parseUserData(PduParser p, boolean hasUserDataHeader) {
        ...
        } else if ((this.mDataCodingScheme & 240) == 192 || (this.mDataCodingScheme & 240) == BerTlv.BER_PROACTIVE_COMMAND_TAG || (this.mDataCodingScheme & 240) == 224) {
            ...
            for (SpecialSmsMsg msg : this.mUserDataHeader.specialSmsMsgList) {
                ...
                if (msgInd == 0 || msgInd == 128) {
                    ...
                    if (msgInd == 128) {
                        ...
                        if ((this.mDataCodingScheme & 240) == BerTlv.BER_PROACTIVE_COMMAND_TAG || (this.mDataCodingScheme & 240) == 224) {
                            if ((this.mDataCodingScheme & 3) != 0) {
                            }
                        }
