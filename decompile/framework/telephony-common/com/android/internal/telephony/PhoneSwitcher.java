...
public class PhoneSwitcher extends Handler {
    ...
    public PhoneSwitcher(int maxActivePhones, int numPhones, Context context, SubscriptionController subscriptionController, Looper looper, ITelephonyRegistry tr, CommandsInterface[] cis, Phone[] phones) {
        ...
        if (HwModemCapability.isCapabilitySupport(9)) {
            CallManager.getInstance().registerForDisconnect(this, EVENT_VOICE_CALL_ENDED, null);
        }
    ...
    public void handleMessage(Message msg) {
        switch (msg.what) {
            ...
            case 111:
                ...
                return;
            case EVENT_VOICE_CALL_ENDED /*112*/:
        ...
        if (HwModemCapability.isCapabilitySupport(9)) {
            if (ar.exception != null) {
                ...
                if (getConnectFailureCount(phoneId) >= 5) {
                    ...
                    sendMessageDelayed(obtainMessage(111, phoneId, 0, this.mPhones[phoneId]), 30000);
                }
            } else {
