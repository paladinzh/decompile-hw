                ...
                if (dc2 != null) {
                    if (dc2.mApnContexts.size() == 0) {
                        ...
                        if (newState.active == 0) {
                            ...
                            } else if ((result.oldLp.isIdenticalDnses(result.newLp) && result.oldLp.isIdenticalRoutes(result.newLp) && result.oldLp.isIdenticalHttpProxy(result.newLp) && result.oldLp.isIdenticalAddresses(result.newLp)) || (DcController.this.mPhone.getPhoneType() == 2 && isSupportRcnInd)) {
