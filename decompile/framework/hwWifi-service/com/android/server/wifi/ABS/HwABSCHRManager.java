...
public class HwABSCHRManager {
    ...
    private Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            if (msg.what == 1) {
                if (HwABSCHRManager.this.isNeedToUpload(HwABSCHRManager.this.mHwABSDataBaseManager.getCHRStatistics())) {
                    ...
                    HwABSCHRManager.this.mHwABSDataBaseManager.inlineUpdateCHRInfo(statistics);
                }
            }
        }
    };
    ...
    public synchronized HwABSCHRStatistics getStatisticsInfo() {
        return this.mHwABSDataBaseManager.getCHRStatistics();
    }

    public synchronized void updateCHRInfo(HwABSCHRStatistics statistics) {
        this.mHwABSDataBaseManager.inlineUpdateCHRInfo(statistics);
    }
    ...
    public synchronized void updateABSTime(String ssid, long mimoTime, long sisoTime, long mimoScreenOnTime, long sisoScreenOnTime) {
    ...
    public synchronized void updateCHRAssociateTimes(String ssid, int associateTimes, int associateFailedTimes) {
