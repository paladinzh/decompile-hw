...
public class WifiProUIDisplayManager {
    ...
    private AlertDialog createSwitchWifiToMobileWarning(boolean internet) {
        ...
        buider.setPositiveButton(33685559, new OnClickListener() {
            public void onClick(DialogInterface dialoginterface, int i) {
                ...
                WifiProUIDisplayManager.this.sendWifiProUICallBack(2);
            }
        });
        buider.setNegativeButton(33685560, new OnClickListener() {
            public void onClick(DialogInterface dialoginterface, int i) {
                ...
                WifiProUIDisplayManager.this.sendWifiProUICallBack(1);
            }
        });
    ...
    public void showNotificationAutoOpenWLAN() {
        ...
        String title = this.mContext.getResources().getString(33685882);
        String text = this.mContext.getResources().getString(33685883);
    ...
    public void showNotificationAutoDisableWLAN() {
        NotificationManager notificationManager = (NotificationManager) this.mContext.getSystemService("notification");
        String title = this.mContext.getResources().getString(33685884);
        String text = this.mContext.getResources().getString(33685885);
        Intent intent = new Intent();
        intent.setComponent(new ComponentName("com.android.settings", "com.android.settings.Settings$WifiSettingsActivity"));
        intent.setFlags(335544320);
        Notification.Builder builder = new Notification.Builder(this.mContext);
    ...
    public void showHMDNotification(int mobileDateSize, boolean isHeadsupDisplay) {
        ...
        remoteViews.setImageViewResource(34603142, 33751349);
        ...
        b.setSmallIcon(33751349);
        b.setVisibility(1);
        Bitmap icon = BitmapFactory.decodeResource(this.mContext.getResources(), 33751349);
        if (icon != null) {
            b.setLargeIcon(icon);
        }
    ...
    public void showPortalNotificationStatusBar(String ssid, String tag, int id) {
        ...
        b.setSmallIcon(getBitampIcon(33751323));
        b.setVisibility(1);
