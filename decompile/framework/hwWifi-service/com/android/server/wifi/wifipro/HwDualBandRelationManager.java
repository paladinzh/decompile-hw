                    ...
                    if (isHaveDuplicateRecord(result2, APInfo)) {
                        ...
                        if (RelateAPInfo == null) {
                            if (isDualBandAP(bssid, result2.BSSID)) {
                                isDualBandAP = 1;
                                WifiProStatisticsManager.getInstance().uploadWifiProDualbandApInfoEvent(1, bssid, result2.BSSID);
                            } else {
                                isDualBandAP = 2;
                                WifiProStatisticsManager.getInstance().uploadWifiProDualbandApInfoEvent(2, bssid, result2.BSSID);
                            }
