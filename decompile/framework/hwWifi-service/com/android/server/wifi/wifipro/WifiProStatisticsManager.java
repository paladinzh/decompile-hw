...
public class WifiProStatisticsManager {
    ...
    private HwWifiCHRStateManagerImpl mHwWifiCHRManagerImpl = null;
    ...
    private boolean uploadStatisticsCHREvent(WifiProStatisticsRecord statRecord) {
        ...
        if (statRecord == null || this.mDataBaseManager == null || this.mSimpleDateFmt == null || this.mWiFiCHRMgr == null) {
            ...
            if (enableTotTime == 0 && statRecord.mWifiOobInitState == (short) 0) {
                ...
                this.mWiFiCHRMgr.updateWifiException(121, "NO_SUB_EVENT");
            }
    ...
    public void increaseDualbandStatisticCount(int type) {
        if (checkInitOk()) {
            ...
            sendStatMsg(STAT_MSG_INCREASE_DUALBAND_STATISTIC_COUNT, type, 0);
        }
    }
    ...
    public void uploadWifiProDualbandExceptionEvent(String dualbandSubExEvent, WifiProDualbandExceptionRecord rec) {
        if (!(dualbandSubExEvent == null || this.mHwWifiCHRManagerImpl == null)) {
            ...
            this.mHwWifiCHRManagerImpl.updateWifiExceptionByWifipro(125, dualbandSubExEvent);
        }
    }
    ...
    public void uploadWifiProDualbandApInfoEvent(int dualbandApType, String bssid2G, String bssid5G) {
        if (this.mHwWifiCHRManagerImpl != null) {
            ...
            this.mHwWifiCHRManagerImpl.updateWifiExceptionByWifipro(126, "");
        }
    }
    ...
    private void updateBqeSvcChrProcess(int bqeSvcChrType) {
        ...
        switch (bqeSvcChrType) {
            ...
            case 4:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mBSG_EndIn4sCnt = (short) (wifiProStatisticsRecord.mBSG_EndIn4sCnt + 1);
                return;
            case 5:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mBSG_EndIn4s7sCnt = (short) (wifiProStatisticsRecord.mBSG_EndIn4s7sCnt + 1);
                return;
            case 6:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mBSG_NotEndIn7sCnt = (short) (wifiProStatisticsRecord.mBSG_NotEndIn7sCnt + 1);
                return;
            case 7:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mBQE_CNUrl1FailCount = (short) (wifiProStatisticsRecord.mBQE_CNUrl1FailCount + 1);
                return;
            case 8:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mBQE_CNUrl2FailCount = (short) (wifiProStatisticsRecord.mBQE_CNUrl2FailCount + 1);
                return;
            case 9:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mBQE_CNUrl3FailCount = (short) (wifiProStatisticsRecord.mBQE_CNUrl3FailCount + 1);
                return;
            case 10:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mBQE_NCNUrl1FailCount = (short) (wifiProStatisticsRecord.mBQE_NCNUrl1FailCount + 1);
                return;
            case 11:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mBQE_NCNUrl2FailCount = (short) (wifiProStatisticsRecord.mBQE_NCNUrl2FailCount + 1);
                return;
            case 12:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mBQE_NCNUrl3FailCount = (short) (wifiProStatisticsRecord.mBQE_NCNUrl3FailCount + 1);
                return;
            case 13:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mBQE_ScoreUnknownCount = (short) (wifiProStatisticsRecord.mBQE_ScoreUnknownCount + 1);
                return;
            case 14:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mBQE_BindWlanFailCount = (short) (wifiProStatisticsRecord.mBQE_BindWlanFailCount + 1);
                return;
            case 15:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mBQE_StopBqeFailCount = (short) (wifiProStatisticsRecord.mBQE_StopBqeFailCount + 1);
                return;
            default:
    ...
    private void increaseDualbandStatisticCountProcess(int type) {
        ...
        switch (type) {
            case 1:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mSingleAP_LearnedCount = (short) (wifiProStatisticsRecord.mSingleAP_LearnedCount + 1);
                return;
            case 2:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mSingleAP_NearbyCount = (short) (wifiProStatisticsRecord.mSingleAP_NearbyCount + 1);
                return;
            case 3:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mSingleAP_MonitorCount = (short) (wifiProStatisticsRecord.mSingleAP_MonitorCount + 1);
                return;
            case 4:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mSingleAP_SatisfiedCount = (short) (wifiProStatisticsRecord.mSingleAP_SatisfiedCount + 1);
                return;
            case 5:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mSingleAP_DisapperCount = (short) (wifiProStatisticsRecord.mSingleAP_DisapperCount + 1);
                return;
            case 6:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mSingleAP_InblacklistCount = (short) (wifiProStatisticsRecord.mSingleAP_InblacklistCount + 1);
                return;
            case 7:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mSingleAP_ScoreNotSatisfyCount = (short) (wifiProStatisticsRecord.mSingleAP_ScoreNotSatisfyCount + 1);
                return;
            case 8:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mSingleAP_HandoverSucCount = (short) (wifiProStatisticsRecord.mSingleAP_HandoverSucCount + 1);
                return;
            case 9:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mSingleAP_HandoverFailCount = (short) (wifiProStatisticsRecord.mSingleAP_HandoverFailCount + 1);
                return;
            case 10:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mSingleAP_LowFreqScan5GCount = (short) (wifiProStatisticsRecord.mSingleAP_LowFreqScan5GCount + 1);
                return;
            case 11:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mSingleAP_MidFreqScan5GCount = (short) (wifiProStatisticsRecord.mSingleAP_MidFreqScan5GCount + 1);
                return;
            case 12:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mSingleAP_HighFreqScan5GCount = (short) (wifiProStatisticsRecord.mSingleAP_HighFreqScan5GCount + 1);
                return;
            case 13:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mMixedAP_LearnedCount = (short) (wifiProStatisticsRecord.mMixedAP_LearnedCount + 1);
                return;
            case 14:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mMixedAP_NearbyCount = (short) (wifiProStatisticsRecord.mMixedAP_NearbyCount + 1);
                return;
            case 15:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mMixedAP_MonitorCount = (short) (wifiProStatisticsRecord.mMixedAP_MonitorCount + 1);
                return;
            case 16:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mMixedAP_SatisfiedCount = (short) (wifiProStatisticsRecord.mMixedAP_SatisfiedCount + 1);
                return;
            case 17:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mMixedAP_DisapperCount = (short) (wifiProStatisticsRecord.mMixedAP_DisapperCount + 1);
                return;
            case 18:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mMixedAP_InblacklistCount = (short) (wifiProStatisticsRecord.mMixedAP_InblacklistCount + 1);
                return;
            case 19:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mMixedAP_ScoreNotSatisfyCount = (short) (wifiProStatisticsRecord.mMixedAP_ScoreNotSatisfyCount + 1);
                return;
            case 20:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mMixedAP_HandoverSucCount = (short) (wifiProStatisticsRecord.mMixedAP_HandoverSucCount + 1);
                return;
            case 21:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mMixedAP_HandoverFailCount = (short) (wifiProStatisticsRecord.mMixedAP_HandoverFailCount + 1);
                return;
            case 22:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mMixedAP_LowFreqScan5GCount = (short) (wifiProStatisticsRecord.mMixedAP_LowFreqScan5GCount + 1);
                return;
            case 23:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mMixedAP_MidFreqScan5GCount = (short) (wifiProStatisticsRecord.mMixedAP_MidFreqScan5GCount + 1);
                return;
            case 24:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mMixedAP_HighFreqScan5GCount = (short) (wifiProStatisticsRecord.mMixedAP_HighFreqScan5GCount + 1);
                return;
            case 25:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mCustomizedScan_SuccCount = (short) (wifiProStatisticsRecord.mCustomizedScan_SuccCount + 1);
                return;
            case 26:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mCustomizedScan_FailCount = (short) (wifiProStatisticsRecord.mCustomizedScan_FailCount + 1);
                return;
            case 27:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mHandoverToNotInet5GCount = (short) (wifiProStatisticsRecord.mHandoverToNotInet5GCount + 1);
                return;
            case DUALBAND_HANDOVER_TOO_SLOW_COUNT /*28*/:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mHandoverTooSlowCount = (short) (wifiProStatisticsRecord.mHandoverTooSlowCount + 1);
                return;
            case DUALBAND_TO_BAD_5G_COUNT /*29*/:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mHandoverToBad5GCount = (short) (wifiProStatisticsRecord.mHandoverToBad5GCount + 1);
                return;
            case 30:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mUserRejectHandoverCount = (short) (wifiProStatisticsRecord.mUserRejectHandoverCount + 1);
                return;
            case DUALBAND_HANDOVER_PINGPONG_COUNT /*31*/:
                wifiProStatisticsRecord = this.mNewestStatRcd;
                wifiProStatisticsRecord.mHandoverPingpongCount = (short) (wifiProStatisticsRecord.mHandoverPingpongCount + 1);
                return;
            default:
