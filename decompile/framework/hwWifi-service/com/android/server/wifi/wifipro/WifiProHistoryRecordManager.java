...
public class WifiProHistoryRecordManager implements IGetApRecordCount {
    ...
    private static final HomeApSwitchRate[] HOME_AP_SWITCH_RATE_TABLE = new HomeApSwitchRate[]{new HomeApSwitchRate(10, 0.5f, HOME_AP_LEVEL_ONE_SWITCH_RATE), new HomeApSwitchRate(20, 0.5f, HOME_AP_LEVEL_TWO_SWITCH_RATE), new HomeApSwitchRate(50, 0.5f, 0.5f), new HomeApSwitchRate(100, HOME_AP_LEVEL_TWO_SWITCH_RATE, HOME_AP_LEVEL_FOUR_SWITCH_RATE), new HomeApSwitchRate(200, HOME_AP_LEVEL_TWO_SWITCH_RATE, HOME_AP_LEVEL_FIVE_SWITCH_RATE)};
