...
public class MobileQosDetector implements IGetMobileInfoCallBack {
    ...
    private double[][] mIPQWeight = new double[][]{new double[]{0.0d, 0.0d, 0.0d, 0.0d, 0.0d, 0.0d}, new double[]{0.0d, TrafficMonitor.LOW_RX_TX_RATIO, HwCHRWifiSpeedBaseChecker.RCV_SND_RATE, HwCHRWifiSpeedBaseChecker.RCV_SND_RATE, TrafficMonitor.LOW_RX_TX_RATIO, 0.0d}, new double[]{0.0d, TrafficMonitor.LOW_RX_TX_RATIO, HwCHRWifiSpeedBaseChecker.RCV_SND_RATE, HwCHRWifiSpeedBaseChecker.RCV_SND_RATE, TrafficMonitor.LOW_RX_TX_RATIO, 0.0d}, new double[]{0.0d, TrafficMonitor.LOW_RX_TX_RATIO, HwCHRWifiSpeedBaseChecker.RCV_SND_RATE, HwCHRWifiSpeedBaseChecker.RCV_SND_RATE, TrafficMonitor.LOW_RX_TX_RATIO, 0.0d}, new double[]{0.0d, TrafficMonitor.LOW_RX_TX_RATIO, HwCHRWifiSpeedBaseChecker.RCV_SND_RATE, HwCHRWifiSpeedBaseChecker.RCV_SND_RATE, TrafficMonitor.LOW_RX_TX_RATIO, 0.0d}, new double[]{0.0d, TrafficMonitor.LOW_RX_TX_RATIO, HwCHRWifiSpeedBaseChecker.RCV_SND_RATE, HwCHRWifiSpeedBaseChecker.RCV_SND_RATE, TrafficMonitor.LOW_RX_TX_RATIO, 0.0d}};
    ...
    private double[] mRAT2G_Weight = new double[]{0.0d, HwCHRWifiSpeedBaseChecker.RCV_SND_RATE, HwCHRWifiSpeedBaseChecker.RCV_SND_RATE, HwCHRWifiSpeedBaseChecker.RCV_SND_RATE, HwCHRWifiSpeedBaseChecker.RCV_SND_RATE, HwCHRWifiSpeedBaseChecker.RCV_SND_RATE};
    private double[] mRAT3G_EVDOA_Weight = new double[]{0.0d, HwCHRWifiSpeedBaseChecker.RCV_SND_RATE, HwCHRWifiSpeedBaseChecker.RCV_SND_RATE, HwCHRWifiSpeedBaseChecker.RCV_SND_RATE, HwCHRWifiSpeedBaseChecker.RCV_SND_RATE, HwCHRWifiSpeedBaseChecker.RCV_SND_RATE};
    private double[] mRAT3G_EVDOB_Weight = new double[]{0.0d, HwCHRWifiSpeedBaseChecker.RCV_SND_RATE, HwCHRWifiSpeedBaseChecker.RCV_SND_RATE, 0.6d, 0.6d, 0.6d};
    private double[] mRAT3G_TDS_Weight = new double[]{0.0d, HwCHRWifiSpeedBaseChecker.RCV_SND_RATE, HwCHRWifiSpeedBaseChecker.RCV_SND_RATE, 0.6d, 0.6d, 0.6d};
    ...
    private double[][] mRTTWeight = new double[][]{new double[]{0.0d, 0.0d, 0.0d, 0.0d, 0.0d, 0.0d}, new double[]{0.0d, 0.7d, 0.7d, TrafficMonitor.LOW_RX_TX_RATIO, TrafficMonitor.LOW_RX_TX_RATIO, TrafficMonitor.LOW_RX_TX_RATIO}, new double[]{0.0d, 0.7d, 0.7d, TrafficMonitor.LOW_RX_TX_RATIO, TrafficMonitor.LOW_RX_TX_RATIO, TrafficMonitor.LOW_RX_TX_RATIO}, new double[]{0.0d, 0.7d, 0.7d, TrafficMonitor.LOW_RX_TX_RATIO, TrafficMonitor.LOW_RX_TX_RATIO, TrafficMonitor.LOW_RX_TX_RATIO}, new double[]{0.0d, 0.7d, 0.7d, TrafficMonitor.LOW_RX_TX_RATIO, TrafficMonitor.LOW_RX_TX_RATIO, TrafficMonitor.LOW_RX_TX_RATIO}, new double[]{0.0d, 0.7d, 0.7d, TrafficMonitor.LOW_RX_TX_RATIO, TrafficMonitor.LOW_RX_TX_RATIO, TrafficMonitor.LOW_RX_TX_RATIO}};
                ...
                case MobileQosDetector.MSG_QUERY_TCP_INFO /*107*/:
                    ...
                    if (conntype == 0) {
                        if (MobileQosDetector.this.mHandler.hasMessages(MobileQosDetector.MSG_QUERY_TCP_INFO)) {
                            ...
                            MobileQosDetector.this.mHandler.sendMessageDelayed(MobileQosDetector.this.mHandler.obtainMessage(MobileQosDetector.MSG_QUERY_TCP_INFO, 0, msg.arg2 + 1), 10000);
                        }
    ...
    private void reportQos(int report_type, int qos_level) {
        ...
        if (report_type == 0) {
            ...
            this.mCallback.onNetworkQosChange(0, qos_level);
        }
    ...
    private void composeQOSLevel(int signal_level, int report_type) {
        ...
        if (!this.mMobileDataSwitch) {
            ...
            if (sim_ready) {
                ...
                if (this.mHisSimStatus[this.mCurrDataSubID] == 5) {
                }
            }
        } else if (conntype != 0) {
            qos_Level = 0;
