...
public class HwDualBandQualityEngine {
    ...
    private static final LossRateScore[] LOSE_RATE_SCORE_TABLE = new LossRateScore[]{new LossRateScore(HwCHRWifiSpeedBaseChecker.D_ACKS_RATE, 15), new LossRateScore(0.1d, 10), new LossRateScore(0.2d, 5), new LossRateScore(0.4d, 0), new LossRateScore(0.6d, -5), new LossRateScore(TrafficMonitor.LOW_RX_TX_RATIO, -10)};
    ...
    private static final RttScore[] RTT_SCORE_TABLE = new RttScore[]{new RttScore(HwCHRWifiSpeedBaseChecker.RTT_THRESHOLD_400, 15), new RttScore(800, 10), new RttScore(WifiproBqeUtils.BQE_GOOD_RTT, 5), new RttScore(2000, 0), new RttScore(4000, -5), new RttScore(16000, -10)};
