...
public class WifiProChrDataBaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        sBuffer.append("[mSingleAP_LearnedCount] SMALLINT,");
        sBuffer.append("[mSingleAP_NearbyCount] SMALLINT,");
        sBuffer.append("[mSingleAP_MonitorCount] SMALLINT,");
        sBuffer.append("[mSingleAP_SatisfiedCount] SMALLINT,");
        sBuffer.append("[mSingleAP_DisapperCount] SMALLINT,");
        sBuffer.append("[mSingleAP_InblacklistCount] SMALLINT,");
        sBuffer.append("[mSingleAP_ScoreNotSatisfyCount] SMALLINT,");
        sBuffer.append("[mSingleAP_HandoverSucCount] SMALLINT,");
        sBuffer.append("[mSingleAP_HandoverFailCount] SMALLINT,");
        sBuffer.append("[mSingleAP_LowFreqScan5GCount] SMALLINT,");
        sBuffer.append("[mSingleAP_MidFreqScan5GCount] SMALLINT,");
        sBuffer.append("[mSingleAP_HighFreqScan5GCount] SMALLINT,");
        sBuffer.append("[mMixedAP_LearnedCount] SMALLINT,");
        sBuffer.append("[mMixedAP_NearbyCount] SMALLINT,");
        sBuffer.append("[mMixedAP_MonitorCount] SMALLINT,");
        sBuffer.append("[mMixedAP_SatisfiedCount] SMALLINT,");
        sBuffer.append("[mMixedAP_DisapperCount] SMALLINT,");
        sBuffer.append("[mMixedAP_InblacklistCount] SMALLINT,");
        sBuffer.append("[mMixedAP_ScoreNotSatisfyCount] SMALLINT,");
        sBuffer.append("[mMixedAP_HandoverSucCount] SMALLINT,");
        sBuffer.append("[mMixedAP_HandoverFailCount] SMALLINT,");
        sBuffer.append("[mMixedAP_LowFreqScan5GCount] SMALLINT,");
        sBuffer.append("[mMixedAP_MidFreqScan5GCount] SMALLINT,");
        sBuffer.append("[mMixedAP_HighFreqScan5GCount] SMALLINT,");
        sBuffer.append("[mCustomizedScan_SuccCount] SMALLINT,");
        sBuffer.append("[mCustomizedScan_FailCount] SMALLINT,");
        sBuffer.append("[mHandoverToNotInet5GCount] SMALLINT,");
        sBuffer.append("[mHandoverTooSlowCount] SMALLINT,");
        sBuffer.append("[mHandoverToBad5GCount] SMALLINT,");
        sBuffer.append("[mUserRejectHandoverCount] SMALLINT,");
        sBuffer.append("[mHandoverPingpongCount] SMALLINT)");
