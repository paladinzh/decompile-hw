...
public class WifiProStatisticsRecord {
    ...
    public void dumpAllChrStatRecord() {
        Log.i(TAG, "dumpChrStatRecord:, mLastStatUploadTime= " + this.mLastStatUploadTime + ", mLastWifiproState= " + this.mLastWifiproState + ", mLastWifiproStateUpdateTime= " + this.mLastWifiproStateUpdateTime + ", mEnableTotTime= " + this.mEnableTotTime + ", mNoInetHandoverCount= " + this.mNoInetHandoverCount + ", mPortalUnauthCount= " + this.mPortalUnauthCount + ", mWifiScoCount= " + this.mWifiScoCount + ", mPortalCodeParseCount= " + this.mPortalCodeParseCount + ", mRcvSMS_Count= " + this.mRcvSMS_Count + ", mPortalAutoLoginCount= " + this.mPortalAutoLoginCount + ", mCellAutoOpenCount= " + this.mCellAutoOpenCount + ", mCellAutoCloseCount= " + this.mCellAutoCloseCount + ", mTotalBQE_BadROC= " + this.mTotalBQE_BadROC + ", mManualBackROC= " + this.mManualBackROC + ", mRSSI_RO_Tot= " + this.mRSSI_RO_Tot + ", mRSSI_ErrRO_Tot= " + this.mRSSI_ErrRO_Tot + ", mOTA_RO_Tot= " + this.mOTA_RO_Tot + ", mOTA_ErrRO_Tot= " + this.mOTA_ErrRO_Tot + ", mTCP_RO_Tot= " + this.mTCP_RO_Tot + ", mTCP_ErrRO_Tot= " + this.mTCP_ErrRO_Tot + ", mManualRI_TotTime= " + this.mManualRI_TotTime + ", mAutoRI_TotTime= " + this.mAutoRI_TotTime + ", mAutoRI_TotCount= " + this.mAutoRI_TotCount + ", mRSSI_RestoreRI_Count= " + this.mRSSI_RestoreRI_Count + ", mRSSI_BetterRI_Count= " + this.mRSSI_BetterRI_Count + ", mTimerRI_Count= " + this.mTimerRI_Count + ", mHisScoRI_Count= " + this.mHisScoRI_Count + ", mUserCancelROC= " + this.mUserCancelROC);
        Log.i(TAG, ", mWifiToWifiSuccCount= " + this.mWifiToWifiSuccCount + ", mNoInetAlarmCount= " + this.mNoInetAlarmCount + ", mWifiOobInitState= " + this.mWifiOobInitState + ", mNotAutoConnPortalCnt= " + this.mNotAutoConnPortalCnt + ", mHighDataRateStopROC= " + this.mHighDataRateStopROC + ", mSelectNotInetAPCount= " + this.mSelectNotInetAPCount + ", mUserUseBgScanAPCount= " + this.mUserUseBgScanAPCount + ", mPingPongCount= " + this.mPingPongCount + ", mBQE_BadSettingCancel = " + this.mBQE_BadSettingCancel + ", mNotInetSettingCancel = " + this.mNotInetSettingCancel + ", mNotInetUserCancel = " + this.mNotInetUserCancel + ", mNotInetRestoreRI = " + this.mNotInetRestoreRI + ", mNotInetUserManualRI = " + this.mNotInetUserManualRI);
        Log.i(TAG, "new 2.0 para  mNotInetWifiToWifiCount = " + this.mNotInetWifiToWifiCount + ", mReopenWifiRICount = " + this.mReopenWifiRICount + ", mSelCSPShowDiglogCount = " + this.mSelCSPShowDiglogCount + ", mSelCSPAutoSwCount = " + this.mSelCSPAutoSwCount + ", mSelCSPNotSwCount = " + this.mSelCSPNotSwCount + ", mTotBtnRICount = " + this.mTotBtnRICount + ", mBMD_TenMNotifyCount = " + this.mBMD_TenMNotifyCount + ", mBMD_TenM_RI_Count = " + this.mBMD_TenM_RI_Count + ", mBMD_FiftyMNotifyCount = " + this.mBMD_FiftyMNotifyCount + ", mBMD_FiftyM_RI_Count = " + this.mBMD_FiftyM_RI_Count + ", mBMD_UserDelNotifyCount = " + this.mBMD_UserDelNotifyCount + ", mRO_TotMobileData = " + this.mRO_TotMobileData + ", mAF_PhoneNumSuccCnt = " + this.mAF_PhoneNumSuccCnt + ", mAF_PhoneNumFailCnt = " + this.mAF_PhoneNumFailCnt + ", mAF_PasswordSuccCnt = " + this.mAF_PasswordSuccCnt + ", mAF_PasswordFailCnt = " + this.mAF_PasswordFailCnt + ", mAF_AutoLoginSuccCnt = " + this.mAF_AutoLoginSuccCnt + ", mAF_AutoLoginFailCnt = " + this.mAF_AutoLoginFailCnt);
        Log.i(TAG, "new 2.0 BG para  mBG_BgRunCnt = " + this.mBG_BgRunCnt + ", mBG_SettingRunCnt = " + this.mBG_SettingRunCnt + ", mBG_FreeInetOkApCnt = " + this.mBG_FreeInetOkApCnt + ", mBG_FishingApCnt = " + this.mBG_FishingApCnt + ", mBG_FreeNotInetApCnt = " + this.mBG_FreeNotInetApCnt + ", mBG_PortalApCnt = " + this.mBG_PortalApCnt + ", mBG_FailedCnt = " + this.mBG_FailedCnt + ", mBG_InetNotOkActiveOk = " + this.mBG_InetNotOkActiveOk + ", mBG_InetOkActiveNotOk = " + this.mBG_InetOkActiveNotOk + ", mBG_UserSelApFishingCnt = " + this.mBG_UserSelApFishingCnt + ", mBG_ConntTimeoutCnt = " + this.mBG_ConntTimeoutCnt + ", mBG_DNSFailCnt = " + this.mBG_DNSFailCnt + ", mBG_DHCPFailCnt = " + this.mBG_DHCPFailCnt + ", mBG_AUTH_FailCnt = " + this.mBG_AUTH_FailCnt + ", mBG_AssocRejectCnt = " + this.mBG_AssocRejectCnt);
        Log.i(TAG, "new 2.0 BG para mBG_UserSelFreeInetOkCnt = " + this.mBG_UserSelFreeInetOkCnt + ", mBG_UserSelNoInetCnt = " + this.mBG_UserSelNoInetCnt + ", mBG_UserSelPortalCnt = " + this.mBG_UserSelPortalCnt + ", mBG_FoundTwoMoreApCnt = " + this.mBG_FoundTwoMoreApCnt + ", mAF_FPNSuccNotMsmCnt = " + this.mAF_FPNSuccNotMsmCnt + ", mBSG_RsGoodCnt = " + this.mBSG_RsGoodCnt + ", mBSG_RsMidCnt = " + this.mBSG_RsMidCnt + ", mBSG_RsBadCnt = " + this.mBSG_RsBadCnt + ", mBSG_EndIn4sCnt = " + this.mBSG_EndIn4sCnt + ", mBSG_EndIn4s7sCnt = " + this.mBSG_EndIn4s7sCnt + ", mBSG_NotEndIn7sCnt = " + this.mBSG_NotEndIn7sCnt);
    }
}
