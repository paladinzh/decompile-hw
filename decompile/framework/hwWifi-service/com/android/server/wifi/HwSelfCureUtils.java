...
public class HwSelfCureUtils {
    ...
    public static final int SCE_WIFI_STATUS_FAIL = 0;
    public static final int SCE_WIFI_STATUS_SUCC = 1;
    public static final int SCE_WIFI_STATUS_UNKOWN = 2;
                ...
                if (nextResult.level >= -75) {
                    ...
                    while (j < savedNetworks.size()) {
                        ...
                        if (nextConfig.SSID != null && nextConfig.SSID.equals(scanSsid) && WifiProCommonUtils.isSameEncryptType(scanResultEncrypt, nextConfig.configKey())) {
                            ...
                            if (!(status.isNetworkEnabled() || disableReason < 1 || disableReason > 9 || disableReason == 6 || disableReason == 7)) {
