...
import com.huawei.device.connectivitychrlog.CSegEVENT_WIFI_ABS_ASSOC_FAILED_EVENT;
import com.huawei.device.connectivitychrlog.CSegEVENT_WIFI_ABS_STATISTICS_EVENT;
...
public class HwWifiCHRStateManagerImpl extends HwWifiCHRStateManager {
    ...
    private static HwWifiCHRStateManager wsm = new HwWifiCHRStateManagerImpl();
    ...
    private int mABSReassFaileReason;
...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find block by offset: 0x0019 in list [B:6:0x0014]
...
*/
        ...
        r6 = this;
        r0 = 0;
        r2 = r6.mLock;	 Catch:{ InterruptedException -> 0x001a, all -> 0x0041 }
        r4 = 1;	 Catch:{ InterruptedException -> 0x001a, all -> 0x0041 }
        r3 = java.util.concurrent.TimeUnit.SECONDS;	 Catch:{ InterruptedException -> 0x001a, all -> 0x0041 }
        r0 = r2.tryLock(r4, r3);	 Catch:{ InterruptedException -> 0x001a, all -> 0x0041 }
        if (r0 == 0) goto L_0x0012;	 Catch:{ InterruptedException -> 0x001a, all -> 0x0041 }
    L_0x000d:
        r2 = r6.mHwCHRAccessNetworkEventInfoList;	 Catch:{ InterruptedException -> 0x001a, all -> 0x0041 }
        r2.clear();	 Catch:{ InterruptedException -> 0x001a, all -> 0x0041 }
    L_0x0012:
    ...
    L_0x001a:
        r1 = move-exception;
        r2 = HWFLOW;	 Catch:{ InterruptedException -> 0x001a, all -> 0x0041 }
        if (r2 == 0) goto L_0x0039;	 Catch:{ InterruptedException -> 0x001a, all -> 0x0041 }
    L_0x001f:
        r2 = "HwWifiCHRStateManager";	 Catch:{ InterruptedException -> 0x001a, all -> 0x0041 }
        r3 = new java.lang.StringBuilder;	 Catch:{ InterruptedException -> 0x001a, all -> 0x0041 }
        r3.<init>();	 Catch:{ InterruptedException -> 0x001a, all -> 0x0041 }
        r4 = "clearHwCHRAccessNetworkEventInfoList";	 Catch:{ InterruptedException -> 0x001a, all -> 0x0041 }
        r3 = r3.append(r4);	 Catch:{ InterruptedException -> 0x001a, all -> 0x0041 }
        r3 = r3.append(r1);	 Catch:{ InterruptedException -> 0x001a, all -> 0x0041 }
        r3 = r3.toString();	 Catch:{ InterruptedException -> 0x001a, all -> 0x0041 }
        android.util.Log.d(r2, r3);	 Catch:{ InterruptedException -> 0x001a, all -> 0x0041 }
    L_0x0039:
        if (r0 == 0) goto L_0x0019;
    L_0x003b:
        r2 = r6.mLock;
...
*/
    ...
    private HwWifiCHRStateManagerImpl() {
        ...
        this.mOpenCloseFailCount = 0;
        this.mApkChangedCount = 0;
        this.mAuthFailCount = 0;
        this.mDhcpFailCount = 0;
        this.mScanFailCount = 0;
        this.mAccessFailCount = 0;
        this.mAssocFailCount = 0;
        this.mDisconnTotalCount = 0;
        this.mWorkaroundCount = 0;
        this.mDisconnectFail = new int[6];
        this.mAuthSubCode = 0;
        this.mLastNetIdFromUI = -1;
        this.mWorkaroundCode = (short) 0;
        this.mWorkaroundRet = (short) 0;
        this.mWorkaroundStatus = (short) 0;
        this.mWorkaroundRemark = "";
        this.mWifiConnentEventCount = 0;
        ...
        this.mSsid_Len = 0;
        this.mHTML_Input_Number = 0;
        this.mNotOpenApRedirectUrl = "";
        this.mApRedirectUrlSendCount = false;
        this.mAC_FailType = 0;
        this.mStatIntervalTime = 0;
        ...
        this.mAccessWebSlowCount = 0;
        this.strSpeedInfo = "";
        this.strUIDSpeedInfo = "";
        this.mMultiGWCount = 0;
        this.mUploadAccessWebSlowly = 0;
        this.mUploadAccessWebSlowlySSID = 0;
        this.mCounter_monitor = HwCHRWifiLinkMonitor.getDefault();
        this.mRssiGroup = new HwCHRWifiRSSIGroupSummery();
        this.mCountryCode = "";
        this.mIpType = 0;
        this.accessSlowlyerrrCode = 0;
        this.mFailReason = 0;
        this.mAPSecurity = -1;
        this.mHomeAPJudgeTime = 0;
        this.mBG_AC_DiffType = 0;
        this.mAWS = null;
        this.mUploadAccessWebFailedCount = 0;
        this.mLastAccessWebFailedTime = 0;
        this.mRssi2gMaxRssi = -127;
        this.mRssi2gMinRssi = 0;
        this.mRssi2gSum = new int[5];
        this.mRssi2gCnt = new int[5];
        this.mpoorRssi2gCnt = 0;
        this.mRssi5gMaxRssi = -127;
        this.mRssi5gMinRssi = 0;
        this.mRssi5gSum = new int[5];
        this.mRssi5gCnt = new int[5];
        this.mpoorRssi5gCnt = 0;
        this.mNetworkId = -1;
        ...
        this.mDeltaTime = 0;
        this.mNeedEnableNetworkId = -1;
        this.mEssCount = 0;
        this.mRssiSum = 0;
        this.mRssiCnt = 0;
        this.mLastApkName = "";
        this.mUserAction = "";
        this.mApkTriggerTimes = 0;
        this.mApkAction = 0;
        this.wifiAntsStatus = new WifiAntsStatus();
        this.mWifiAntsPrevSWCnt = 0;
        this.mDualAntsChr = false;
        this.mHwLogUtils = null;
        this.mIsPortalConnection = 0;
        this.mPortalStatus = 0;
        this.mCurrentApSecurity = -1;
        ...
        this.mTriggerReportType = 0;
        this.mABSReassFaileReason = -1;
    ...
    public void updateConnectThreadName(String ConnectThreadName) {
        ...
        reportHwCHRAccessNetworkEventInfoList(6);
        ...
        if (!isWifiProEvaluate()) {
            ...
            try {
                ...
                if (z) {
                    ...
                    if (1 == ReportReason) {
                        if (this.mHwCHRAccessNetworkEventInfoList.size() > 0 && !this.mCurrentApBssid.equals(((HwCHRAccessNetworkEventInfo) this.mHwCHRAccessNetworkEventInfoList.get(0)).getAP_MAC())) {
                            if (this.mHwWifiStatStore != null) {
    ...
    public HwCHRAccessNetworkEventInfo constructHwCHRAccessNetworkEventInfo(int ucErrorCode, String ucSubErrorCode) {
        ...
        byte essCount = (byte) (getRelatedApInfo(this.strAp_mac) >> 16);
    ...
    public void updateSignalLevel(int rssi, int freq, int level) {
        ...
        if (is2G(freq)) {
            ...
            this.mpoorRssi2gCnt = level == 4 ? 0 : this.mpoorRssi2gCnt + 1;
            ...
            iArr[level] = iArr[level] + 1;
            this.mpoorRssi5gCnt = level == 4 ? 0 : this.mpoorRssi5gCnt + 1;
        ...
        int rssi2gCnt = (((this.mRssi2gCnt[0] + this.mRssi2gCnt[1]) + this.mRssi2gCnt[2]) + this.mRssi2gCnt[3]) + this.mRssi2gCnt[4];
        int rssi5gCnt = (((this.mRssi5gCnt[0] + this.mRssi5gCnt[1]) + this.mRssi5gCnt[2]) + this.mRssi5gCnt[3]) + this.mRssi5gCnt[4];
        this.mRssiCnt = rssi2gCnt + rssi5gCnt;
        if (rssi2gCnt + rssi5gCnt == 0) {
            Log.d(TAG, "poor rssi count error.");
        } else if (rssi5gCnt != 0 && (this.mpoorRssi5gCnt > POOR_RSSI_TRIGGER_TIME_THRESHOLD || (rssi5gCnt > POOR_RSSI_TRIGGER_TIME_THRESHOLD && (this.mRssi5gCnt[4] * 100) / rssi5gCnt < 5))) {
            writeNETInfo(103, "");
            clearWifiPoorLevel();
        } else if (rssi2gCnt != 0 && (this.mpoorRssi2gCnt > POOR_RSSI_TRIGGER_TIME_THRESHOLD || (rssi2gCnt > POOR_RSSI_TRIGGER_TIME_THRESHOLD && (this.mRssi2gCnt[4] * 100) / rssi2gCnt < 5))) {
            writeNETInfo(103, "");
            clearWifiPoorLevel();
        } else if (this.mpoorRssi2gCnt + this.mpoorRssi5gCnt > POOR_RSSI_TRIGGER_TIME_THRESHOLD || (rssi2gCnt + rssi5gCnt > POOR_RSSI_TRIGGER_TIME_THRESHOLD && ((this.mRssi2gCnt[4] + this.mRssi5gCnt[4]) * 100) / (rssi2gCnt + rssi5gCnt) < 5)) {
            writeNETInfo(103, "");
            clearWifiPoorLevel();
        }
    }
    ...
    private CSubApRoaming getApRoaming(String ssid, String bssid) {
        ...
        } else if (this.mCurrentApSecurity == -1) {
            return ApRoaming;
        }
        synchronized (this.mScanResultLock) {
            try {
    ...
    private boolean isWifiProEvaluate() {
        int tag = -1;
        if (this.mContextRef != null) {
            tag = Secure.getInt(this.mContextRef.getContentResolver(), WIFI_EVALUATE_TAG, 0);
        }
        if (tag == 1) {
            return true;
        }
        ...
        if (SystemProperties.getBoolean("persist.sys.wifi_chr_onoff.dis", true)) {
            ...
            if (result.size() != 0) {
                for (int i = 0; i < result.size(); i++) {
                    Log.d(TAG, "normal@trigger:  type:" + type + " ; mWifiType = " + mWifiType + " ; msg_type = " + 1);
                    ConnectivityLogManager.getInstance().reportAbnormalEventEx((ChrLogBaseModel) result.get(i), mWifiType, 1, type, date, 1);
                }
            } else {
    ...
    public void uploadConnectFailed(int netid, int reason) {
        ...
        if (now - this.mLastConnectFailTimestamp >= this.MIN_UPLOAD_CONNECT_FAIL_SPAN) {
            ...
            if (this.mLastNetIdFromUI == netid && netid != -1) {
                this.hwWifiCHRService = HwWifiCHRServiceImpl.getDefault();
                if (this.hwWifiCHRService != null) {
    ...
    public void waitForDhcpStopping(String ifname) {
        if (!LogManager.getInstance().isCommercialUserFromCache()) {
            if ("wlan0".equals(ifname) || "p2p".equals(ifname)) {
                ...
                while (count < 5 && "running".equals(dhcpStauts)) {
                    try {
                        Thread.sleep(200);
                    } catch (InterruptedException e) {
                    }
    ...
    public void uploadDhcpException(int result, int serialNo) {
        ...
        this.aucDhcp_failed = (short) (result > 0 ? 2 : 1);
    ...
    public void uploadDisconnectException(String remainder) {
        ...
        if (ind >= 0) {
            ...
            if (reason.indexOf(HwCHRWifiCPUUsage.COL_SEP) >= 0) {
                reason = reason.substring(0, reason.indexOf(HwCHRWifiCPUUsage.COL_SEP)).trim();
            } else {
                reason = reason.trim();
            }
            try {
            ...
            this.mABSReassFaileReason = ireason;
    ...
    private void triggerDisableNetworkIfNeed() {
        long now = SystemClock.elapsedRealtime();
        if (this.mNetworkId == -1 || this.mNetworkId != this.mLastNetworkId) {
            this.mDisableNetworkflag = (byte) 0;
            this.mLastNetworkId = this.mNetworkId;
            this.mDisconnectCnt = 1;
        ...
        } else if (this.mDisconnectCnt >= 15 && now - this.mFirstDisconnectTime < ACCESSWEB_SLOW_OR_FAILED_UPLOAD_MIN) {
            this.hwWifiCHRService = HwWifiCHRServiceImpl.getDefault();
            if (this.hwWifiCHRService != null) {
    ...
    private void restoreDisableNetwork() {
        if (this.mDisableNetworkflag == DISABLE_NETWORK_PHASE1) {
            this.hwWifiCHRService = HwWifiCHRServiceImpl.getDefault();
            if (this.hwWifiCHRService != null) {
    ...
    private boolean canUploadWifiproEvent(String subEventName, boolean commercialUser) {
        ...
        if (commercialUser) {
            ...
            if (subEventName.equals(SUB_EVENT_CANT_CONNECT_FOR_LONG)) {
                int i = this.wifiproCanotConnectForLongCount + 1;
    ...
    private boolean canUploadWifiproDualbandEvent(String subEventName, boolean commercialUser) {
        ...
        if (commercialUser && subEventName.equals("DUALBAND_HANDOVER_SNAPSHOP")) {
    ...
    private boolean matchCommercialTrigger(boolean commercialUser, long lastUploadTime, long now, int count) {
        boolean ret = true;
        if (count >= 50 && now - lastUploadTime <= COMM_UPLOAD_MIN_SPAN) {
            ret = false;
        }
        if (ret && this.dftType != -1) {
        ...
        switch (type) {
            case 909001001:
                try {
                    ...
                    eventStabilityStat.setParam((short) 0, hwWifiDFTStabilityStat.mOpenCount).setParam((short) 1, hwWifiDFTStabilityStat.mOPenSuccCount).setParam((short) 2, hwWifiDFTStabilityStat.mOPenDuration).setParam((short) 3, hwWifiDFTStabilityStat.mCloseCount).setParam((short) 4, hwWifiDFTStabilityStat.mCloseSuccCount).setParam((short) 5, hwWifiDFTStabilityStat.mCloseDuration).setParam((short) 6, Boolean.valueOf(hwWifiDFTStabilityStat.mIsWifiProON)).setParam((short) 7, hwWifiDFTStabilityStat.mWifiProSwcnt).setParam((short) 8, Boolean.valueOf(hwWifiDFTStabilityStat.mIsScanAlwaysAvalible)).setParam((short) 9, hwWifiDFTStabilityStat.mScanAlwaysSwCnt).setParam((short) 10, Boolean.valueOf(hwWifiDFTStabilityStat.mIsWifiNotificationOn)).setParam((short) 11, hwWifiDFTStabilityStat.mWifiNotifationSwCnt).setParam((short) 12, hwWifiDFTStabilityStat.mWifiSleepPolicy).setParam((short) 13, hwWifiDFTStabilityStat.mWifiSleepSwCnt).setParam((short) 14, hwWifiDFTStabilityStat.mWifiToPdp).setParam((short) 15, hwWifiDFTStabilityStat.mWifiToPdpSwCnt);
            ...
            case 909001002:
                try {
                    ...
                    for (short i = (short) 0; i < ssidStatSize; i++) {
            ...
            case 909002012:
                try {
                    ...
                    abnormalDisconnect.setParam((short) 0, this.aucAbnormal_disconnect).setParam((short) 1, 0);
            ...
            case 909002013:
                try {
                    ...
                    scanFailed.setParam((short) 0, 0).setParam((short) 1, this.mScanFailCount);
            ...
            case 909002015:
                try {
                    ...
                    accessInternetFailed.setParam((short) 0, this.aucAccess_internet_failed).setParam((short) 1, 0);
            ...
            case 909002016:
                try {
                    ...
                    accessWebSlowly.setParam((short) 0, (short) this.accessSlowlyerrrCode).setParam((short) 1, 0);
            ...
            case 909002017:
                try {
                    ...
                    deviceFirmwareException110X.setParam((short) 0, 0).setParam((short) 1, 0);
        ...
        switch (type) {
            ...
            case HwWifiCHRConstImpl.WIFI_ABNORMAL_DISCONNECT /*85*/:
                if (matchCommercialTrigger(commercialUser, this.mDailyUploadTime, elapsedRealtime, this.mDisconnTotalCount)) {
                    ...
                    for (i = 0; i < rssiGroupCHR2.size(); i++) {
                    ...
                    if (this.mDualAntsChr && chipType != null) {
                        if (chipType.equalsIgnoreCase("hisi")) {
                            ...
                            if (getWifiAntsInfo(-1)) {
                                cSegEVENT_WIFI_ABNORMAL_DISCONNECT.ucIsAntSWCauseBreak.setValue(this.wifiAntsStatus.getIsAntSWCauseError() ? 1 : 0);
                ...
                while (i < 6) {
                    if (this.mDisconnectFail[i] == 0) {
                        this.mDisconnectFail[i] = (this.aucAbnormal_disconnect << 16) + 1;
                    } else if ((this.mDisconnectFail[i] >> 16) == this.aucAbnormal_disconnect) {
                ...
                if (this.mContextRef != null) {
                    if (isNeedReportAccessWebFailedEvent(elapsedRealtime, commercialUser)) {
                        if (matchCommercialTrigger(commercialUser, this.mDailyUploadTime, elapsedRealtime, this.mAccessFailCount)) {
                            ...
                            iIsMobileAP = 0;
                            if (this.mContextRef != null) {
                                iIsMobileAP = HwFrameworkFactory.getHwInnerWifiManager().getHwMeteredHint(this.mContextRef) ? 1 : 0;
                            }
                            relatedAps = getRelatedApInfo(bssid);
                            rssiGroupCHR2 = this.mRssiGroup.getRSSIGroupEXCHR();
                            essCount = (byte) (relatedAps >> 16);
                            ...
                            if (this.mAWS != null) {
                                ...
                                accessInterModel.enCANNOT_ACCESS_WEB_STATUS.setValue(this.mAWS.getDetectWebStatus() == 1 ? "NEVER_ABLE" : "ONCE_ABLE");
            ...
            case 101:
                ...
                if (this.hwWifiCHRService != null) {
                    try {
                        ...
                        rssiGroupCHR = this.mRssiGroup.getRSSIGroupCHR();
                        userConnModel.ucPublicEss.setValue((byte) (usrrelatedAps >> 16));
                        for (i = 0; i < rssiGroupCHR.size(); i++) {
                ...
                if (this.mContextRef != null) {
                    if (isNeedCreateAccessWebSlow(elapsedRealtime, commercialUser)) {
                        if (matchCommercialTrigger(commercialUser, this.mDailyUploadTime, elapsedRealtime, this.mAccessWebSlowCount)) {
                            ...
                            this.mAccessWebSlowCount++;
                            this.mUploadAccessWebSlowly++;
                            this.mUploadAccessWebSlowlySSID++;
            ...
            case 103:
                ...
                segWifipoorLevel.ucRssi2g0LevelAvg.setValue(this.mRssi2gCnt[0] == 0 ? 0 : this.mRssi2gSum[0] / this.mRssi2gCnt[0]);
                segWifipoorLevel.ucRssi2g1LevelAvg.setValue(this.mRssi2gCnt[1] == 0 ? 0 : this.mRssi2gSum[1] / this.mRssi2gCnt[1]);
                segWifipoorLevel.ucRssi2g2LevelAvg.setValue(this.mRssi2gCnt[2] == 0 ? 0 : this.mRssi2gSum[2] / this.mRssi2gCnt[2]);
                segWifipoorLevel.ucRssi2g3LevelAvg.setValue(this.mRssi2gCnt[3] == 0 ? 0 : this.mRssi2gSum[3] / this.mRssi2gCnt[3]);
                segWifipoorLevel.ucRssi2g4LevelAvg.setValue(this.mRssi2gCnt[4] == 0 ? 0 : this.mRssi2gSum[4] / this.mRssi2gCnt[4]);
                segWifipoorLevel.iRssi2g0LevelCnt.setValue(this.mRssi2gCnt[0]);
                segWifipoorLevel.iRssi2g1LevelCnt.setValue(this.mRssi2gCnt[1]);
                segWifipoorLevel.iRssi2g2LevelCnt.setValue(this.mRssi2gCnt[2]);
                segWifipoorLevel.iRssi2g3LevelCnt.setValue(this.mRssi2gCnt[3]);
                segWifipoorLevel.iRssi2g4LevelCnt.setValue(this.mRssi2gCnt[4]);
                ...
                segWifipoorLevel.ucRssi5g0LevelAvg.setValue(this.mRssi5gCnt[0] == 0 ? 0 : this.mRssi5gSum[0] / this.mRssi5gCnt[0]);
                segWifipoorLevel.ucRssi5g1LevelAvg.setValue(this.mRssi5gCnt[1] == 0 ? 0 : this.mRssi5gSum[1] / this.mRssi5gCnt[1]);
                segWifipoorLevel.ucRssi5g2LevelAvg.setValue(this.mRssi5gCnt[2] == 0 ? 0 : this.mRssi5gSum[2] / this.mRssi5gCnt[2]);
                segWifipoorLevel.ucRssi5g3LevelAvg.setValue(this.mRssi5gCnt[3] == 0 ? 0 : this.mRssi5gSum[3] / this.mRssi5gCnt[3]);
                LogByte logByte = segWifipoorLevel.ucRssi5g4LevelAvg;
                if (this.mRssi5gCnt[4] == 0) {
                    i2 = 0;
                } else {
                    i2 = this.mRssi5gSum[4] / this.mRssi5gCnt[4];
                }
                logByte.setValue(i2);
                segWifipoorLevel.iRssi5g0LevelCnt.setValue(this.mRssi5gCnt[0]);
                segWifipoorLevel.iRssi5g1LevelCnt.setValue(this.mRssi5gCnt[1]);
                segWifipoorLevel.iRssi5g2LevelCnt.setValue(this.mRssi5gCnt[2]);
                segWifipoorLevel.iRssi5g3LevelCnt.setValue(this.mRssi5gCnt[3]);
                segWifipoorLevel.iRssi5g4LevelCnt.setValue(this.mRssi5gCnt[4]);
            ...
            case HwWifiCHRConstImpl.WIFI_WIFIPRO_STATISTICS_EVENT /*121*/:
                ...
                statisticsEvent.enWifiUserType.setValue(getWifiUserTypeStr(commercialUser ? 2 : 1));
            ...
            case 126:
                if (this.mDualband2GAPBssid != null || this.mDualband5GAPBssid != null) {
                    if (this.mDualbandAPType != 1 && this.mDualbandAPType != 2) {
            ...
            case 214:
                if (matchCommercialTrigger(commercialUser, this.mDailyUploadTime, elapsedRealtime, this.mWifiConnentEventCount)) {
                    byte essNumber = (byte) (getRelatedApInfo(bssid) >> 16);
                    iIsMobileAP = 0;
                    if (this.mContextRef != null) {
                        iIsMobileAP = HwFrameworkFactory.getHwInnerWifiManager().getHwMeteredHint(this.mContextRef) ? 1 : 0;
                    }
                        ...
                        if (z) {
                            ...
                            try {
                                ...
                                for (HwCHRAccessNetworkEventInfo tmpEvent : arrayList) {
                                    if (tmpEvent.getEventId() == 82 && lstAuth_Chr_EventList.size() < 5) {
                                    ...
                                    } else if (tmpEvent.getEventId() == 83 && lstAssoc_Chr_EventList.size() < 5) {
                                    ...
                                    } else if (tmpEvent.getEventId() == 84 && lstDHCP_Chr_EventList.size() < 5) {
                ...
                break;
            case 215:
                HwABSCHRExEvent mABSException = HwABSCHRManager.getInstance(this.mContextRef).getExceptionInfo();
                if (mABSException != null) {
                    CSegEVENT_WIFI_ABS_ASSOC_FAILED_EVENT absAssocFailedEvent = new CSegEVENT_WIFI_ABS_ASSOC_FAILED_EVENT();
                    absAssocFailedEvent.tmTimeStamp.setValue(date);
                    absAssocFailedEvent.ucCardIndex.setValue(this.mChrComInfo.getCardIndex());
                    absAssocFailedEvent.strSTA_MAC.setValue(this.strSta_mac);
                    absAssocFailedEvent.usAP_RSSI.setValue(mABSException.mABSApRSSI);
                    absAssocFailedEvent.strAP_MAC.setValue(mABSException.mABSApBssid);
                    absAssocFailedEvent.strAP_SSID.setValue(mABSException.mABSApSsid);
                    absAssocFailedEvent.usAP_channel.setValue(mABSException.mABSApChannel);
                    absAssocFailedEvent.ucAP_auth_type.setValue(mABSException.mABSApAuthType);
                    absAssocFailedEvent.usSubErrorCode.setValue(this.mABSReassFaileReason);
                    absAssocFailedEvent.ucSwitchType.setValue(mABSException.mSwitchType);
                    chrLogBaseModel = absAssocFailedEvent;
                    break;
                }
                break;
            case 216:
                HwABSCHRStatistics mABSStatistics = HwABSCHRManager.getInstance(this.mContextRef).getStatisticsInfo();
                if (mABSStatistics != null) {
                    CSegEVENT_WIFI_ABS_STATISTICS_EVENT absStatisticsEvent = new CSegEVENT_WIFI_ABS_STATISTICS_EVENT();
                    absStatisticsEvent.tmTimeStamp.setValue(date);
                    absStatisticsEvent.ucCardIndex.setValue(this.mChrComInfo.getCardIndex());
                    absStatisticsEvent.uslong_connect_event.setValue(mABSStatistics.long_connect_event);
                    absStatisticsEvent.usshort_connect_event.setValue(mABSStatistics.short_connect_event);
                    absStatisticsEvent.ussearch_event.setValue(mABSStatistics.search_event);
                    absStatisticsEvent.usantenna_preempted_screen_on_event.setValue(mABSStatistics.antenna_preempted_screen_on_event);
                    absStatisticsEvent.usantenna_preempted_screen_off_event.setValue(mABSStatistics.antenna_preempted_screen_off_event);
                    absStatisticsEvent.usmo_mt_call_event.setValue(mABSStatistics.mo_mt_call_event);
                    absStatisticsEvent.ussiso_to_mimo_event.setValue(mABSStatistics.siso_to_mimo_event);
                    absStatisticsEvent.usping_pong_times.setValue(mABSStatistics.ping_pong_times);
                    absStatisticsEvent.usmax_ping_pong_times.setValue(mABSStatistics.max_ping_pong_times);
                    absStatisticsEvent.lsiso_time.setValue(mABSStatistics.siso_time);
                    absStatisticsEvent.lmimo_time.setValue(mABSStatistics.mimo_time);
                    absStatisticsEvent.lmimo_screen_on_time.setValue(mABSStatistics.mimo_screen_on_time);
                    absStatisticsEvent.lsiso_screen_on_time.setValue(mABSStatistics.siso_screen_on_time);
                    chrLogBaseModel = absStatisticsEvent;
                    break;
                }
                break;
        }
    ...
    public void updateAPSsidByEvent(String eventStr) {
        if ("wlan0".equals(this.mCurrentMsgIface)) {
            resetWhenDisconnect();
            String ssid = getAPSsidByEvent(eventStr);
            if (ssid.length() > 0) {
                updateAPSsid(ssid);
            }
        }
    ...
    private String getAPSsidByEvent(String eventStr) {
        String ssid = "";
        ...
        int indexOfSSID = eventStr.indexOf(ssidPattern);
        if (indexOfSSID > 0) {
            ssid = eventStr.substring(indexOfSSID);
            int indexStart = ssid.indexOf(symbolPattern);
            int indexEnd = ssid.lastIndexOf(symbolPattern);
            if (indexStart <= 0 || indexEnd <= indexStart) {
                ssid = "";
            } else {
                ssid = ssid.substring(indexStart + 1, indexEnd);
            }
        }
        return ssid;
    }
    ...
    public void updateAPSsid(SupplicantState state, WifiInfo mWifiInfo) {
        if (state == SupplicantState.COMPLETED && mWifiInfo.getWifiSsid() != null) {
            ...
            String ssid = "";
            if (!oriSsid.equals("")) {
                ssid = oriSsid.substring(2, oriSsid.length() - 1);
            }
            try {
                updateAPSsid(ssid);
            } catch (Exception e) {
    ...
    public void handleIPv4SuccessException(Inet4Address addr) {
        if (addr != null) {
            ...
            if (LogManager.getInstance().isCommercialUser()) {
                ...
                updateTimeStampSessionFinish(SystemClock.elapsedRealtime());
                reportHwCHRAccessNetworkEventInfoList(4);
            }
            this.mTimeStampSessionStart = 0;
            this.mTimeStampSessionFirstConnect = 0;
            this.mTimeStampSessionFinish = 0;
    ...
    public void handleCHREvents(String eventStr) {
        ...
        if (index > 0) {
            String header = eventStr.substring(0, index);
            String body = eventStr.substring(index + 1);
            int typeIdx = header.indexOf("=");
            if (typeIdx > 0) {
                String strType = header.substring(typeIdx + 1);
    ...
    public void processWifiHalDriverEvent(String strJsonExp) {
        ...
        errNo = adaptErrorCode(eventNo, errNo, 15);
        ...
        if (ConnectivityLogManager.mapCHRDataPlus.containsKey(Integer.valueOf(eventNo))) {
            ...
            ConnectivityLogManager.getInstance().sendMessage(ConnectivityLogManager.getInstance().obtainMessage(2, strJsonExp));
            if (HWFLOW) {
    ...
    void initWifiEventReasonMap() {
        ...
        mapWifiOpenFailed.put(Integer.valueOf(6), "CHR_WIFI_DRV_ERROR_INSMOD_KO");
        mapWifiOpenFailed.put(Integer.valueOf(7), "CHR_WIFI_DRV_ERROR_SYS_VERSION");
        mapWifiOpenFailed.put(Integer.valueOf(8), "CHR_WIFI_DRV_ERROR_POWER_ON");
        ...
        mapWifiOpenFailed.put(Integer.valueOf(15), "CHR_PLAT_DRV_ERROR_OPEN_UART");
        mapWifiOpenFailed.put(Integer.valueOf(16), "CHR_PLAT_DRV_ERROR_BCPU_BOOTUP");
        ...
        mapWifiCloseFailed.put(Integer.valueOf(3), "CHR_WIFI_DRV_ERROR_POWER_OFF");
        mapWifiCloseFailed.put(Integer.valueOf(4), "CHR_PLAT_DRV_ERROR_CLOSE_BCPU");
        mapWifiCloseFailed.put(Integer.valueOf(5), "CHR_PLAT_DRV_ERROR_CLOSE_WCPU");
        mapWifiCloseFailed.put(Integer.valueOf(6), "CHR_PLAT_DRV_ERROR_CLOSE_THREAD");
        ...
        mapAbnormalDisconnect.put(Integer.valueOf(101), "CHR_WIFI_DRV_ERROR_LINKLOSS");
        mapAbnormalDisconnect.put(Integer.valueOf(102), "CHR_WIFI_DRV_ERROR_KEEPALIVE_TIMEOUT");
        mapAbnormalDisconnect.put(Integer.valueOf(103), "CHR_WIFI_DRV_ERROR_CHANNEL_CHANGE");
        ...
        mapWifiScanFailed.put(Integer.valueOf(4), "CHR_WIFI_DRV_ERROR_SCAN_REFUSED");
        mapWifiScanFailed.put(Integer.valueOf(5), "CHR_WIFI_DRV_ERROR_SCAN_TIMEOUT");
        mapWifiScanFailed.put(Integer.valueOf(6), "CHR_WIFI_DRV_ERROR_SCAN_ZERO");
        ...
        mapAccessInternetFailed.put(Integer.valueOf(6), "CHR_WIFI_DRV_ERROR_RX_NO_BUFFER");
        ...
        mapAuthFailed.put(Integer.valueOf(1), "CHR_WIFI_DRV_ERROR_AUTH_TIMEOUT");
        this.mapWifiEventReaseon.put(Integer.valueOf(82), mapAuthFailed);
        HashMap<Integer, String> mapAssocFailed = new HashMap();
        mapAssocFailed.put(Integer.valueOf(1), "CHR_WIFI_DRV_ERROR_ASSOC_TIMEOUT");
        this.mapWifiEventReaseon.put(Integer.valueOf(83), mapAssocFailed);
        HashMap<Integer, String> mapUserConnectFailed = new HashMap();
        mapUserConnectFailed.put(Integer.valueOf(1), "CHR_WIFI_DRV_ERROR_CONNECT_CMD");
        mapUserConnectFailed.put(Integer.valueOf(2), "CHR_WIFI_DRV_ERROR_AUTH_REJECTED");
        mapUserConnectFailed.put(Integer.valueOf(3), "CHR_WIFI_DRV_ERROR_ASSOC_REJECTED");
        this.mapWifiEventReaseon.put(Integer.valueOf(101), mapUserConnectFailed);
        HashMap<Integer, String> mapAccessWebSlowlyFailed = new HashMap();
        mapAccessWebSlowlyFailed.put(Integer.valueOf(1), "CHR_WIFI_DRV_ERROR_INTERFERENCE");
        this.mapWifiEventReaseon.put(Integer.valueOf(102), mapAccessWebSlowlyFailed);
        HashMap<Integer, String> mapHalDriverEvent = new HashMap();
        mapHalDriverEvent.put(Integer.valueOf(1), "CHR_WIFI_DRV_ERROR_ARP_TX_FAIL");
        mapHalDriverEvent.put(Integer.valueOf(2), "CHR_WIFI_DRV_ERROR_EAPOL_TX_FAIL");
        mapHalDriverEvent.put(Integer.valueOf(3), "CHR_WIFI_DRV_ERROR_BEAT_HEART_TIMEOUT");
        mapHalDriverEvent.put(Integer.valueOf(4), "CHR_WIFI_DRV_ERROR_WAKEUP_FAIL");
        mapHalDriverEvent.put(Integer.valueOf(5), "CHR_WIFI_DRV_ERROR_DEVICE_PANIC");
        mapHalDriverEvent.put(Integer.valueOf(6), "CHR_WIFI_DRV_ERROR_SDIO_TRANS_FAIL");
        mapHalDriverEvent.put(Integer.valueOf(7), "CHR_WIFI_DRV_ERROR_WATCHDOG_TIMEOUT");
        mapHalDriverEvent.put(Integer.valueOf(8), "CHR_WIFI_HAL_ERROR_MODE_CHANGE_FAIL");
        ...
        mapHalDriverEvent.put(Integer.valueOf(15), "CHR_PLAT_DRV_ERROR_BEAT_TIMEOUT");
        mapHalDriverEvent.put(Integer.valueOf(16), "CHR_WIFI_DEV_ERROR_FEM_FAIL");
        ...
        this.mapWifiEventReaseon.put(Integer.valueOf(200), mapHalDriverEvent);
        ...
        mapWifiAntsEvent.put(Integer.valueOf(0), "WIFI_ANTS_SW_FAILED_MODEM_PREEMPTIVE");
        mapWifiAntsEvent.put(Integer.valueOf(1), "WIFI_ANTS_SW_FAILED_DEVICE_EXCEPTION");
        mapWifiAntsEvent.put(Integer.valueOf(2), "WIFI_ANTS_SW_FAILED_ALG_EXCEPTION");
        mapWifiAntsEvent.put(Integer.valueOf(3), "WIFI_ANTS_SW_FAILED_UNKNOWN_ERROR");
    ...
    boolean matchHalDriverEventTriggerFreq(boolean commercialUser, String suberror) {
        ...
        if (this.mapHalDriverEventTriggerFreq.containsKey(suberror)) {
            ...
            if (eventFreq != null) {
                isMatch = (!commercialUser || eventFreq.getTriggerCount() < 3) ? true : nowTime - eventFreq.getLastTime() > COMM_UPLOAD_MIN_SPAN;
                if (isMatch) {
                    eventFreq.setTriggerCount(eventFreq.getTriggerCount() + 1);
                    eventFreq.setLastTime(nowTime);
                }
            }
        } else {
            this.mapHalDriverEventTriggerFreq.put(suberror, new HalDrivceEventFreq(1, nowTime));
        }
        if (HWFLOW) {
    ...
    protected void processWifiCHRPlusException(int eventNo, String strReason) {
        if (eventNo == 210 || eventNo == 212) {
            int antsSwitchFailedDir = 0;
            if (eventNo == 210) {
                antsSwitchFailedDir = 0;
            } else if (eventNo == 212) {
                antsSwitchFailedDir = 1;
            }
            eventNo = 210;
    ...
    private void clearWifiPoorLevel() {
        ...
        this.mRssi5gMinRssi = 0;
        this.mpoorRssi5gCnt = 0;
        for (i = 0; i < this.mRssi2gSum.length; i++) {
            this.mRssi2gSum[i] = 0;
        }
        for (i = 0; i < this.mRssi2gCnt.length; i++) {
            this.mRssi2gCnt[i] = 0;
        }
        for (i = 0; i < this.mRssi5gSum.length; i++) {
            this.mRssi5gSum[i] = 0;
        }
        for (i = 0; i < this.mRssi5gCnt.length; i++) {
            this.mRssi5gCnt[i] = 0;
        }
    }
