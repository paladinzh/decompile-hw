...
public class GarbageCanDelAnim {
    ...
    private static PathInterpolator CURRENT_PAGE_TRANSLATIONX_IP = new PathInterpolator(0.89f, 0.21f, CylinderTransition.RADIUS_SCALE, 0.96f);
    ...
    private static PathInterpolator NEXT_PAGE_ALPHA_IP = new PathInterpolator(0.99f, -0.01f, CylinderTransition.RADIUS_SCALE, 1.01f);
