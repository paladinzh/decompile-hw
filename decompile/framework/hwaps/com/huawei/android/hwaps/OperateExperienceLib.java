        ...
        try {
            if (this.mResolver != null) {
                ...
                if (cursor == null) {
                    ...
                    this.mGameType = cursor.getInt(2);
                    this.mMaxFPS = cursor.getInt(3);
                    this.mMinFPS = cursor.getInt(4);
                    ...
                    for (int i = 0; i < sceneNum; i++) {
                        int fps = cursor.getInt(((i * 2) + 9) + 1);
                        float ratio = cursor.getFloat(((i * 2) + 9) + 2);
