...
final class HttpsClient extends HttpClient implements HandshakeCompletedListener {
    static final /* synthetic */ boolean -assertionsDisabled = (!HttpsClient.class.desiredAssertionStatus());
    ...
    private static Proxy newHttpProxy(final String proxyHost, int proxyPort) {
        SocketAddress saddr = null;
        String phost = proxyHost;
        final int pport = proxyPort < 0 ? httpsPortNumber : proxyPort;
        try {
            saddr = (InetSocketAddress) AccessController.doPrivileged(new PrivilegedExceptionAction<InetSocketAddress>() {
                public InetSocketAddress run() {
                    return new InetSocketAddress(proxyHost, pport);
                }
            });
