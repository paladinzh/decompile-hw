...
public class PKCS9Attribute implements DerEncoder {
    ...
    static {
        ...
        try {
            ...
            r3 = new Byte[18][];
            r3[1] = new Byte[]{new Byte((byte) 22)};
            r3[2] = new Byte[]{new Byte((byte) 22)};
            r3[3] = new Byte[]{new Byte((byte) 6)};
            r3[4] = new Byte[]{new Byte((byte) 4)};
            r3[5] = new Byte[]{new Byte((byte) 23)};
            r3[6] = new Byte[]{new Byte((byte) 48)};
            r3[7] = new Byte[]{new Byte((byte) 19), new Byte((byte) 20)};
            r3[8] = new Byte[]{new Byte((byte) 19), new Byte((byte) 20)};
            r3[9] = new Byte[]{new Byte((byte) 49)};
            r3[10] = new Byte[]{new Byte((byte) 48)};
            r3[11] = null;
            r3[12] = null;
            r3[13] = null;
            r3[14] = new Byte[]{new Byte((byte) 48)};
            r3[15] = new Byte[]{new Byte((byte) 48)};
            r3[16] = new Byte[]{new Byte((byte) 48)};
            r3[17] = new Byte[]{new Byte((byte) 48)};
            PKCS9_VALUE_TAGS = r3;
            try {
