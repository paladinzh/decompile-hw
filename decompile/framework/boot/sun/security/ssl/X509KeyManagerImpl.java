...
final class X509KeyManagerImpl extends X509ExtendedKeyManager implements X509KeyManager {
    ...
    private static final boolean useDebug = (debug != null ? Debug.isOn("keymanager") : false);
                ...
                if (!(chain == null || chain.length == 0)) {
                    ...
                    if (incompatible) {
                        ...
                        if (keyIndex != -1) {
                            if (issuerSet != null) {
                                boolean found = false;
                                for (Certificate cert2 : chain) {
                                    if (issuerSet.contains(((X509Certificate) cert2).getIssuerX500Principal())) {
                                        found = true;
                                        break;
                                    }
                                }
