...
class InputRecord extends ByteArrayInputStream implements Record {
    ...
    private static final byte[] v2NoCipher = new byte[]{Byte.MIN_VALUE, (byte) 3, (byte) 0, (byte) 0, (byte) 1};
    ...
    void read(InputStream s, OutputStream o) throws IOException {
        if (!this.isClosed) {
            ...
            if (this.formatVerified) {
                ...
                if (this.buf[0] == (byte) 22 || this.buf[0] == (byte) 21) {
                    readV3Record(s, o);
                } else {
    ...
    private void handleUnknownRecord(InputStream s, OutputStream o) throws IOException {
        if ((this.buf[0] & 128) == 0 || this.buf[2] != (byte) 1) {
            if ((this.buf[0] & 128) == 0 || this.buf[2] != (byte) 4) {
            ...
            int len = (((this.buf[0] & 127) << 8) + (this.buf[1] & 255)) - 3;
            if (this.v2Buf == null) {
