...
public class LocalGregorianCalendar extends BaseCalendar {
    ...
    static LocalGregorianCalendar getLocalGregorianCalendar(String name) {
        try {
            final String fname = ((String) AccessController.doPrivileged(new GetPropertyAction("java.home"))) + File.separator + "lib" + File.separator + "calendars.properties";
            String props = ((Properties) AccessController.doPrivileged(new PrivilegedExceptionAction() {
            ...
            })).getProperty("calendar." + name + ".eras");
            if (props == null) {
                return null;
            }
