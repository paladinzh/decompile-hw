...
public class ThreadPool {
    ...
    static ThreadPool createDefault() {
        ...
        return new ThreadPool(new ThreadPoolExecutor(0, Integer.MAX_VALUE, Long.MAX_VALUE, TimeUnit.MILLISECONDS, new SynchronousQueue(), threadFactory), false, initialSize);
    }
