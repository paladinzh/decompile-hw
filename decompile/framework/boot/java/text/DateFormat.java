...
public abstract class DateFormat extends Format {
    ...
    private static class DateFormatGetter implements LocalizedObjectGetter<DateFormatProvider, DateFormat> {
        ...
        static {
            boolean z;
            if (DateFormatGetter.class.desiredAssertionStatus()) {
                z = false;
            } else {
                z = true;
            }
        ...
        public DateFormat getObject(DateFormatProvider dateFormatProvider, Locale locale, String key, Object... params) {
            if (!-assertionsDisabled) {
                if ((params.length == 3 ? 1 : 0) == 0) {
                    throw new AssertionError();
                }
            }
            int timeStyle = ((Integer) params[0]).intValue();
            int dateStyle = ((Integer) params[1]).intValue();
            switch (((Integer) params[2]).intValue()) {
                case 1:
