...
public final class URI implements Comparable<URI>, Serializable {
    ...
    private class Parser {
        ...
        private int parseAuthority(int start, int n) throws URISyntaxException {
            ...
            boolean regChars = scan(start, n, URI.L_REG_NAME, URI.H_REG_NAME) == n;
    ...
    public boolean equals(Object ob) {
        ...
        if (this.host != null) {
            return equal(this.userInfo, that.userInfo) && equalIgnoringCase(this.host, that.host) && this.port == that.port;
        } else {
...
*/
    ...
    static {
        boolean z;
        if (URI.class.desiredAssertionStatus()) {
            z = false;
        } else {
            z = true;
        }
