...
public class TreeMap<K, V> extends AbstractMap<K, V> implements NavigableMap<K, V>, Cloneable, Serializable {
    ...
    static abstract class NavigableSubMap<K, V> extends AbstractMap<K, V> implements NavigableMap<K, V>, Serializable {
        ...
        abstract class SubMapIterator<T> implements Iterator<T> {
            ...
            public final boolean hasNext() {
                return (this.next == null || this.next.key == this.fenceKey) ? false : TreeMap.BLACK;
            }
        ...
        final boolean inRange(Object key) {
            return (tooLow(key) || tooHigh(key)) ? false : TreeMap.BLACK;
        }
        ...
        public final boolean containsKey(Object key) {
            return inRange(key) ? this.m.containsKey(key) : false;
        }
        ...
        public final SortedMap<K, V> subMap(K fromKey, K toKey) {
            return subMap(fromKey, TreeMap.BLACK, toKey, false);
        }
    ...
    abstract class PrivateEntryIterator<T> implements Iterator<T> {
        ...
        public final boolean hasNext() {
            return this.next != null ? TreeMap.BLACK : false;
        }
    ...
    static final class KeySet<E> extends AbstractSet<E> implements NavigableSet<E> {
        ...
        public boolean remove(Object o) {
            int oldSize = size();
            this.m.remove(o);
            return size() != oldSize ? TreeMap.BLACK : false;
        }
        ...
        public SortedSet<E> subSet(E fromElement, E toElement) {
            return subSet(fromElement, TreeMap.BLACK, toElement, false);
        }
    ...
    private class SubMap extends AbstractMap<K, V> implements SortedMap<K, V>, Serializable {
        ...
        private Object readResolve() {
            return new AscendingSubMap(TreeMap.this, this.fromStart, this.fromKey, TreeMap.BLACK, this.toEnd, this.toKey, false);
        }
    ...
    public boolean containsKey(Object key) {
        return getEntry(key) != null ? BLACK : false;
    }
    ...
    public NavigableMap<K, V> headMap(K toKey, boolean inclusive) {
        return new AscendingSubMap(this, BLACK, null, BLACK, false, toKey, inclusive);
    }

    public NavigableMap<K, V> tailMap(K fromKey, boolean inclusive) {
        return new AscendingSubMap(this, false, fromKey, inclusive, BLACK, null, BLACK);
    }

    public SortedMap<K, V> subMap(K fromKey, K toKey) {
        return subMap(fromKey, BLACK, toKey, false);
    }
