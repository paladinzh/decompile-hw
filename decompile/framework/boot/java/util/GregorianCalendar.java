...
public class GregorianCalendar extends Calendar {
    static final /* synthetic */ boolean -assertionsDisabled = (!GregorianCalendar.class.desiredAssertionStatus());
...
*/
    ...
    public boolean isLeapYear(int year) {
        ...
        if (year > this.gregorianCutoverYear) {
            ...
            boolean gregorian = this.gregorianCutoverYear == this.gregorianCutoverYearJulian ? getCalendarDate(this.gregorianCutoverDate).getMonth() < 3 : year == this.gregorianCutoverYear;
