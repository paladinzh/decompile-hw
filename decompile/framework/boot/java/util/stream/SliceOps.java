...
final class SliceOps {
    static final /* synthetic */ boolean -assertionsDisabled = (!SliceOps.class.desiredAssertionStatus());
    ...
    public static IntStream makeInt(AbstractPipeline<?, Integer, ?> upstream, long skip, long limit) {
        ...
        return new IntPipeline.StatefulOp<Integer>(upstream, StreamShape.INT_VALUE, flags(limit)) {
            ...
            public <P_IN> Spliterator<Integer> opEvaluateParallelLazy(PipelineHelper<Integer> helper, Spliterator<P_IN> spliterator) {
                ...
                return ((Node) new SliceTask(this, helper, spliterator, new -java_util_Spliterator_opEvaluateParallelLazy_java_util_stream_PipelineHelper_helper_java_util_Spliterator_spliterator_LambdaImpl0(), j, j2).invoke()).spliterator();
            }
