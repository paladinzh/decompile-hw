...
class StreamSpliterators {
    ...
    static abstract class SliceSpliterator<T, T_SPLITR extends Spliterator<T>> {
        static final /* synthetic */ boolean -assertionsDisabled = (!SliceSpliterator.class.desiredAssertionStatus());
        long fence;
        long index;
        T_SPLITR s;
    ...
    static abstract class UnorderedSliceSpliterator<T, T_SPLITR extends Spliterator<T>> {
        static final /* synthetic */ boolean -assertionsDisabled = (!UnorderedSliceSpliterator.class.desiredAssertionStatus());
