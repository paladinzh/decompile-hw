...
public class Collections {
    ...
    private static class CopiesList<E> extends AbstractList<E> implements RandomAccess, Serializable {
        static final /* synthetic */ boolean -assertionsDisabled = (!CopiesList.class.desiredAssertionStatus());
        ...
        public boolean contains(Object obj) {
            return this.n != 0 ? Collections.eq(obj, this.element) : false;
        }
    ...
    private static class ReverseComparator2<T> implements Comparator<T>, Serializable {
        static final /* synthetic */ boolean -assertionsDisabled = (!ReverseComparator2.class.desiredAssertionStatus());
