...
public class GenderInfo {
    ...
    private static class Cache {
        ...
        private static GenderInfo load(ULocale ulocale) {
            try {
                return new GenderInfo(ListGenderStyle.fromName(UResourceBundle.getBundleInstance("android/icu/impl/data/icudt56b", "genderList", ICUResourceBundle.ICU_DATA_CLASS_LOADER, true).get("genderList").getString(ulocale.toString())));
