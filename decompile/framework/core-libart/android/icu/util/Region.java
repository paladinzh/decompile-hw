...
public class Region implements Comparable<Region> {
    ...
    private static synchronized void loadRegionData() {
        synchronized (Region.class) {
            ...
            UResourceBundle territoryAlias = UResourceBundle.getBundleInstance("android/icu/impl/data/icudt56b", "metadata", ICUResourceBundle.ICU_DATA_CLASS_LOADER).get("alias").get("territory");
