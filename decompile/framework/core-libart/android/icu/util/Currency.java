...
public class Currency extends MeasureUnit {
    ...
    public int getNumericCode() {
        int result = 0;
        try {
            result = UResourceBundle.getBundleInstance("android/icu/impl/data/icudt56b", "currencyNumericCodes", ICUResourceBundle.ICU_DATA_CLASS_LOADER).get("codeMap").get(this.subType).getInt();
