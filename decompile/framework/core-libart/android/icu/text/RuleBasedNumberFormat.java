...
public class RuleBasedNumberFormat extends NumberFormat {
    ...
    private void initCapitalizationContextInfo(ULocale theLocale) {
        boolean z = true;
        try {
            int[] intVector = ((ICUResourceBundle) UResourceBundle.getBundleInstance("android/icu/impl/data/icudt56b", theLocale)).getWithFallback("contextTransforms/number-spellout").getIntVector();
