...
final class DictionaryData {
    ...
    public static DictionaryMatcher loadDictionaryFor(String dictType) throws IOException {
        ByteBuffer bytes = ICUBinary.getRequiredData("brkitr/" + ((ICUResourceBundle) UResourceBundle.getBundleInstance("android/icu/impl/data/icudt56b/brkitr")).getStringWithFallback("dictionaries/" + dictType));
