...
public final class StringSearch extends SearchIterator {
    ...
    private static class CEBuffer {
        static final /* synthetic */ boolean -assertionsDisabled = (!CEBuffer.class.desiredAssertionStatus());
    ...
    private boolean search(int startIdx, Match m) {
        ...
        while (true) {
            ...
            if (found || (r22 != null && r22.ce_ == -1)) {
                ...
                if (this.breakIterator != null || nextCEI == null || ((nextCEI.ce_ >>> 32) & Collation.MAX_PRIMARY) == 0 || maxLimit < lastCEI.highIndex_ || nextCEI.highIndex_ <= maxLimit) {
