...
public class RelativeDateFormat extends DateFormat {
    ...
    private synchronized void loadDates() {
        ICUResourceBundle rdb = ((ICUResourceBundle) UResourceBundle.getBundleInstance("android/icu/impl/data/icudt56b", this.fLocale)).getWithFallback("fields/day/relative");
    ...
    private void initCapitalizationContextInfo(ULocale locale) {
        boolean z = true;
        try {
            int[] intVector = ((ICUResourceBundle) UResourceBundle.getBundleInstance("android/icu/impl/data/icudt56b", locale)).getWithFallback("contextTransforms/relative").getIntVector();
