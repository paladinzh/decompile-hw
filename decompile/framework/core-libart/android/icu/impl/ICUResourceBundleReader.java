...
public final class ICUResourceBundleReader {
    ...
    private static final CharBuffer EMPTY_16_BIT_UNITS = CharBuffer.wrap(DexFormat.MAGIC_SUFFIX);
    ...
    static class Array extends Container {
        static final /* synthetic */ boolean -assertionsDisabled = (!Array.class.desiredAssertionStatus());
    ...
    private static final class ResourceCache {
        static final /* synthetic */ boolean -assertionsDisabled = (!ResourceCache.class.desiredAssertionStatus());
        ...
        private static final class Level {
            static final /* synthetic */ boolean -assertionsDisabled = (!Level.class.desiredAssertionStatus());
            int[] keys;
            int levelBitsList;
            int mask;
            int shift;
...
*/
    ...
    static class Table extends Container {
        static final /* synthetic */ boolean -assertionsDisabled = (!Table.class.desiredAssertionStatus());
    ...
    static {
        boolean z;
        if (ICUResourceBundleReader.class.desiredAssertionStatus()) {
            z = false;
        } else {
            z = true;
        }
