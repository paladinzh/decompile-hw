...
public final class CollationBuilder extends Sink {
    ...
    private static final class CEFinalizer implements CEModifier {
        static final /* synthetic */ boolean -assertionsDisabled = (!CEFinalizer.class.desiredAssertionStatus());
...
*/
    ...
    static {
        boolean z;
        if (CollationBuilder.class.desiredAssertionStatus()) {
            z = false;
        } else {
            z = true;
        }
