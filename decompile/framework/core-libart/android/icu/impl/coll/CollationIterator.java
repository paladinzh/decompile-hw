...
public abstract class CollationIterator {
    ...
    private static final class SkippedState {
        static final /* synthetic */ boolean -assertionsDisabled = (!SkippedState.class.desiredAssertionStatus());
...
jadx.core.utils.exceptions.CodegenException: Error generate insn: PHI: (r9_1 'pos' int) = (r9_0 'pos' int), (r9_4 'pos' int) binds: {(r9_0 'pos' int)=B:56:0x0105, (r9_4 'pos' int)=B:62:0x0141} in method: android.icu.impl.coll.CollationIterator.appendNumericSegmentCEs(java.lang.CharSequence):void
