...
public class TZDBTimeZoneNames extends TimeZoneNames {
    ...
    private static final ICUResourceBundle ZONESTRINGS = ((ICUResourceBundle) UResourceBundle.getBundleInstance("android/icu/impl/data/icudt56b/zone", "tzdbNames").get("zoneStrings"));
    ...
    private static class TZDBNameSearchHandler implements ResultHandler<TZDBNameInfo> {
        static final /* synthetic */ boolean -assertionsDisabled = (!TZDBNameSearchHandler.class.desiredAssertionStatus());
