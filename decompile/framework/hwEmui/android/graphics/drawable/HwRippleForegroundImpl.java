...
class HwRippleForegroundImpl extends RippleComponent {
    ...
    private static final TimeInterpolator INTERPOLATOR_ENTER = new PathInterpolator(HwFragmentMenuItemView.ALPHA_DISABLE, 0.15f, 0.1f, 0.85f);
    ...
    private float mOpacity = HwFragmentMenuItemView.ALPHA_NORMAL;
