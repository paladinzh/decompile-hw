...
public interface IHwSysResManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IHwSysResManager {
        ...
        static final int TRANSACTION_reportAppType = 33;
        ...
        private static class Proxy implements IHwSysResManager {
            ...
            public void reportAppType(String pkgName, int appType, boolean status) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_reportAppType, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 32:
                    ...
                    reply.writeLong(_result4);
                    return true;
                case TRANSACTION_reportAppType /*33*/:
                    data.enforceInterface(DESCRIPTOR);
                    reportAppType(data.readString(), data.readInt(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    void reportAppType(String str, int i, boolean z) throws RemoteException;
