    ...
    float getOffsetBrightnessLevel_new(float brightnessStartOrig, float brightnessEndOrig, float brightnessStartNew) {
        ...
        if (brightnessStartOrig < brightnessEndOrig) {
            ...
            if (this.mDelta > 0.0f) {
                ...
                ratio2 = Math.max(Math.min((2.5f * ratio2) + 0.5f, (-1.25f * ratio2) + 1.25f), 0.0f);
            }
            if (this.mDelta < 0.0f) {
        ...
        if (brightnessStartOrig > brightnessEndOrig) {
            ...
            if (this.mDelta > 0.0f) {
                ratio = Math.max(Math.min((0.05f * brightnessEndOrig) - 0.6f, HwFragmentMenuItemView.ALPHA_NORMAL), 0.0f);
            }
        }
