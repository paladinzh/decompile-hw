...
public class HwScrollingTabContainerView extends ScrollingTabContainerView {
    ...
    class TabIndicatorAnimation {
        ...
        private void anim(int from, int to, int l2r) {
            ...
            this.mAnimator.setInterpolator(new PathInterpolator(0.2f, 0.5f, HwRippleForegroundImpl.LINEAR_FROM, 0.5f));
            final int i = l2r;
    ...
    public void updateTabViewContainerWidth(Context context) {
        int tabContainerViewWidth = context.getResources().getDimensionPixelOffset(34472081);
    ...
    private void createTabIndicator() {
        this.mIndicatorHeight = getResources().getDimensionPixelSize(34472185);
    ...
    protected void handleTabViewCreated(TabView tabView) {
        if (tabView != null) {
            ...
            if (HwWidgetUtils.isActionbarBackgroundThemed(getContext())) {
                tabView.setBackgroundResource(33751684);
                return;
            }
            int resBackground = HwWidgetFactory.getImmersionResource(this.mContext, 33751687, 0, 33751688, false);
            if (this.mIsHwEmphasizeTheme) {
                resBackground = 33751689;
            }
