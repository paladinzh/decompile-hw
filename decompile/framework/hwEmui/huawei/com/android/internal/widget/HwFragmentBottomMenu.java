...
public class HwFragmentBottomMenu extends LinearLayout implements OnClickListener {
    ...
    private void init(Context context) {
        ...
        this.mTextSize = this.mContext.getResources().getDimensionPixelSize(34472171) + this.mContext.getResources().getDimensionPixelSize(34471977);
    ...
    public void refreshMenu() {
        ...
        for (int i = 0; i < this.mFragmentMenu.size(); i++) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (getChildCount() != 0) {
            ...
            Log.d(TAG, "onMeasure end: mParentViewWidth = " + this.mParentViewWidth + ", mMenuBarWidth = " + this.mMenuBarWidth + ", mMenuBarHeight = " + this.mMenuBarHeight + ", mMenuItemWidth = " + this.mMenuItemWidth + ", mDisplayMenuCount = " + this.mDisplayMenuCount + ", mDisplayMoreMenuCount = " + this.mDisplayMoreMenuCount);
            setMeasuredDimension(this.mMenuBarWidth, this.mMenuBarHeight);
        }
    }
    ...
    public void showPopup(View view) {
        if (this.mFragmentMenu != null && this.mMoreMenuList.size() != 0) {
            ...
            this.mPopupWindow.setBackgroundDrawable(getResources().getDrawable(33751584));
