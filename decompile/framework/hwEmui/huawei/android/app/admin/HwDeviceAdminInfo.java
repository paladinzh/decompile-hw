...
public class HwDeviceAdminInfo implements IHwDeviceAdminInfo {
    ...
    static {
        sPoliciesDisplayOrder.add(new PolicyInfo(0, "com.huawei.permission.sec.MDM_WIFI", 33685843, 33685844));
        sPoliciesDisplayOrder.add(new PolicyInfo(1, "com.huawei.permission.sec.MDM_USB", 33685845, 33685846));
        sPoliciesDisplayOrder.add(new PolicyInfo(2, "com.huawei.permission.sec.MDM_SDCARD", 33685847, 33685848));
        sPoliciesDisplayOrder.add(new PolicyInfo(3, "com.huawei.permission.sec.MDM_NFC", 33685849, 33685850));
        sPoliciesDisplayOrder.add(new PolicyInfo(4, "com.huawei.permission.sec.MDM_CONNECTIVITY", 33685851, 33685852));
        sPoliciesDisplayOrder.add(new PolicyInfo(5, "com.huawei.permission.sec.MDM_PHONE", 33685853, 33685854));
        sPoliciesDisplayOrder.add(new PolicyInfo(6, "com.huawei.permission.sec.MDM_MMS", 33685855, 33685856));
        sPoliciesDisplayOrder.add(new PolicyInfo(7, "com.huawei.permission.sec.MDM_DEVICE_MANAGER", 33685857, 33685858));
        sPoliciesDisplayOrder.add(new PolicyInfo(8, "com.huawei.permission.sec.MDM_APP_MANAGEMENT", 33685859, 33685860));
        sPoliciesDisplayOrder.add(new PolicyInfo(9, "com.huawei.permission.sec.MDM_EMAIL", 33685861, 33685862));
        sPoliciesDisplayOrder.add(new PolicyInfo(10, "com.huawei.permission.sec.MDM_BLUETOOTH", 33685863, 33685864));
        sPoliciesDisplayOrder.add(new PolicyInfo(11, "com.huawei.permission.sec.MDM_APN", 33685865, 33685866));
