...
public class HwPhoneLayoutInflater extends PhoneLayoutInflater {
    ...
    private static final String[] sAndroidClassList = new String[]{"LinearLayout", "RelativeLayout", "FrameLayout", "ViewStub", "View", "ScrollView", "Button", "TextView", "RadioButton", "EditText", "ImageView", "Space"};
