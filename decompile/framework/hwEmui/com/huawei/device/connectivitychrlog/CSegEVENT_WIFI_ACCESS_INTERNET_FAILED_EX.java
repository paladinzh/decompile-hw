...
public class CSegEVENT_WIFI_ACCESS_INTERNET_FAILED_EX extends ChrLogBaseEventModel {
    ...
    public CSubApRoaming cApRoaming = null;
    public CSubBTStatus cBTStatus = null;
    public CSubCPUInfo cCPUInfo = null;
    public CSubCellID cCellID = null;
    public CSubDNS cDNS = null;
    public CSubMemInfo cMemInfo = null;
    public CSubNET_CFG cNET_CFG = null;
    public List<CSubRSSIGROUP_EVENT_EX> cRSSIGROUP_EVENTList = new ArrayList(4);
    public CSubTCP_STATIST cTCP_STATIST = null;
    public CSubTRAFFIC_GROUND cTRAFFIC_GROUND = null;
    public ENCACCESS_INTERNET_FAILED enACCESS_INTERNET_FAILED = new ENCACCESS_INTERNET_FAILED();
    public ENCCANNOT_ACCESS_WEB_STATUS enCANNOT_ACCESS_WEB_STATUS = new ENCCANNOT_ACCESS_WEB_STATUS();
    ...
    public LogInt iAccessNetFailedCount = new LogInt();
    public LogInt iTime_NetAccessibleTime = new LogInt();
    public LogInt iTime_NetUnusableTime = new LogInt();
    ...
    public LogString strIP_firewall = new LogString(ConnectivityLogManager.WIFI_PORTAL_AUTH_MSG_COLLECTE);
    public LogString strIP_public = new LogString(48);
    public LogString strIP_route = new LogString(400);
    ...
    public LogByte ucCheckReason = new LogByte();
    ...
    public CSegEVENT_WIFI_ACCESS_INTERNET_FAILED_EX() {
        ...
        this.lengthMap.put("enACCESS_INTERNET_FAILED", Integer.valueOf(1));
        this.fieldMap.put("enACCESS_INTERNET_FAILED", this.enACCESS_INTERNET_FAILED);
        ...
        this.lengthMap.put("ucCheckReason", Integer.valueOf(1));
        this.fieldMap.put("ucCheckReason", this.ucCheckReason);
        ...
        this.lengthMap.put("strIP_route", Integer.valueOf(400));
        this.fieldMap.put("strIP_route", this.strIP_route);
        this.lengthMap.put("strIP_firewall", Integer.valueOf(ConnectivityLogManager.WIFI_PORTAL_AUTH_MSG_COLLECTE));
        this.fieldMap.put("strIP_firewall", this.strIP_firewall);
        this.lengthMap.put("enCANNOT_ACCESS_WEB_STATUS", Integer.valueOf(1));
        this.fieldMap.put("enCANNOT_ACCESS_WEB_STATUS", this.enCANNOT_ACCESS_WEB_STATUS);
        ...
        this.fieldMap.put("cDNS", this.cDNS);
        this.lengthMap.put("iTime_NetUnusableTime", Integer.valueOf(4));
        this.fieldMap.put("iTime_NetUnusableTime", this.iTime_NetUnusableTime);
        this.lengthMap.put("iTime_NetAccessibleTime", Integer.valueOf(4));
        this.fieldMap.put("iTime_NetAccessibleTime", this.iTime_NetAccessibleTime);
        ...
        this.fieldMap.put("cTCP_STATIST", this.cTCP_STATIST);
        this.lengthMap.put("iAccessNetFailedCount", Integer.valueOf(4));
        this.fieldMap.put("iAccessNetFailedCount", this.iAccessNetFailedCount);
        ...
        this.enEventId.setValue("WIFI_ACCESS_INTERNET_FAILED_EX");
        this.usLen.setValue(getTotalLen());
    }
}
