...
public class ENCEventId extends Cenum {
    public ENCEventId() {
        ...
        this.map.put("WIFI_USER_CONNECT", Integer.valueOf(101));
        ...
        this.map.put("WIFI_HAL_DRIVER_DEVICE_EXCEPTION", Integer.valueOf(200));
        ...
        this.map.put("WIFI_ABS_ASSOC_FAILED_EVENT", Integer.valueOf(ConnectivityLogManager.WIFI_ABS_ASSOC_FAILED_EVENT));
        this.map.put("WIFI_ABS_STATISTICS_EVENT", Integer.valueOf(ConnectivityLogManager.WIFI_ABS_STATISTICS_EVENT));
        setLength(1);
    }
}
