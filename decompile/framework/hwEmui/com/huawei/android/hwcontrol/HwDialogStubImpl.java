...
public class HwDialogStubImpl implements HwDialogStub {
    ...
    private void initAnimatorParams(final WindowManager windowManager, final View view) {
        ...
        this.mAnimator.addUpdateListener(new AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                l.y = HwDialogStubImpl.this.mState == 1 ? (int) (((float) HwDialogStubImpl.this.mOffset) * fraction) : (int) (((float) HwDialogStubImpl.this.mOffset) * (HwFragmentMenuItemView.ALPHA_NORMAL - fraction));
                if (view != null) {
                    try {
    ...
    private void setState(View view, int direction) {
        if (this.mContext != null) {
            ...
            int offset = (((displayHeight - statusBarHeight) - height) / 2) - ((int) ((res.getDisplayMetrics().density * 36.0f) + 0.5f));
            if (offset < 0) {
                offset = 0;
            }
            this.mOffset = offset;
