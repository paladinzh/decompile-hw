...
public class LocaleParam {
    ...
    private static List<String> support = Arrays.asList(new String[]{"en", "de", "fr", "it", "pt", "es", "es_MX", "ca", "ru", "uk", "pl", "cs", "el", "hu", "hr", "ro", "da", "fi", "nl", "nb", "sv", "sk", "tr", "ar", "he", "th", "ja", "zh_hans", "ko", "ms", "hi", "id", "vi", "az", "et", "eu", "bg", "bs", "fa", "km", "ka", "gl", "lv", "lt", "mk", "sr", "sl", "ur", "uz", "bo", "si", "my", "be", "kk", "bn", "lo", "fil", "ne", "jv"});
