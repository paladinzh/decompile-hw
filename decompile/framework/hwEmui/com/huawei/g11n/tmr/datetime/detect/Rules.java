    ...
    private HashMap<Integer, String> rules = new HashMap<Integer, String>() {
        {
            ...
            put(Integer.valueOf(21005), "([param_EEEE]|[param_E])[ ]+den[ ]+[regex_d]\\.[ ]*([param_MMMM]|[param_MMM])[ ]*[regex_y]");
            ...
            put(Integer.valueOf(21017), "([param_EEEE]|[param_E])[ ]+d\\.[ ]+[regex_d]\\b");
            ...
            put(Integer.valueOf(31005), "(?<!周)(([regex_zzzz])[ ]*){0,1}(([param_am]|[param_pm]|am|pm)[ ]*){0,1}((2[0-3]|[0-1]?[0-9])[param_digitHour])\\s*([時时]|[点點]半?)(整|[一三]刻|((([0-5]?[0-9][param_digitMS2])\\s*分|([0-5][0-9][param_digitMS])(\\s*分)?)(\\s*(([0-5]?[0-9])[param_digitMS])\\s*秒)?))?");
