...
public class DateConvert {
    ...
    public List<Date> convert(DatePeriod datePeriod, long j) {
        ...
        if (type == 0) {
            ...
            instance = Calendar.getInstance();
            instance.setTime(new Date(j));
            stringBuffer4.append(instance.get(1)).append("-").append(instance.get(2) + 1).append("-").append(instance.get(5)).append(" ");
            ...
            if (!timezone.equals("")) {
                ...
                stringBuffer4.append(" ").append(timezone);
            }
            try {
                    ...
                    if (satuts == 0 || satuts == 1) {
                        if (satuts2 == 2) {
                            ...
                            if (satuts == 0 || satuts == 2 || satuts2 == 0 || satuts2 == 2) {
                                if (mark2.trim().equals("") && !mark3.trim().equals("")) {
                                ...
                                } else if (mark3.trim().equals("") && !mark2.trim().equals("")) {
                                    if (second == i2 && r3 == i && r4 == type) {
                                        obj = 1;
                                    } else {
                                        obj = null;
                            ...
                            if (mark2.equals("")) {
                                ...
                                stringBuffer5.append(" ").append(mark2);
                            }
                            if (!timezone2.equals("")) {
                                stringBuffer.append(" Z");
                                stringBuffer5.append(" ").append(timezone2);
                            }
                            ...
                            if (mark3.equals("")) {
                                ...
                                stringBuffer7.append(" ").append(mark3);
                            }
                            if (!timezone2.equals("")) {
                                stringBuffer6.append(" Z");
                                stringBuffer7.append(" ").append(timezone2);
                            }
