...
public final class UpdateConfig {
    ...
    public static final String DEEPCLEAN_ONE_KEY_PATH_LIST_NAME = (intToString(40005) + ".dat");
    public static final String DEEPCLEAN_SDCARD_SCAN_RULE_NAME = (intToString(40248) + ".dat");
    public static final String DEEPCLEAN_SDCARD_SCAN_RULE_NAME_V2 = (intToString(40225) + ".dat");
    ...
    public static final int[] FILE_IDS = new int[]{50001, 60001, 80001, 20001, 10001, 10002, 10007, 10008, 10011, 10009, 10010, 10012, 10013, 10014, 10018, 10015, 10017, 10016, 50002, 70001, 30001, 90003, 90002, 10019, 10020, 10021, 40001, 40002, 40248, 40005, 40006, 40007, 40008, 100003, 40011, 40012, 40013, 40101, 40102, 40201, 100004, 40015, 60002, 40205, 40203, 60003, 40233, 70002, 40283, 40331, 40291};
    public static final String[] FILE_NAMES = new String[]{LOCATION_NAME, SMS_CHECKER_NAME, TRUST_URLS_NAME, TRAFFIC_MONITOR_CONFIG_NAME, WHITELIST_COMMON_NAME, WHITELIST_UNUSUAL_NAME, PRIVACYLOCKLIST_USUAL_NAME, BLACKLIST_KILL_PROCESS_NAME, WHITELIST_KILL_PROCESS_NAME, WHITELIST_AUTO_BOOT_NAME, WHITELIST_PERMISSION_CONTROL_NAME, CAMERA_SOFTWARE_LIST_NAME, DEEPCLEAN_SOFTWARE_LIST_NAME, DEEPCLEAN_SOFT_PATH_LIST_NAME, PERMIS_MONITOR_LIST_NAME, NOTKILLLIST_KILL_PROCESSES_NAME, ADBLOCKING_REPORT_WHITE_NAME, DEEP_CLEAN_MEDIA_SRC_PATH_NAME, NUM_MARK_NAME, VIRUS_BASE_NAME, SYSTEM_SCAN_CONFIG_NAME, PAY_LIST_NAME, STEAL_ACCOUNT_LIST_NAME, DEEP_CLEAN_WHITE_LIST_PATH_NAME, CAMERA_SOFTWARE_NEW_LIST_PATH_NAME, ROOT_PHONE_WHITE_LIST_PATH_NAME, H_LIST_NAME, ADB_DES_LIST_NAME, DEEPCLEAN_SDCARD_SCAN_RULE_NAME, DEEPCLEAN_ONE_KEY_PATH_LIST_NAME, PROCESSMANAGER_WHITE_LIST_NAME, TMSLITE_COMMISION_LIST_NAME, ANTITHEFT_WEB_SERVER_NUM, AMS_DATA, QUICK_PANEL_SUP, PCLinkedSoftCommunicateFlow, WeixinTrashClean, DeepCleanSoftScanRuleWord, DeepCleanSdcardScanRuleWord, KingUserPermision, SkinConfig, SoftLock_LockFunc, POSEIDON, GAME_SPEED_UP_LIST_NAME, QUICKPANEL_WIFIMANAGE, POSEIDONV2, WeixinTrashCleanNew, VIRUS_BASE_EN_NAME, NUM_MARK_LARGE_NAME, NUM_MARK_LARGE50W_NAME, RUBBISH_ENGLISH_TABLE_NAME};
    ...
    public static final String NUM_MARK_LARGE50W_NAME = (intToString(40331) + ".sdb");
    public static final String NUM_MARK_LARGE_NAME = (intToString(40283) + ".sdb");
    public static final String NUM_MARK_NAME = (intToString(50002) + ".sdb");
    ...
    public static final String STEAL_ACCOUNT_LIST_NAME = (intToString(90002) + ".dat");
    ...
    public static final long[] UPDATE_FLAGS = new long[]{2, 4, 16, 32, 512, 1024, UPDATE_FLAG_PRIVACYLOCKLIST_USUAL, UPDATE_FLAG_BLACKLIST_PROCESS, UPDATE_FLAG_WHITELIST_PROCESS, UPDATE_FLAG_WHITELIST_AUTO_BOOT, UPDATE_FLAG_WHITELIST_PERMISSION_CONTROL, UPDATE_FLAG_CAMERA_SOFTWARE_LIST, UPDATE_FLAG_DEEPCLEAN_SOFTWARE_LIST, UPDATE_FLAG_DEEPCLEAN_SOFT_PATH_LIST, 1048576, 2097152, UPDATE_ADBLOCKING_REPORT_WHITE_LIST, UPDATE_FLAG_DEEP_CLEAN_MEDIA_SRC_PATH, UPDATA_FLAG_NUM_MARK, UPDATE_FLAG_VIRUS_BASE, UPDATE_FLAG_SYSTEM_SCAN_CONFIG, 4294967296L, UPDATE_FLAG_STEAL_ACCOUNT_LIST, UPDATE_FLAG_DEEP_CLEAN_WHITE_LIST, 34359738368L, 68719476736L, UPDATE_FLAG_H_LIST, UPDATE_FLAG_ADB_DES_LIST, UPDATE_FLAG_DEEPCLEAN_SDCARD_SCAN_RULE, UPDATE_FLAG_DEEPCLEAN_ONE_KEY_PATH_LIST, UPDATE_FLAG_PROCESSMANAGER_WHITE_LIST, UPDATE_FLAG_TMSLITE_COMMISION_LIST, UPDATE_FLAG_ANTITHEFT_WEB_SERVER_NUM, UPDATE_FLAG_AMS_DATA, UPDATE_FLAG_QUICK_PANEL_SUP, UPDATE_FLAG_PCLinkedSoftCommunicateFlow, UPDATE_FLAG_WeixinTrashClean, UPDATE_FLAG_EFN_DeepCleanSoftScanRuleWord, UPDATE_FLAG_DeepCleanSdcardScanRuleWord, UPDATE_FLAG_KingUserPermision, UPDATE_FLAG_SkinConfig, UPDATE_FLAG_SoftLock_LockFunc, UPDATE_FLAG_POSEIDON, UPDATE_FLAG_GAME_SPEED_UP, UPDATE_FLAG_QUICKPANEL_WIFIMANAGE, UPDATE_FLAG_POSEIDONV2, UPDATE_FLAG_WeixinTrashCleanNew, UPDATE_FLAG_VIRUS_BASE_ENG, UPDATE_FLAG_NUMMARK_LARGE, Long.MIN_VALUE, UPDATE_FLAG_ENGLISH_TABLE};
    ...
    public static final String VIRUS_BASE_NAME = (intToString(70001) + ".amf");
    ...
    static {
        ...
        sDeprecatedNameMap.put(STEAL_ACCOUNT_LIST_NAME, "steal_account_list.dat");
        ...
        sDeprecatedNameMap.put(DEEPCLEAN_SDCARD_SCAN_RULE_NAME_V2, "deepclean_sdcard_scan_rule.dat");
    ...
    public static long prepareCheckFlag(long j) {
        if ((UPDATE_FLAG_ALL & j) == 0) {
            return (UPDATE_FLAG_APP_LIST & j) != 0 ? ((((((((((((((((((((((512 | j) | 1024) | UPDATE_FLAG_PRIVACYLOCKLIST_USUAL) | UPDATE_FLAG_BLACKLIST_PROCESS) | UPDATE_FLAG_WHITELIST_PROCESS) | UPDATE_FLAG_WHITELIST_AUTO_BOOT) | UPDATE_FLAG_WHITELIST_PERMISSION_CONTROL) | UPDATE_FLAG_CAMERA_SOFTWARE_LIST) | UPDATE_FLAG_DEEPCLEAN_SOFTWARE_LIST) | UPDATE_FLAG_DEEPCLEAN_SOFT_PATH_LIST) | 1048576) | 2097152) | UPDATE_ADBLOCKING_REPORT_WHITE_LIST) | UPDATE_FLAG_DEEP_CLEAN_MEDIA_SRC_PATH) | 4294967296L) | UPDATE_FLAG_STEAL_ACCOUNT_LIST) | UPDATE_FLAG_PROCESSMANAGER_WHITE_LIST) | UPDATE_FLAG_DEEP_CLEAN_WHITE_LIST) | UPDATE_FLAG_WeixinTrashCleanNew) | 34359738368L) | 68719476736L) | UPDATE_FLAG_TMSLITE_COMMISION_LIST) | UPDATE_FLAG_GAME_SPEED_UP : j;
        } else {
            j = 0;
            for (long j2 : UPDATE_FLAGS) {
                j |= j2;
            }
            return j;
        }
    ...
    private static String v(long j) {
        return (2 == j || UPDATA_FLAG_NUM_MARK == j || Long.MIN_VALUE == j || UPDATE_FLAG_NUMMARK_LARGE == j) ? ".sdb" : 4 == j ? ".sys" : (UPDATE_FLAG_VIRUS_BASE == j || UPDATE_FLAG_VIRUS_BASE_ENG == j) ? ".amf" : ".dat";
    }
}
