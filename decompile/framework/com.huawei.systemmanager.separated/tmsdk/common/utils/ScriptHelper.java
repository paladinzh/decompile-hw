...
public final class ScriptHelper {
    ...
    static final class b {
        ...
        void writeToStream(OutputStream outputStream) throws IOException {
            ...
            System.arraycopy(mo.bE(this.type), 0, obj, 0, 4);
            System.arraycopy(mo.bE(this.time), 0, obj, 4, 4);
            System.arraycopy(mo.bE(this.size), 0, obj, 8, 4);
    ...
    static {
        boolean z = (ms.cy("/system/bin/su") || ms.cy("/system/xbin/su") || ms.cy("/sbin/su")) ? true : Li;
        isSuExist = z;
    }
    ...
    public static boolean providerSupportCancelMissCall() {
        return (Lp != null && Lp.cB(2)) ? true : Li;
    }
