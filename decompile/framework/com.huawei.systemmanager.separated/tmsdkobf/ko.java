...
public class ko extends ContentProvider {
    ...
    public final Object vN = new Object();
    private final int vO = 2;
    ...
    protected SQLiteDatabase getDatabase() {
        ...
        if (applicaionContext == null) {
            ...
            if (this.vQ == null) {
                this.vQ = new ij(this, applicaionContext, this.mName, null, this.vR, this.vT) {
            ...
            if (this.vP == null) {
                this.vP = new SQLiteOpenHelper(this, applicaionContext, this.mName, null, this.vR) {
                    final /* synthetic */ ko vU;
