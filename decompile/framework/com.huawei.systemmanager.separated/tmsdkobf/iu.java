...
public final class iu extends DataInterceptorBuilder<SmsEntity> {
    ...
    private static final class b extends IncomingSmsFilter {
        ...
        b(Context context) {
            ...
            this.sC = new iq();
            this.sC.b(256, 1, 2, 4, 8, 16, 32, 64, IncomingSmsFilterConsts.PAY_SMS, 128);
            ...
            this.sC.a(IncomingSmsFilterConsts.PAY_SMS, new a(this) {
                final /* synthetic */ b sQ;
        ...
        protected FilterResult b(final SmsEntity smsEntity, final Object... objArr) {
            Throwable th;
            qz qzVar;
            StringBuffer d;
            String a;
                    ...
                    try {
                        ...
                        try {
                            ...
                            anonymousClass4 = new Runnable(this) {
                                ...
                                public void run() {
                                    this.sQ.sD.getAresEngineFactor().getPhoneDeviceController().unBlockSms(smsEntity, objArr);
                                }
                            };
                            if (intValue != 0) {
                                anonymousClass4.run();
                        ...
                        filterResult.mState = 0;
                        intValue = ((Integer) objArr[0]).intValue();
                        anonymousClass4 = /* anonymous class already generated */;
                        if (intValue != 0) {
                            filterResult.mDotos.add(anonymousClass4);
                        } else {
                            anonymousClass4.run();
        ...
        public boolean c(final SmsEntity smsEntity, Object... objArr) {
            ...
            jq.ct().b(new Runnable(this) {
                ...
                public void run() {
                    ...
                    this.sX.a(this.sX.a(smsEntity, arrayList), smsEntity, (ArrayList) arrayList);
                }
