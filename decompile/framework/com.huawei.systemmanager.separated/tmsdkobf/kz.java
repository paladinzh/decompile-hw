...
public class kz implements kp, qj {
        ...
        try {
            ...
            try {
                ...
                if (new File(str).exists()) {
                    ...
                    if (entry != null) {
                        int indexOf;
                        bufferedReader2 = new BufferedReader(new InputStreamReader(zipFile.getInputStream(entry)));
                        while (true) {
                            try {
    ...
    public void a(hw hwVar) {
        ...
        hv.bG().a(CallerIdent.getIdent(1, 4294967296L), 2, new c(this) {
    ...
    public void p(ArrayList<a> arrayList) {
        ...
        if (arrayList != null && arrayList.size() != 0) {
            ...
            if (arrayList2 != null && arrayList2.size() > 0) {
                hv.bG().a(CallerIdent.getIdent(1, 4294967296L), 2, 0, arrayList2);
            }
            if (arrayList5 != null && arrayList5.size() > 0) {
                hv.bG().a(CallerIdent.getIdent(1, 4294967296L), 2, 3, arrayList5);
            }
            if (arrayList4 != null && arrayList4.size() > 0) {
                hv.bG().a(CallerIdent.getIdent(1, 4294967296L), 2, 2, arrayList4);
            }
            if (arrayList3 != null && arrayList3.size() > 0) {
                hv.bG().a(CallerIdent.getIdent(1, 4294967296L), 2, 1, arrayList3);
            }
        }
    }
}
