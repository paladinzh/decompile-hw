...
public class hv {
    public static String TAG = "ProfileUpload";
    private static Object lock = new Object();
    private static int[] rd;
    private static hv rh;
    private HandlerThread mHandlerThread = ((lq) fe.ad(4)).bF("profile upload task queue");
    private hz ra;
    private ht rb = ht.bD();
    private HashMap<Integer, hq> rc = new HashMap();
    private Set<Integer> re = new HashSet();
    private qi rf = new qi("profile4", 43200000, 24);
    private qi rg = new qi("profile2", 43200000, 12);
    private State ri = State.UNKNOWN;
    private State rj = State.UNKNOWN;
    private tmsdkobf.lp.a rk = new tmsdkobf.lp.a(this) {
    ...
    private ConcurrentHashMap<Integer, a> rm = new ConcurrentHashMap();
    private SparseIntArray rn = new SparseIntArray();
    private Handler ro;
    private Callback rp = new Callback(this) {
        final /* synthetic */ hv rr;
    ...
    private HashSet<ks> rq = new HashSet();
    ...
    private void aR(int i) {
        ...
        if (dn != null) {
            a(CallerIdent.getIdent(1, 4294967296L), i, 0, dn);
        } else {
    ...
    public WeakReference<ll> b(int i, int i2, int i3, long j, long j2, int i4, fs fsVar, byte[] bArr, fs fsVar2, int i5, lg lgVar, lh lhVar, long j3, long j4) {
        ll llVar = new ll();
        Message.obtain(this.ro, 7, new hq(i, i2, i3, j, j2, i4, fsVar, bArr, fsVar2, i5, lgVar, lhVar, j3, j4, llVar)).sendToTarget();
