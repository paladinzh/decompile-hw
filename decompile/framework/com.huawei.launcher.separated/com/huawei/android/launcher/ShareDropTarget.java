...
public class ShareDropTarget extends ButtonDropTarget {
    ...
    private void init() {
        ...
        int MAGIN_TO_LEFT = (int) this.mContext.getResources().getDimension(2131165588);
        int MAGIN_TO_RIGHT = (int) this.mContext.getResources().getDimension(2131165589);
        int MAGIN_TO_TOP = (int) this.mContext.getResources().getDimension(2131165568);
        ...
        this.mImageView.setBackgroundResource(2130837750);
        this.mTextView = new TextView(this.mContext);
        this.mTextView.setText(2131558607);
        this.mTextView.setTextColor(this.mContext.getResources().getColor(2131361859));
        this.mTextView.setTextSize(0, (float) this.mContext.getResources().getDimensionPixelSize(2131165575));
        ...
        if (componentName != null) {
            ...
            if (!packageNameString.equals("")) {
                try {
                    ...
                    Intent intent2 = null;
                    try {
                        intent2 = Intent.createChooser(intent, this.mLauncher.getResources().getString(2131558607));
                    } catch (Exception e) {
                        e.printStackTrace();
    ...
    public void onDragStart(DragSource source, Object info, int dragAction) {
        ...
        if ((info instanceof ShortcutInfo) && !(info instanceof DownloadCutInfo)) {
            ...
            if (!this.mIsExsitApp || ((ShortcutInfo) info).itemType == ACCEPTED_DRAGTO_ICON_SIZE || ((ShortcutInfo) info).isCloneApp) {
                isToShare = false;
            } else {
    ...
    private void setClearActiveHoloBg() {
        this.mShareBg.setBackgroundResource(2130837599);
    }
    ...
    public void onDragEnter(DragObject d) {
        ...
        Utilities.sendAccessibilityEvent(this.mLauncher.getString(2131558607));
