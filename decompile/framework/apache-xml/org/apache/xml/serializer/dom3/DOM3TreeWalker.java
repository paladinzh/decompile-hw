...
*/
    ...
    protected void serializeAttList(Element node) throws SAXException {
        ...
        for (int i = 0; i < nAttrs; i++) {
            ...
            boolean startsWith = !attrName.equals("xmlns") ? attrName.startsWith(Constants.ATTRNAME_XMLNS) : true;
            if ((this.fFeatures & 16384) != 0) {
                isAttributeWellFormed(attr);
            }
            if ((this.fFeatures & 256) == 0 || startsWith) {
                attrName2 = attrName;
            ...
            if (!(!applyFilter || this.fFilter == null || (this.fFilter.getWhatToShow() & 2) == 0 || startsWith)) {
            ...
            if (startsWith && (this.fFeatures & 512) != 0) {
                String prefix;
