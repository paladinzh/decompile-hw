...
public class NodeTest extends Expression {
    public static final XNumber SCORE_NODETEST = new XNumber((double) XPath.MATCH_SCORE_NODETEST);
    public static final XNumber SCORE_NONE = new XNumber((double) XPath.MATCH_SCORE_NONE);
    public static final XNumber SCORE_NSWILD = new XNumber((double) XPath.MATCH_SCORE_NSWILD);
    public static final XNumber SCORE_OTHER = new XNumber((double) XPath.MATCH_SCORE_OTHER);
