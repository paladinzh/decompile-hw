...
public class ac implements IPushChannel {
    ...
    public boolean a(Socket socket) {
        aw.d("PushLog2841", "enter NormalChannel:init(" + socket.getRemoteSocketAddress() + ")");
    ...
    public boolean a(byte[] bArr) {
        if (this.socket == null || this.socket.getOutputStream() == null) {
            aw.e("PushLog2841", "when call send, socket is not ready!!");
            return false;
        }
    ...
    public ChannelType br() {
        return ChannelType.ChannelType_Normal;
    }
