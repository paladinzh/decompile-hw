...
class bd {
    public static String a(String str, byte[] bArr) {
        ...
        if (!(TextUtils.isEmpty(str) || bArr == null || bArr.length <= 0)) {
            try {
                ...
                aw.d("PushLog2841", "aes cbc encrypter data error", e);
            }
        }
        return str2;
    }
    ...
    public static String r(String str) {
        return TextUtils.isEmpty(str) ? null : bd.a(str, bd.cf());
    }

    public static String s(String str) {
        return TextUtils.isEmpty(str) ? "" : bd.b(str, bd.cf());
    }
