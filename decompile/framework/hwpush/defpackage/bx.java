...
public class bx {
    ...
    private static HttpsURLConnection a(Context context, String str, String str2, boolean z, boolean z2) {
        ...
        if (str == null) {
            aw.d("PushLog2841", "TRSUrl is null, cannot create connection.");
            return null;
        }
        aw.d("PushLog2841", "TRS httpUrl = " + str + ",useDefaultPort = " + z2);
        try {
            HttpsURLConnection c = bx.c(context, str, z);
            try {
                aw.d("PushLog2841", "get connection success.");
                c.connect();
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            aw.d("PushLog2841", "call conn.connect() success");
                            return c;
                        } catch (Throwable th3) {
                            e = th3;
                            if (outputStream != null) {
                ...
                th2 = th;
                aw.d("PushLog2841", "connect to TRS cause IOException:" + th2.toString(), th2);
                ...
                httpsURLConnection = c;
                th2 = th;
                aw.d("PushLog2841", "connect to TRS cause Exception:" + th2.toString(), th2);
                if (httpsURLConnection != null) {
                    return null;
                }
                httpsURLConnection.disconnect();
    ...
    private static String b(Context context, String str, boolean z) {
        ...
        aw.d("PushLog2841", "url:" + stringBuffer.toString());
            ...
            try {
                if (VERSION.SDK_INT >= 11) {
                    ...
                    try {
                        ...
                        e = e2;
                        aw.e("PushLog2841", "get proxy ip or port error:" + e.getMessage());
                        parseInt = -1;
                        aw.d("PushLog2841", "use Proxy " + property + ":" + parseInt + " to open:" + str);
                        ...
                        if (httpsURLConnection == null) {
                            aw.d("PushLog2841", "direct to open " + str);
                            httpsURLConnection = (HttpsURLConnection) new URL(str).openConnection();
                        }
                        httpsURLConnection.setConnectTimeout(((int) ae.l(context).I()) * 1000);
                        httpsURLConnection.setReadTimeout((int) (ae.l(context).J() * 1000));
    ...
    private static String g(String str, String str2) {
        if (TextUtils.isEmpty(str2) || TextUtils.isEmpty(str)) {
            aw.w("PushLog2841", "belongId is null or trsAddress is null");
        } else if (str.startsWith("push")) {
            try {
                int parseInt = Integer.parseInt(str2.trim());
                if (parseInt <= 0) {
                    aw.w("PushLog2841", "belongId is invalid:" + parseInt);
                } else {
                ...
                aw.d("PushLog2841", "belongId parseInt error " + str2, e);
            } catch (Throwable e2) {
                aw.d("PushLog2841", e2.getMessage(), e2);
            }
        } else {
            aw.w("PushLog2841", "trsAddress is invalid:" + str);
        }
        return str;
    }
    ...
    public static k y(Context context, String str) {
        ...
        aw.d("PushLog2841", "queryTrs runing");
        ...
        try {
            ...
            if (a != null) {
                ...
                try {
                    ...
                    if (a != null) {
                        ...
                        if (a != null) {
                            ...
                            if (a != null) {
                                ...
                                aw.e("PushLog2841", "after all, trs connect is null");
                                if (null != null) {
                                    try {
                                        inputStream.close();
                                    } catch (IOException e2) {
                                        aw.e("PushLog2841", "close is err");
                                    }
                                }
                                if (null != null) {
                                    try {
                                ...
                                aw.d("PushLog2841", "disconnect the socket");
                                a.disconnect();
                                return null;
                            }
                        }
                    ...
                    bufferedReader = null;
                    try {
                        aw.a("PushLog2841", "query trs err:" + e.toString(), e);
                        if (inputStream != null) {
                            try {
                                inputStream.close();
                            } catch (IOException e5) {
                        ...
                        try {
                            ...
                            aw.d("PushLog2841", e6.toString(), e6);
                        }
                        aw.d("PushLog2841", "get IP/PORT failed, retry again.");
                        return null;
                    } catch (Throwable th2) {
                        th = th2;
                        if (inputStream != null) {
            ...
            try {
                aw.d("PushLog2841", "queryTrs connect() success");
                inputStream = httpsURLConnection.getInputStream();
            } catch (Exception e8) {
                e62 = e8;
                bufferedReader = null;
                inputStream = null;
                aw.a("PushLog2841", "query trs err:" + e62.toString(), e62);
                if (inputStream != null) {
                    inputStream.close();
                }
                if (bufferedReader != null) {
            ...
            try {
                ...
                try {
                    ...
                    aw.d("PushLog2841", "response is null");
                    if (inputStream != null) {
                        try {
                            inputStream.close();
                    ...
                    e622 = e12;
                    aw.a("PushLog2841", "query trs err:" + e622.toString(), e622);
                    if (inputStream != null) {
                        inputStream.close();
                    }
                    if (bufferedReader != null) {
            ...
            inputStream = null;
            httpsURLConnection = null;
            aw.a("PushLog2841", "query trs err:" + e6222.toString(), e6222);
            if (inputStream != null) {
                inputStream.close();
            }
            if (bufferedReader != null) {
    ...
    private static String z(Context context, String str) {
        ...
        try {
            ...
            jSONObject.put("emV", bx.C(bK));
            jSONObject.put("rV", bx.C(Build.DISPLAY));
            jSONObject.put("agentV", x);
        } catch (JSONException e) {
            aw.e("PushLog2841", e.toString());
        }
        aw.d("PushLog2841", "enter the buildReqTRSContent and the  content info is  = " + bi.b(jSONObject));
