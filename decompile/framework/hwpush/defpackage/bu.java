...
public class bu {
    private static ResolveInfo a(List list, String str) {
        ...
        if (!(list == null || list.size() == 0)) {
            ...
            if (resolveInfo != null) {
                aw.d("PushLog2841", "after getHighVersion pushService pkgName=" + (resolveInfo.serviceInfo != null ? resolveInfo.serviceInfo.packageName : resolveInfo.activityInfo.packageName));
            }
        }
        return resolveInfo;
    }
    ...
    private static String a(ResolveInfo resolveInfo) {
        if (resolveInfo != null) {
            ...
            aw.i("PushLog2841", "ResolveInfo is null , cannot get packageName");
            return null;
        }
    }
    ...
    private static boolean a(ResolveInfo resolveInfo, ResolveInfo resolveInfo2, String str) {
        ...
        aw.d("PushLog2841", "the curPkgName(" + a + ")version is:" + b + "the oldPkgName (" + str2 + ")version is:" + b2);
        if (b > b2) {
            return true;
        }
        if (b != b2) {
    ...
    public static String ae(Context context) {
        aw.d("PushLog2841", " choose the high version for push service");
        ...
        if (228 > x || !bu.cp()) {
            ...
            aw.d("PushLog2841", "the getHightMetaPackageName return version is :" + b + " curApkVersion:" + x);
            String str;
            if (x >= b) {
                str = "com.huawei.android.pushagent";
                aw.d("PushLog2841", "the push APK version (" + x + ")is hight,use APK for push service");
                return str;
            }
            str = bu.a(n);
            aw.d("PushLog2841", "use the hight version(" + b + " )for push service, highPkgName is :" + str);
            return str;
        }
        aw.i("PushLog2841", "support ctrlsocket.");
    ...
    private static long b(ResolveInfo resolveInfo, String str) {
        ...
        if (resolveInfo != null) {
            try {
                ...
                aw.d("PushLog2841", str + " is not set in " + bu.a(resolveInfo));
            }
        }
        return j;
    }
    ...
    private static boolean cp() {
        if (-2 != au.ctrlSockets(1, 3) && !bv.ct()) {
            return true;
        }
        aw.d("PushLog2841", "not support ctrlsocket.");
        return false;
    }
    ...
    private static ResolveInfo n(Context context, String str, String str2) {
        ...
        if (m == null || m.size() == 0) {
            aw.e("PushLog2841", "no push service install, may be system Err!! pkgName:" + context.getPackageName());
            return null;
        }
        aw.d("PushLog2841", "begin to get the hight Version package, have action:" + str);
        ResolveInfo a = bu.a(m, str2);
        if (a != null) {
            return a;
        }
        aw.e("PushLog2841", "there is no hightVersion PushService, maybe system Err!! pkgName:" + context.getPackageName());
        return null;
    }
    ...
    public static long x(Context context, String str) {
        ...
        long j = -1000;
        try {
            List queryBroadcastReceivers = context.getPackageManager().queryBroadcastReceivers(new Intent("com.huawei.android.push.intent.REGISTER").setPackage(str), 787072, ActivityManager.getCurrentUser());
            if (!(queryBroadcastReceivers == null || queryBroadcastReceivers.size() == 0)) {
                try {
                    ...
                    if (str2 == null || !str2.equals(str)) {
                        j = 228;
                        aw.d("PushLog2841", str + " version is :" + j);
                    } else {
                    ...
                    aw.e("PushLog2841", "get Apk version faild ,Exception e= " + exception.toString());
                    aw.d("PushLog2841", str + " version is :" + j);
                    return j;
                }
            }
