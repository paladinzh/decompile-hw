...
public class PushService extends MKService {
    ...
    private static PushService c = null;
    ...
    private NetworkCallback j = new b(this);
    ...
    private static boolean a(Context context) {
        return System.currentTimeMillis() < g || (ae.l(context).ab() * 1000) + g < System.currentTimeMillis();
    }
    ...
    private void b(Context context) {
        ...
        while (i < ba.bQ().length) {
            intentFilter2.addAction(ba.bQ()[i]);
            i++;
        }
    ...
    private synchronized void b(Intent intent) {
        if (intent == null) {
            aw.e(TAG, "when broadcastToProcess, intent is null");
        } else {
    ...
    public void onDestroy() {
        ...
        if (!this.f) {
            long a = System.currentTimeMillis() - this.e > ae.l(this.context).K() * 1000 ? 0 : ag.a(this.context, "run_time_less_times", 0) + 1;
            long L = a == 0 ? ae.l(this.context).L() * 1000 : a == 1 ? ae.l(this.context).M() * 1000 : a == 2 ? ae.l(this.context).N() * 1000 : a >= 3 ? ae.l(this.context).O() * 1000 : 0;
            aw.d(TAG, "next start time will be " + (L / 1000) + " seconds later" + " run_time_less_times is " + a + "times");
            ag.a(this.context, new g("run_time_less_times", Long.class, Long.valueOf(a)));
            bq.c(this.context, new Intent().setClassName("android", "com.huawei.android.pushagentproxy.PushService"), L);
            bl.ad(this.context);
        }
        super.onDestroy();
    }
