...
public class NewDeviceRegisterReqMessage extends PushMessage {
        ...
        if (TextUtils.isEmpty(this.mDeviceId)) {
            ...
            try {
                ...
                if (this.mNetEventInfoList != null && this.mNetEventInfoList.length > 0) {
                    for (NetEventInfo netEventInfo : this.mNetEventInfoList) {
                        byteArrayOutputStream.write(au.m(netEventInfo.aH()));
                        byteArrayOutputStream.write(netEventInfo.aI());
                        byteArrayOutputStream.write(netEventInfo.aJ());
                    }
                }
    ...
    public String toString() {
        StringBuffer append = new StringBuffer(getClass().getSimpleName()).append(" cmdId:").append(aC()).append(" mDeviceId:").append(this.mDeviceId).append(" mNetworkType:").append(this.mNetworkType).append(" mAgentVersion:").append(this.mAgentVersion).append(" mLastDisconnectTime:").append(au.a(this.mLastDisconnectTime, "yyyy-MM-dd HH:mm:ss SSS")).append(" mCurrentConnectTime:").append(au.a(this.mCurrentConnectTime, "yyyy-MM-dd HH:mm:ss SSS")).append(" mCurrentTime:").append(au.a(this.mCurrentTime, "yyyy-MM-dd HH:mm:ss SSS")).append(" mNetEventAccount:").append(this.mNetEventCount);
        if (this.mNetEventInfoList != null && this.mNetEventInfoList.length > 0) {
