...
public class PushDataRspMessage extends PushMessage {
    ...
    public byte[] encode() {
        byte[] bArr = null;
        if (this.mMsgId == null) {
            aw.e("PushLog2841", "encode error, mMsgId is null ");
        } else {
            try {
    ...
    public String toString() {
        return new StringBuffer(getClass().getSimpleName()).append(",cmdId:").append(aC()).append(",msgId:").append(au.f(this.mMsgId)).append(",flag:").append(this.mPkgFlag).toString();
    }
}
