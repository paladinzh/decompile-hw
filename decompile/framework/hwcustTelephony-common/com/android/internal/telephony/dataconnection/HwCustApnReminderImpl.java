...
public class HwCustApnReminderImpl extends HwCustApnReminder {
    ...
    private void mentionApnFailed() {
        ...
        builder.setTitle(33685931).setCancelable(HWDBG).setMessage(33685932).setPositiveButton(33685934, new goSetApnListener()).setNegativeButton(33685933, new OnClickListener() {
    ...
    public void showNewAddAPN(Context mContext, Builder builder) {
        if (mContext != null && builder != null) {
            this.mContext = mContext;
            builder.setPositiveButton(33685935, new goSetApnListener());
        }
    }
